(certificate vampire-megalodon 1
  (problem "native-cert-v1-equality-factoring-kernel-valid")
  ...
  (step_extra "u2" "kernel_v1" ("schema=prover9-small-kernel-v1" "rule=equality_factoring" "primitive_expansion=prefix" "primitive_expansion_prefix=u2" "primitive_expansion_requires=equality_factoring" "conclusion_unit=u2" "selected=(pos (AP (AP (TMH \"=\") (TMH \"a\")) (TMH \"b\")))" "selected_substituted=(pos (AP (AP (TMH \"=\") (TMH \"a\")) (TMH \"b\")))" "selected_parent_index=0" "selected_literal_index=0" "selected_parent_unit=u1" "other=(pos (AP (AP (TMH \"=\") (TMH \"a\")) (TMH \"c\")))" "other_substituted=(pos (AP (AP (TMH \"=\") (TMH \"a\")) (TMH \"c\")))" "other_parent_index=0" "other_literal_index=1" "other_parent_unit=u1" "primitive_parent_0_substitution=(subst)" "result_clause=(clause (pos (AP (AP (TMH \"=\") (TMH \"a\")) (TMH \"c\"))) (neg (AP (AP (TMH \"=\") (TMH \"b\")) (TMH \"c\"))))" "conclusion_clause=(clause (pos (AP (AP (TMH \"=\") (TMH \"a\")) (TMH \"c\"))) (neg (AP (AP (TMH \"=\") (TMH \"b\")) (TMH \"c\"))))" "result_literal_count=2"))
