% megalodon_origin ((file "native_cert_v1_equality_factoring_constraints_explicit_cross_core_pf_valid.mg") (line "1") (char "1") (kind "synthetic_equality_factoring_constraints_explicit_cross_core_pf"))
thf(a_type,type,a:$i).
thf(b_type,type,b:$i).
thf(c_type,type,c:$i).
