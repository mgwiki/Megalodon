% megalodon_origin ((file "/project/Megalodon/examples/hammer/100thms_12_h.mg") (line "11271") (char "23") (kind "aby"))
...
% megalodon_source_map (conjecture "conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F11271_5F23" "/project/tmp/megalodon3_source_linked_corpus_250/hammer_11271_23" "")
thf(conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F11271_5F23,conjecture,(! [X3:($i > $o)] : ((X3 @ c_Empty) => ((! [X4:$i] : ((X3 @ X4) => (X3 @ (ordsucc @ X4)))) => (X3 @ m))))).
