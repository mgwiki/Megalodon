% megalodon_origin ((file "/project/Megalodon/examples/hammer/100thms_12_h.mg") (line "11925") (char "125") (kind "aby"))
...
% megalodon_source_map (known "nat_5F1" "nat_1" "a985fbd82807c603866f35d87f9d2827902df20043761c604b521c2cfc62c64e")
thf(nat_5F1,axiom,(! [X0:($i > $o)] : ((X0 @ c_Empty) => ((! [X1:$i] : ((X0 @ X1) => (X0 @ (ordsucc @ X1)))) => (X0 @ (ordsucc @ c_Empty)))))). % a985fbd82807c603866f35d87f9d2827902df20043761c604b521c2cfc62c64e
...
% megalodon_source_map (known "nat_5Fp_5Fomega" "nat_p_omega" "cd49a636af3e3734e4fffd883d424478c3079474a4c7d6e668a59efdabd07c2a")
thf(nat_5Fp_5Fomega,axiom,(! [X0:$i] : ((! [X1:($i > $o)] : ((X1 @ c_Empty) => ((! [X2:$i] : ((X1 @ X2) => (X1 @ (ordsucc @ X2)))) => (X1 @ X0)))) => ((c_In @ X0) @ omega)))). % cd49a636af3e3734e4fffd883d424478c3079474a4c7d6e668a59efdabd07c2a
...
% megalodon_source_map (known "c_SNo_5Feps_5FSNoS_5Fomega" "SNo_eps_SNoS_omega" "f8e000c80f123a7847ac12cdb3aa15a3ea1ad70430bae7bc57842a3baeba7288")
thf(c_SNo_5Feps_5FSNoS_5Fomega,axiom,(! [X0:$i] : (((c_In @ X0) @ omega) => ((c_In @ (eps_5F @ X0)) @ (c_SNoS_5F @ omega))))). % f8e000c80f123a7847ac12cdb3aa15a3ea1ad70430bae7bc57842a3baeba7288
...
% megalodon_source_map (known "add_5FSNo_5FSNoS_5Fomega" "add_SNo_SNoS_omega" "b6e57b081c34853a5ec3d08e48b6df5445989e557765d3cb7d73195c67c6ee83")
thf(add_5FSNo_5FSNoS_5Fomega,axiom,(! [X0:$i] : (((c_In @ X0) @ (c_SNoS_5F @ omega)) => (! [X1:$i] : (((c_In @ X1) @ (c_SNoS_5F @ omega)) => ((c_In @ ((add_5FSNo @ X0) @ X1)) @ (c_SNoS_5F @ omega))))))). % b6e57b081c34853a5ec3d08e48b6df5445989e557765d3cb7d73195c67c6ee83
% megalodon_source_map (known "add_5FSNo_5F1_5Fordsucc" "add_SNo_1_ordsucc" "8c729c530d69502cc13890766571341da3e9f182521ce06746ec93158ce9b70d")
thf(add_5FSNo_5F1_5Fordsucc,axiom,(! [X0:$i] : (((c_In @ X0) @ omega) => (((add_5FSNo @ X0) @ (ordsucc @ c_Empty)) = (ordsucc @ X0))))). % 8c729c530d69502cc13890766571341da3e9f182521ce06746ec93158ce9b70d
...
% megalodon_source_map (known "mul_5FSNo_5FoneR" "mul_SNo_oneR" "bd601b8e3252eb28873719169159ee0ef30c2303c64a80b24aa26881dbe4f6ed")
thf(mul_5FSNo_5FoneR,axiom,(! [X0:$i] : ((c_SNo @ X0) => (((mul_5FSNo @ X0) @ (ordsucc @ c_Empty)) = X0)))). % bd601b8e3252eb28873719169159ee0ef30c2303c64a80b24aa26881dbe4f6ed
% megalodon_source_map (known "mul_5FSNo_5FdistrL" "mul_SNo_distrL" "58251a89cd22b894687387772513303547a43dbdb1887246ba5b5c889f271651")
thf(mul_5FSNo_5FdistrL,axiom,(! [X0:$i] : (! [X1:$i] : (! [X2:$i] : ((c_SNo @ X0) => ((c_SNo @ X1) => ((c_SNo @ X2) => (((mul_5FSNo @ X0) @ ((add_5FSNo @ X1) @ X2)) = ((add_5FSNo @ ((mul_5FSNo @ X0) @ X1)) @ ((mul_5FSNo @ X0) @ X2)))))))))). % 58251a89cd22b894687387772513303547a43dbdb1887246ba5b5c889f271651
...
% megalodon_source_map (conjecture "conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F11925_5F125" "/project/tmp/megalodon3_source_linked_corpus_250/hammer_11925_125" "")
thf(conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F11925_5F125,conjecture,(! [X1:$i] : ((! [X2:($i > $o)] : ((X2 @ c_Empty) => ((! [X3:$i] : ((X2 @ X3) => (X2 @ (ordsucc @ X3)))) => (X2 @ X1)))) => (((c_In @ ((mul_5FSNo @ (eps_5F @ k)) @ X1)) @ (c_SNoS_5F @ omega)) => ((c_In @ ((mul_5FSNo @ (eps_5F @ k)) @ (ordsucc @ X1))) @ (c_SNoS_5F @ omega)))))).
