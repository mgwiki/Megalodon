% megalodon_origin ((file "examples/hammer/100thms_12_h.mg") (line "10795") (char "33") (kind "aby"))
...
% megalodon_source_map (known "mul_5Fnat_5Fmul_5FSNo" "mul_nat_mul_SNo" "d488daae49a28a575741be5a526a525621d1e4bcc346fa8339b1216ee1837b49")
thf(mul_5Fnat_5Fmul_5FSNo,axiom,(! [X0:$i] : (((c_In @ X0) @ omega) => (! [X1:$i] : (((c_In @ X1) @ omega) => (((mul_5Fnat @ X0) @ X1) = ((mul_5FSNo @ X0) @ X1))))))). % d488daae49a28a575741be5a526a525621d1e4bcc346fa8339b1216ee1837b49
...
% megalodon_source_map (conjecture "conj_c__2Fproject_2Ftmp_2Fsource_5Flinked_5Fstrict_5F100_5Fcorpus_5Ffresh_5F041947_2Fhammer_5F10795_5F33" "/project/tmp/source_linked_strict_100_corpus_fresh_041947/hammer_10795_33" "")
thf(conj_c__2Fproject_2Ftmp_2Fsource_5Flinked_5Fstrict_5F100_5Fcorpus_5Ffresh_5F041947_2Fhammer_5F10795_5F33,conjecture,(((add_5FSNo @ ((mul_5Fnat @ q) @ n)) @ r) = ((add_5FSNo @ ((mul_5FSNo @ q) @ n)) @ r))).
