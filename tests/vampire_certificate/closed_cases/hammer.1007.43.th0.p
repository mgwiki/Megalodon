% megalodon_origin ((file "examples/hammer/100thms_12_h.mg") (line "1007") (char "43") (kind "aby"))
...
% megalodon_source_map (known "setminus_5FIn_5FPower" "setminus_In_Power" "83b53c6e2122cffca9796caa4c5b1431d936e3b5694255b74ebc24a115abc75a")
thf(setminus_5FIn_5FPower,axiom,(! [X0:$i] : (! [X1:$i] : ((c_In @ ((setminus @ X0) @ X1)) @ (c_Power @ X0))))). % 83b53c6e2122cffca9796caa4c5b1431d936e3b5694255b74ebc24a115abc75a
...
% megalodon_source_map (known "image_5FIn_5FPower" "image_In_Power" "b720a774f9c6eb63e2028292d1adf741faca20e6d6013a8f3a5c8df0d2c2163e")
thf(image_5FIn_5FPower,axiom,(! [X0:$i] : (! [X1:$i] : (! [X2:($i > $i)] : ((! [X3:$i] : (((c_In @ X3) @ X0) => ((c_In @ (X2 @ X3)) @ X1))) => (! [X3:$i] : (((c_In @ X3) @ (c_Power @ X0)) => ((c_In @ ((c_Repl @ X3) @ X2)) @ (c_Power @ X1))))))))). % b720a774f9c6eb63e2028292d1adf741faca20e6d6013a8f3a5c8df0d2c2163e
...
thf(c_Hg1,axiom,(! [X4:$i] : (((c_In @ X4) @ c_B) => ((c_In @ (g @ X4)) @ c_A)))).
% megalodon_source_map (conjecture "conj_c__2Fproject_2Ftmp_2Fsource_5Flinked_5Fstrict_5F100_5Fcorpus_5Ffresh_5F041947_2Fhammer_5F1007_5F43" "/project/tmp/source_linked_strict_100_corpus_fresh_041947/hammer_1007_43" "")
thf(conj_c__2Fproject_2Ftmp_2Fsource_5Flinked_5Fstrict_5F100_5Fcorpus_5Ffresh_5F041947_2Fhammer_5F1007_5F43,conjecture,(! [X4:$i] : (((c_In @ X4) @ (c_Power @ c_A)) => ((c_In @ ((c_Repl @ ((setminus @ c_B) @ ((c_Repl @ ((setminus @ c_A) @ X4)) @ f))) @ g)) @ (c_Power @ c_A))))).
