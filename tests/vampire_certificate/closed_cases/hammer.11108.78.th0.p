% megalodon_origin ((file "/project/Megalodon/examples/hammer/100thms_12_h.mg") (line "11108") (char "78") (kind "aby"))
...
thf(p_tp,type,(p : $i)).
% megalodon_source_map (local_type "a_tp" "a" "")
thf(a_tp,type,(a : $i)).
% megalodon_source_map (local_type "b_tp" "b" "")
thf(b_tp,type,(b : $i)).
...
thf(c_H5,axiom,(((add_5FSNo @ ((mul_5FSNo @ m) @ p)) @ ((mul_5FSNo @ n) @ a)) = (ordsucc @ c_Empty))).
% megalodon_source_map (local_fact "c_Hm" "Hm" "")
thf(c_Hm,axiom,((c_In @ m) @ int)).
% megalodon_source_map (local_fact "c_LpZ" "LpZ" "")
thf(c_LpZ,axiom,((c_In @ p) @ int)).
% megalodon_source_map (local_fact "c_LbS" "LbS" "")
thf(c_LbS,axiom,(c_SNo @ b)).
% megalodon_source_map (local_fact "c_LaS" "LaS" "")
thf(c_LaS,axiom,(c_SNo @ a)).
% megalodon_source_map (conjecture "conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F11108_5F78" "/project/tmp/megalodon3_source_linked_corpus_250/hammer_11108_78" "")
thf(conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F11108_5F78,conjecture,(((add_5FSNo @ ((mul_5FSNo @ b) @ ((mul_5FSNo @ m) @ p))) @ ((mul_5FSNo @ b) @ ((mul_5FSNo @ n) @ a))) = b)).
