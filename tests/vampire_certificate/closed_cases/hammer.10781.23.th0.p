% megalodon_origin ((file "/project/Megalodon/examples/hammer/100thms_12_h.mg") (line "10781") (char "23") (kind "aby"))
...
% megalodon_source_map (conjecture "conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F10781_5F23" "/project/tmp/megalodon3_source_linked_corpus_250/hammer_10781_23" "")
thf(conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F10781_5F23,conjecture,(! [X4:($i > $o)] : ((X4 @ c_Empty) => ((! [X5:$i] : ((X4 @ X5) => (X4 @ (ordsucc @ X5)))) => (X4 @ q))))).
