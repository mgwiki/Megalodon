% megalodon_origin ((file "/project/Megalodon/examples/hammer/100thms_12_h.mg") (line "10806") (char "144") (kind "aby"))
...
thf(c_L4,axiom,((c_In @ ((add_5FSNo @ n) @ (minus_5FSNo @ r))) @ n)).
% megalodon_source_map (local_fact "c_H2" "H2" "")
thf(c_H2,axiom,((c_SNoLt @ c_Empty) @ r)).
% megalodon_source_map (local_fact "c_L3" "L3" "")
thf(c_L3,axiom,(! [X4:$o] : ((((((c_PNoLt @ (c_SNoLev @ c_Empty)) @ (^ [X5:$i] : ((c_In @ X5) @ c_Empty))) @ (c_SNoLev @ r)) @ (^ [X5:$i] : ((c_In @ X5) @ r))) => X4) => (((! [X5:$o] : ((((c_SNoLev @ c_Empty) = (c_SNoLev @ r)) => ((! [X6:$i] : (((c_In @ X6) @ (c_SNoLev @ c_Empty)) => (! [X7:$o] : (((((c_In @ X6) @ c_Empty) => ((c_In @ X6) @ r)) => ((((c_In @ X6) @ r) => ((c_In @ X6) @ c_Empty)) => X7)) => X7)))) => X5)) => X5)) => X4) => X4)))).
% megalodon_source_map (local_fact "c_L2" "L2" "")
thf(c_L2,axiom,(m = ((add_5FSNo @ ((mul_5FSNo @ q) @ n)) @ r))).
% megalodon_source_map (local_fact "c_LqnS" "LqnS" "")
thf(c_LqnS,axiom,(c_SNo @ ((mul_5FSNo @ q) @ n))).
...
% megalodon_source_map (local_fact "c_LrN" "LrN" "")
thf(c_LrN,axiom,(! [X4:($i > $o)] : ((X4 @ c_Empty) => ((! [X5:$i] : ((X4 @ X5) => (X4 @ (ordsucc @ X5)))) => (X4 @ r))))).
% megalodon_source_map (local_fact "c_LqS" "LqS" "")
thf(c_LqS,axiom,(c_SNo @ q)).
% megalodon_source_map (local_fact "c_LqN" "LqN" "")
thf(c_LqN,axiom,(! [X4:($i > $o)] : ((X4 @ c_Empty) => ((! [X5:$i] : ((X4 @ X5) => (X4 @ (ordsucc @ X5)))) => (X4 @ q))))).
% megalodon_source_map (local_fact "c_H1" "H1" "")
thf(c_H1,axiom,(m = ((add_5Fnat @ ((mul_5Fnat @ q) @ n)) @ r))).
% megalodon_source_map (local_fact "c_Hr" "Hr" "")
thf(c_Hr,axiom,((c_In @ r) @ n)).
% megalodon_source_map (local_fact "c_H" "H" "")
thf(c_H,axiom,(! [X4:$o] : ((((c_In @ r) @ n) => ((m = ((add_5Fnat @ ((mul_5Fnat @ q) @ n)) @ r)) => X4)) => X4))).
% megalodon_source_map (local_fact "c_H_src2" "H" "")
thf(c_H_src2,axiom,(! [X4:$o] : ((! [X5:$i] : ((! [X6:$o] : ((((c_In @ X5) @ n) => ((m = ((add_5Fnat @ ((mul_5Fnat @ q) @ n)) @ X5)) => X6)) => X6)) => X4)) => X4))).
% megalodon_source_map (local_fact "c_Hq" "Hq" "")
thf(c_Hq,axiom,((c_In @ q) @ omega)).
% megalodon_source_map (local_fact "c_H_src3" "H" "")
thf(c_H_src3,axiom,(! [X4:$o] : ((((c_In @ q) @ omega) => ((! [X5:$o] : ((! [X6:$i] : ((! [X7:$o] : ((((c_In @ X6) @ n) => ((m = ((add_5Fnat @ ((mul_5Fnat @ q) @ n)) @ X6)) => X7)) => X7)) => X5)) => X5)) => X4)) => X4))).
% megalodon_source_map (local_fact "c_Hm" "Hm" "")
thf(c_Hm,axiom,((c_In @ m) @ omega)).
% megalodon_source_map (local_fact "c_L0n" "L0n" "")
thf(c_L0n,axiom,((c_In @ c_Empty) @ n)).
% megalodon_source_map (local_fact "c_Lno" "Lno" "")
thf(c_Lno,axiom,(! [X4:$o] : (((! [X5:$i] : (((c_In @ X5) @ n) => (! [X6:$i] : (((c_In @ X6) @ X5) => ((c_In @ X6) @ n))))) => ((! [X5:$i] : (((c_In @ X5) @ n) => (! [X6:$i] : (((c_In @ X6) @ X5) => (! [X7:$i] : (((c_In @ X7) @ X6) => ((c_In @ X7) @ X5))))))) => X4)) => X4))).
% megalodon_source_map (local_fact "c_LnN" "LnN" "")
thf(c_LnN,axiom,(! [X4:($i > $o)] : ((X4 @ c_Empty) => ((! [X5:$i] : ((X4 @ X5) => (X4 @ (ordsucc @ X5)))) => (X4 @ n))))).
% megalodon_source_map (local_fact "c_Hn2" "Hn2" "")
thf(c_Hn2,axiom,(((c_In @ n) @ (c_Sing @ c_Empty)) => (! [X4:$o] : X4))).
% megalodon_source_map (local_fact "c_Hn1" "Hn1" "")
thf(c_Hn1,axiom,((c_In @ n) @ omega)).
% megalodon_source_map (local_fact "c_Hn" "Hn" "")
thf(c_Hn,axiom,((c_In @ n) @ ((setminus @ omega) @ (c_Sing @ c_Empty)))).
% megalodon_source_map (conjecture "conj_c__2Fproject_2Ftmp_2Fsource_5Flinked_5Fstrict_5F100_5Fcorpus_5Ffresh_5F041947_2Fhammer_5F10806_5F144" "/project/tmp/source_linked_strict_100_corpus_fresh_041947/hammer_10806_144" "")
thf(conj_c__2Fproject_2Ftmp_2Fsource_5Flinked_5Fstrict_5F100_5Fcorpus_5Ffresh_5F041947_2Fhammer_5F10806_5F144,conjecture,(! [X4:($i > $o)] : ((X4 @ c_Empty) => ((! [X5:$i] : ((X4 @ X5) => (X4 @ (ordsucc @ X5)))) => (X4 @ (ordsucc @ c_Empty)))))).
