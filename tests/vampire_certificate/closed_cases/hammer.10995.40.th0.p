% megalodon_origin ((file "examples/hammer/100thms_12_h.mg") (line "10995") (char "40") (kind "aby"))
...
% megalodon_source_map (known "mul_5FSNo_5Fminus_5FdistrL" "mul_SNo_minus_distrL" "9de1fa9b8752ee1153e808caa30232b5ec190b9a3cddd23374a7c3af91b8fb06")
thf(mul_5FSNo_5Fminus_5FdistrL,axiom,(! [X0:$i] : (! [X1:$i] : ((c_SNo @ X0) => ((c_SNo @ X1) => (((mul_5FSNo @ (minus_5FSNo @ X0)) @ X1) = (minus_5FSNo @ ((mul_5FSNo @ X0) @ X1)))))))). % 9de1fa9b8752ee1153e808caa30232b5ec190b9a3cddd23374a7c3af91b8fb06
...
% megalodon_source_map (local_fact "c_LdS" "LdS" "")
thf(c_LdS,axiom,(c_SNo @ d)).
% megalodon_source_map (local_fact "c_H2" "H2" "")
thf(c_H2,axiom,(((add_5FSNo @ ((mul_5FSNo @ m) @ a)) @ ((mul_5FSNo @ n) @ b)) = d)).
% megalodon_source_map (conjecture "conj_c__2Fproject_2Ftmp_2Fsource_5Flinked_5Fstrict_5F100_5Fcorpus_5Ffresh_5F041947_2Fhammer_5F10995_5F40" "/project/tmp/source_linked_strict_100_corpus_fresh_041947/hammer_10995_40" "")
thf(conj_c__2Fproject_2Ftmp_2Fsource_5Flinked_5Fstrict_5F100_5Fcorpus_5Ffresh_5F041947_2Fhammer_5F10995_5F40,conjecture,(((add_5FSNo @ a) @ (minus_5FSNo @ ((mul_5FSNo @ q) @ d))) = ((add_5FSNo @ a) @ ((mul_5FSNo @ (minus_5FSNo @ q)) @ ((add_5FSNo @ ((mul_5FSNo @ m) @ a)) @ ((mul_5FSNo @ n) @ b)))))).
