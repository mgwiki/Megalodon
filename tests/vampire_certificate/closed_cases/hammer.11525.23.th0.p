% megalodon_origin ((file "/project/Megalodon/examples/hammer/100thms_12_h.mg") (line "11525") (char "23") (kind "aby"))
...
% megalodon_source_map (known "omega_5Fnat_5Fp" "omega_nat_p" "7d6896163f052ef582e2a72a8911b4c98c592a603f8a706a5b5bcba281c2441b")
thf(omega_5Fnat_5Fp,axiom,(! [X0:$i] : (((c_In @ X0) @ omega) => (! [X1:($i > $o)] : ((X1 @ c_Empty) => ((! [X2:$i] : ((X1 @ X2) => (X1 @ (ordsucc @ X2)))) => (X1 @ X0))))))). % 7d6896163f052ef582e2a72a8911b4c98c592a603f8a706a5b5bcba281c2441b
...
thf(n_tp,type,(n : $i)).
% megalodon_source_map (local_fact "c_Lmn1" "Lmn1" "")
thf(c_Lmn1,axiom,((c_In @ ((add_5FSNo @ m) @ n)) @ omega)).
% megalodon_source_map (conjecture "conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F11525_5F23" "/project/tmp/megalodon3_source_linked_corpus_250/hammer_11525_23" "")
thf(conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F11525_5F23,conjecture,(! [X2:($i > $o)] : ((X2 @ c_Empty) => ((! [X3:$i] : ((X2 @ X3) => (X2 @ (ordsucc @ X3)))) => (X2 @ ((add_5FSNo @ m) @ n)))))).
