% megalodon_origin ((file "examples/hammer/100thms_12_h.mg") (line "11696") (char "239") (kind "aby"))
...
thf(c_Hguv,axiom,(((add_5FSNo @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n)) @ (f @ ((binintersect @ u) @ (c_SNoElts_5F @ n)))) = (f @ ((binintersect @ v) @ (c_SNoElts_5F @ n))))).
% megalodon_source_map (local_fact "c_H2" "H2" "")
thf(c_H2,axiom,((c_In @ n) @ v)).
...
% megalodon_source_map (conjecture "conj_c__2Fproject_2Ftmp_2Fsource_5Flinked_5Fstrict_5F100_5Fcorpus_5Ffresh_5F041947_2Fhammer_5F11696_5F239" "/project/tmp/source_linked_strict_100_corpus_fresh_041947/hammer_11696_239" "")
thf(conj_c__2Fproject_2Ftmp_2Fsource_5Flinked_5Fstrict_5F100_5Fcorpus_5Ffresh_5F041947_2Fhammer_5F11696_5F239,conjecture,((c_SNoLt @ (f @ ((binintersect @ v) @ (c_SNoElts_5F @ n)))) @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n))).
