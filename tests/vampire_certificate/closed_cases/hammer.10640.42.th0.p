% megalodon_origin ((file "/project/Megalodon/examples/hammer/100thms_12_h.mg") (line "10640") (char "42") (kind "aby"))
...
% megalodon_source_map (known "int_5FSNo_5Fcases" "int_SNo_cases" "3d50cbc81b78e648c83e89894326eb7c6cd1e5edaf78c0ff1a3887fe05920285")
thf(int_5FSNo_5Fcases,axiom,(! [X0:($i > $o)] : ((! [X1:$i] : (((c_In @ X1) @ omega) => (X0 @ X1))) => ((! [X1:$i] : (((c_In @ X1) @ omega) => (X0 @ (minus_5FSNo @ X1)))) => (! [X1:$i] : (((c_In @ X1) @ int) => (X0 @ X1))))))). % 3d50cbc81b78e648c83e89894326eb7c6cd1e5edaf78c0ff1a3887fe05920285
% megalodon_source_map (conjecture "conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F10640_5F42" "/project/tmp/megalodon3_source_linked_corpus_250/hammer_10640_42" "")
thf(conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F10640_5F42,conjecture,(! [X0:$i] : (((c_In @ X0) @ int) => (c_SNo @ X0)))).
