% megalodon_origin ((file "/project/Megalodon/examples/hammer/100thms_12_h.mg") (line "11399") (char "51") (kind "aby"))
...
% megalodon_source_map (known "nat_5F0" "nat_0" "8184e026ae720ae8ac54902d7e3149de08f2ad09a231d1695d0c97a705e1f859")
thf(nat_5F0,axiom,(! [X0:($i > $o)] : ((X0 @ c_Empty) => ((! [X1:$i] : ((X0 @ X1) => (X0 @ (ordsucc @ X1)))) => (X0 @ c_Empty))))). % 8184e026ae720ae8ac54902d7e3149de08f2ad09a231d1695d0c97a705e1f859
...
% megalodon_source_map (known "exp_5FSNo_5Fnat_5F0" "exp_SNo_nat_0" "0cce75eb9dc3a78ea5ae1dffbb0d90bb8fb0a5c6185009a65844a32a18691c25")
thf(exp_5FSNo_5Fnat_5F0,axiom,(! [X0:$i] : ((c_SNo @ X0) => (((exp_5FSNo_5Fnat @ X0) @ c_Empty) = (ordsucc @ c_Empty))))). % 0cce75eb9dc3a78ea5ae1dffbb0d90bb8fb0a5c6185009a65844a32a18691c25
% megalodon_source_map (known "exp_5FSNo_5Fnat_5FS" "exp_SNo_nat_S" "a3cfdc34163db454184b968ef9b60d6306842eaf811785f876e8fbdee04e40d6")
thf(exp_5FSNo_5Fnat_5FS,axiom,(! [X0:$i] : ((c_SNo @ X0) => (! [X1:$i] : ((! [X2:($i > $o)] : ((X2 @ c_Empty) => ((! [X3:$i] : ((X2 @ X3) => (X2 @ (ordsucc @ X3)))) => (X2 @ X1)))) => (((exp_5FSNo_5Fnat @ X0) @ (ordsucc @ X1)) = ((mul_5FSNo @ X0) @ ((exp_5FSNo_5Fnat @ X0) @ X1)))))))). % a3cfdc34163db454184b968ef9b60d6306842eaf811785f876e8fbdee04e40d6
% megalodon_source_map (conjecture "conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F11399_5F51" "/project/tmp/megalodon3_source_linked_corpus_250/hammer_11399_51" "")
thf(conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F11399_5F51,conjecture,(! [X0:$i] : ((c_SNo @ X0) => (((exp_5FSNo_5Fnat @ X0) @ (ordsucc @ c_Empty)) = X0)))).
