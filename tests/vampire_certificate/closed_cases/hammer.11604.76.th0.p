% megalodon_origin ((file "/project/Megalodon/examples/hammer/100thms_12_h.mg") (line "11604") (char "76") (kind "aby"))
...
% megalodon_source_map (known "c_SNo_5F2" "SNo_2" "e294feb06b6142fa0c75cdbed265d96e77d84f1ceb480d3536848cdd00510cfd")
thf(c_SNo_5F2,axiom,(c_SNo @ (ordsucc @ (ordsucc @ c_Empty)))). % e294feb06b6142fa0c75cdbed265d96e77d84f1ceb480d3536848cdd00510cfd
...
% megalodon_source_map (known "c_SNoLt_5F0_5F2" "SNoLt_0_2" "c4a336580396d372e4b6d61f7434e8cd5f52b05d83a883996ce39b4bf107f6dd")
thf(c_SNoLt_5F0_5F2,axiom,((c_SNoLt @ c_Empty) @ (ordsucc @ (ordsucc @ c_Empty)))). % c4a336580396d372e4b6d61f7434e8cd5f52b05d83a883996ce39b4bf107f6dd
...
% megalodon_source_map (known "add_5FSNo_5F0R" "add_SNo_0R" "75b04e11158df96fb891cbff4ded4c33fe9b6861265d0f11da3175ebf863d5d0")
thf(add_5FSNo_5F0R,axiom,(! [X0:$i] : ((c_SNo @ X0) => (((add_5FSNo @ X0) @ c_Empty) = X0)))). % 75b04e11158df96fb891cbff4ded4c33fe9b6861265d0f11da3175ebf863d5d0
...
% megalodon_source_map (known "exp_5FSNo_5Fnat_5Fpos" "exp_SNo_nat_pos" "60cb7dbd0d34891942701384d4b0ae300e59658bfc6660a91a4b2dbc54eccf08")
thf(exp_5FSNo_5Fnat_5Fpos,axiom,(! [X0:$i] : ((c_SNo @ X0) => (((c_SNoLt @ c_Empty) @ X0) => (! [X1:$i] : ((! [X2:($i > $o)] : ((X2 @ c_Empty) => ((! [X3:$i] : ((X2 @ X3) => (X2 @ (ordsucc @ X3)))) => (X2 @ X1)))) => ((c_SNoLt @ c_Empty) @ ((exp_5FSNo_5Fnat @ X0) @ X1)))))))). % 60cb7dbd0d34891942701384d4b0ae300e59658bfc6660a91a4b2dbc54eccf08
% megalodon_source_map (local_type "n_tp" "n" "")
thf(n_tp,type,(n : $i)).
% megalodon_source_map (local_fact "c_L2npLt2n2n" "L2npLt2n2n" "")
thf(c_L2npLt2n2n,axiom,(! [X1:$i] : ((c_SNo @ X1) => (((c_SNoLt @ X1) @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n)) => ((c_SNoLt @ ((add_5FSNo @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n)) @ X1)) @ ((add_5FSNo @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n)) @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n))))))).
...
thf(c_Hn,axiom,(! [X1:($i > $o)] : ((X1 @ c_Empty) => ((! [X2:$i] : ((X1 @ X2) => (X1 @ (ordsucc @ X2)))) => (X1 @ n))))).
% megalodon_source_map (conjecture "conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F11604_5F76" "/project/tmp/megalodon3_source_linked_corpus_250/hammer_11604_76" "")
thf(conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F11604_5F76,conjecture,((c_SNoLt @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n)) @ ((add_5FSNo @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n)) @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n)))).
