% megalodon_origin ((file "/project/Megalodon/examples/hammer/100thms_12_h.mg") (line "10994") (char "67") (kind "aby"))
...
% megalodon_source_map (known "add_5FSNo_5Fcom" "add_SNo_com" "ccbcc874643c8e73c8e68259a58ad308dbec318a0d9b3dee2c2d0b79d6c6c46c")
thf(add_5FSNo_5Fcom,axiom,(! [X0:$i] : (! [X1:$i] : ((c_SNo @ X0) => ((c_SNo @ X1) => (((add_5FSNo @ X0) @ X1) = ((add_5FSNo @ X1) @ X0))))))). % ccbcc874643c8e73c8e68259a58ad308dbec318a0d9b3dee2c2d0b79d6c6c46c
% megalodon_source_map (known "add_5FSNo_5Fminus_5FL2" "add_SNo_minus_L2" "59fa30fc43c7d7cd6ceb15f964f2605ea43373287dd79fc6ae173423370d3f1b")
thf(add_5FSNo_5Fminus_5FL2,axiom,(! [X0:$i] : (! [X1:$i] : ((c_SNo @ X0) => ((c_SNo @ X1) => (((add_5FSNo @ (minus_5FSNo @ X0)) @ ((add_5FSNo @ X0) @ X1)) = X1)))))). % 59fa30fc43c7d7cd6ceb15f964f2605ea43373287dd79fc6ae173423370d3f1b
...
thf(b_tp,type,(b : $i)).
% megalodon_source_map (local_type "d_tp" "d" "")
thf(d_tp,type,(d : $i)).
...
thf(r_tp,type,(r : $i)).
% megalodon_source_map (local_fact "c_LrS" "LrS" "")
thf(c_LrS,axiom,(c_SNo @ r)).
% megalodon_source_map (local_fact "c_LqdS" "LqdS" "")
thf(c_LqdS,axiom,(c_SNo @ ((mul_5FSNo @ q) @ d))).
% megalodon_source_map (local_fact "c_H1" "H1" "")
thf(c_H1,axiom,(a = ((add_5FSNo @ ((mul_5FSNo @ q) @ d)) @ r))).
% megalodon_source_map (local_fact "c_LaS" "LaS" "")
thf(c_LaS,axiom,(c_SNo @ a)).
% megalodon_source_map (conjecture "conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F10994_5F67" "/project/tmp/megalodon3_source_linked_corpus_250/hammer_10994_67" "")
thf(conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F10994_5F67,conjecture,(r = ((add_5FSNo @ a) @ (minus_5FSNo @ ((mul_5FSNo @ q) @ d))))).
