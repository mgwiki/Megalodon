% megalodon_origin ((file "/project/Megalodon/examples/hammer/100thms_12_h.mg") (line "11497") (char "79") (kind "aby"))
...
% megalodon_source_map (known "c_SNo_5Feps_5F" "SNo_eps_" "bad8d3abde1059b5d5a897709f01b01990ccbd33f061ef50ca87baa3c919b810")
thf(c_SNo_5Feps_5F,axiom,(! [X0:$i] : (((c_In @ X0) @ omega) => (c_SNo @ (eps_5F @ X0))))). % bad8d3abde1059b5d5a897709f01b01990ccbd33f061ef50ca87baa3c919b810
...
% megalodon_source_map (known "mul_5FSNo_5Fcom" "mul_SNo_com" "b53e7266d2b8331cdd95ca20b7f6811d0a460fc67be322cf74fb2af1d281ea4c")
thf(mul_5FSNo_5Fcom,axiom,(! [X0:$i] : (! [X1:$i] : ((c_SNo @ X0) => ((c_SNo @ X1) => (((mul_5FSNo @ X0) @ X1) = ((mul_5FSNo @ X1) @ X0))))))). % b53e7266d2b8331cdd95ca20b7f6811d0a460fc67be322cf74fb2af1d281ea4c
...
% megalodon_source_map (known "c_SNo_5Fexp_5FSNo_5Fnat" "SNo_exp_SNo_nat" "2e79ac0134c4519c3c403c840111ca4605aa24474fff41703f5f21e0e974a9aa")
thf(c_SNo_5Fexp_5FSNo_5Fnat,axiom,(! [X0:$i] : ((c_SNo @ X0) => (! [X1:$i] : ((! [X2:($i > $o)] : ((X2 @ c_Empty) => ((! [X3:$i] : ((X2 @ X3) => (X2 @ (ordsucc @ X3)))) => (X2 @ X1)))) => (c_SNo @ ((exp_5FSNo_5Fnat @ X0) @ X1))))))). % 2e79ac0134c4519c3c403c840111ca4605aa24474fff41703f5f21e0e974a9aa
% megalodon_source_map (known "mul_5FSNo_5Feps_5Fpower_5F2" "mul_SNo_eps_power_2" "7349fd5f3f2a711d3ec85914c0738b80b9761d82bb17f31f66c219d8c95620c2")
thf(mul_5FSNo_5Feps_5Fpower_5F2,axiom,(! [X0:$i] : ((! [X1:($i > $o)] : ((X1 @ c_Empty) => ((! [X2:$i] : ((X1 @ X2) => (X1 @ (ordsucc @ X2)))) => (X1 @ X0)))) => (((mul_5FSNo @ (eps_5F @ X0)) @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ X0)) = (ordsucc @ c_Empty))))). % 7349fd5f3f2a711d3ec85914c0738b80b9761d82bb17f31f66c219d8c95620c2
% megalodon_source_map (conjecture "conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F11497_5F79" "/project/tmp/megalodon3_source_linked_corpus_250/hammer_11497_79" "")
thf(conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F11497_5F79,conjecture,(! [X0:$i] : ((! [X1:($i > $o)] : ((X1 @ c_Empty) => ((! [X2:$i] : ((X1 @ X2) => (X1 @ (ordsucc @ X2)))) => (X1 @ X0)))) => (((mul_5FSNo @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ X0)) @ (eps_5F @ X0)) = (ordsucc @ c_Empty))))).
