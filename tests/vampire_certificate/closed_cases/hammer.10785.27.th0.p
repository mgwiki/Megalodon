% megalodon_origin ((file "/project/Megalodon/examples/hammer/100thms_12_h.mg") (line "10785") (char "27") (kind "aby"))
...
% megalodon_source_map (known "nat_5Fp_5Ftrans" "nat_p_trans" "02c1be4fb7e8692a5ff13768a268b8f86936de1e79562d2d1c2a93838bee6cd2")
thf(nat_5Fp_5Ftrans,axiom,(! [X0:$i] : ((! [X1:($i > $o)] : ((X1 @ c_Empty) => ((! [X2:$i] : ((X1 @ X2) => (X1 @ (ordsucc @ X2)))) => (X1 @ X0)))) => (! [X1:$i] : (((c_In @ X1) @ X0) => (! [X2:($i > $o)] : ((X2 @ c_Empty) => ((! [X3:$i] : ((X2 @ X3) => (X2 @ (ordsucc @ X3)))) => (X2 @ X1))))))))). % 02c1be4fb7e8692a5ff13768a268b8f86936de1e79562d2d1c2a93838bee6cd2
...
% megalodon_source_map (conjecture "conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F10785_5F27" "/project/tmp/megalodon3_source_linked_corpus_250/hammer_10785_27" "")
thf(conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F10785_5F27,conjecture,(! [X4:($i > $o)] : ((X4 @ c_Empty) => ((! [X5:$i] : ((X4 @ X5) => (X4 @ (ordsucc @ X5)))) => (X4 @ r))))).
