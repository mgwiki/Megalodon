% megalodon_origin ((file "examples/hammer/100thms_12_h.mg") (line "11888") (char "36") (kind "aby"))
...
thf(c_X_27_def,definition,(c_X_27 = ((c_Repl @ c_X) @ (^ [X1:$i] : (minus_5FSNo @ X1))))).
% megalodon_source_map (local_fact "c_HX" "HX" "")
thf(c_HX,axiom,(! [X1:$i] : (((c_In @ X1) @ c_X) => (c_SNo @ X1)))).
% megalodon_source_map (conjecture "conj_c__2Fproject_2Ftmp_2Fsource_5Flinked_5Fstrict_5F100_5Fcorpus_5Ffresh_5F041947_2Fhammer_5F11888_5F36" "/project/tmp/source_linked_strict_100_corpus_fresh_041947/hammer_11888_36" "")
thf(conj_c__2Fproject_2Ftmp_2Fsource_5Flinked_5Fstrict_5F100_5Fcorpus_5Ffresh_5F041947_2Fhammer_5F11888_5F36,conjecture,(! [X1:$i] : (((c_In @ X1) @ ((c_Repl @ c_X) @ minus_5FSNo)) => (c_SNo @ X1)))).
