% megalodon_origin ((file "examples/hammer/100thms_12_h.mg") (line "11635") (char "105") (kind "aby"))
...
% megalodon_source_map (known "c_If_5Fi_5F1" "If_i_1" "c46dcd5309c285bba711ee85bc9b53bf80d0b7243e6070e8ef41cc2ae69c7362")
thf(c_If_5Fi_5F1,axiom,(! [X0:$o] : (! [X1:$i] : (! [X2:$i] : (X0 => ((((c_If_5Fi @ X0) @ X1) @ X2) = X1)))))). % c46dcd5309c285bba711ee85bc9b53bf80d0b7243e6070e8ef41cc2ae69c7362
...
thf(c_H1,axiom,((c_In @ n) @ x)).
% megalodon_source_map (local_fact "c_Lf" "Lf" "")
thf(c_Lf,axiom,(! [X3:$i] : (((c_In @ X3) @ ((c_Sep @ (c_SNoS_5F @ omega)) @ (^ [X4:$i] : ((c_SNoLev @ X4) = (ordsucc @ n))))) => (! [X4:$o] : (((! [X5:($i > $o)] : ((X5 @ c_Empty) => ((! [X6:$i] : ((X5 @ X6) => (X5 @ (ordsucc @ X6)))) => (X5 @ (f @ ((binintersect @ X3) @ (c_SNoElts_5F @ n))))))) => ((! [X5:$o] : (((! [X6:$i] : (((c_In @ X6) @ (f @ ((binintersect @ X3) @ (c_SNoElts_5F @ n)))) => (! [X7:$i] : (((c_In @ X7) @ X6) => ((c_In @ X7) @ (f @ ((binintersect @ X3) @ (c_SNoElts_5F @ n)))))))) => ((! [X6:$i] : (((c_In @ X6) @ (f @ ((binintersect @ X3) @ (c_SNoElts_5F @ n)))) => (! [X7:$i] : (((c_In @ X7) @ X6) => (! [X8:$i] : (((c_In @ X8) @ X7) => ((c_In @ X8) @ X6))))))) => X5)) => X5)) => ((c_SNo @ (f @ ((binintersect @ X3) @ (c_SNoElts_5F @ n)))) => (((c_SNoLt @ (f @ ((binintersect @ X3) @ (c_SNoElts_5F @ n)))) @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n)) => X4)))) => X4))))).
% megalodon_source_map (local_fact "c_L2" "L2" "")
thf(c_L2,axiom,(! [X3:$i] : (((c_In @ X3) @ ((c_Sep @ (c_SNoS_5F @ omega)) @ (^ [X4:$i] : ((c_SNoLev @ X4) = (ordsucc @ n))))) => (! [X4:$o] : (((c_SNo @ X3) => (((c_SNoLev @ X3) = (ordsucc @ n)) => (((c_In @ ((binintersect @ X3) @ (c_SNoElts_5F @ n))) @ ((c_Sep @ (c_SNoS_5F @ omega)) @ (^ [X5:$i] : ((c_SNoLev @ X5) = n)))) => ((c_SNo @ ((binintersect @ X3) @ (c_SNoElts_5F @ n))) => (((c_SNoLev @ ((binintersect @ X3) @ (c_SNoElts_5F @ n))) = n) => X4))))) => X4))))).
% megalodon_source_map (local_fact "c_Hf3" "Hf3" "")
thf(c_Hf3,axiom,(! [X3:$i] : (((c_In @ X3) @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n)) => (! [X4:$o] : ((! [X5:$i] : ((! [X6:$o] : ((((c_In @ X5) @ ((c_Sep @ (c_SNoS_5F @ omega)) @ (^ [X7:$i] : ((c_SNoLev @ X7) = n)))) => (((f @ X5) = X3) => X6)) => X6)) => X4)) => X4))))).
% megalodon_source_map (local_fact "c_Hf2" "Hf2" "")
thf(c_Hf2,axiom,(! [X3:$i] : (((c_In @ X3) @ ((c_Sep @ (c_SNoS_5F @ omega)) @ (^ [X4:$i] : ((c_SNoLev @ X4) = n)))) => (! [X4:$i] : (((c_In @ X4) @ ((c_Sep @ (c_SNoS_5F @ omega)) @ (^ [X5:$i] : ((c_SNoLev @ X5) = n)))) => (((f @ X3) = (f @ X4)) => (X3 = X4))))))).
% megalodon_source_map (local_fact "c_Hf1" "Hf1" "")
thf(c_Hf1,axiom,(! [X3:$i] : (((c_In @ X3) @ ((c_Sep @ (c_SNoS_5F @ omega)) @ (^ [X4:$i] : ((c_SNoLev @ X4) = n)))) => ((c_In @ (f @ X3)) @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n))))).
% megalodon_source_map (local_fact "c_Hf" "Hf" "")
thf(c_Hf,axiom,(! [X3:$o] : (((! [X4:$o] : (((! [X5:$i] : (((c_In @ X5) @ ((c_Sep @ (c_SNoS_5F @ omega)) @ (^ [X6:$i] : ((c_SNoLev @ X6) = n)))) => ((c_In @ (f @ X5)) @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n)))) => ((! [X5:$i] : (((c_In @ X5) @ ((c_Sep @ (c_SNoS_5F @ omega)) @ (^ [X6:$i] : ((c_SNoLev @ X6) = n)))) => (! [X6:$i] : (((c_In @ X6) @ ((c_Sep @ (c_SNoS_5F @ omega)) @ (^ [X7:$i] : ((c_SNoLev @ X7) = n)))) => (((f @ X5) = (f @ X6)) => (X5 = X6)))))) => X4)) => X4)) => ((! [X4:$i] : (((c_In @ X4) @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n)) => (! [X5:$o] : ((! [X6:$i] : ((! [X7:$o] : ((((c_In @ X6) @ ((c_Sep @ (c_SNoS_5F @ omega)) @ (^ [X8:$i] : ((c_SNoLev @ X8) = n)))) => (((f @ X6) = X4) => X7)) => X7)) => X5)) => X5)))) => X3)) => X3))).
...
thf(c_L2npLt2n2n,axiom,(! [X3:$i] : ((c_SNo @ X3) => (((c_SNoLt @ X3) @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n)) => ((c_SNoLt @ ((add_5FSNo @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n)) @ X3)) @ ((add_5FSNo @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n)) @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n))))))).
...
thf(c_L2n2n2,axiom,(! [X3:$o] : (((! [X4:$i] : (((c_In @ X4) @ ((add_5FSNo @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n)) @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n))) => (! [X5:$i] : (((c_In @ X5) @ X4) => ((c_In @ X5) @ ((add_5FSNo @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n)) @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n))))))) => ((! [X4:$i] : (((c_In @ X4) @ ((add_5FSNo @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n)) @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n))) => (! [X5:$i] : (((c_In @ X5) @ X4) => (! [X6:$i] : (((c_In @ X6) @ X5) => ((c_In @ X6) @ X4))))))) => X3)) => X3))).
% megalodon_source_map (local_fact "c_L2n2n1" "L2n2n1" "")
thf(c_L2n2n1,axiom,(! [X3:($i > $o)] : ((X3 @ c_Empty) => ((! [X4:$i] : ((X3 @ X4) => (X3 @ (ordsucc @ X4)))) => (X3 @ ((add_5FSNo @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n)) @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n))))))).
...
thf(c_L2n2,axiom,(! [X3:$o] : (((! [X4:$i] : (((c_In @ X4) @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n)) => (! [X5:$i] : (((c_In @ X5) @ X4) => ((c_In @ X5) @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n)))))) => ((! [X4:$i] : (((c_In @ X4) @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n)) => (! [X5:$i] : (((c_In @ X5) @ X4) => (! [X6:$i] : (((c_In @ X6) @ X5) => ((c_In @ X6) @ X4))))))) => X3)) => X3))).
% megalodon_source_map (local_fact "c_L2n1" "L2n1" "")
thf(c_L2n1,axiom,(! [X3:($i > $o)] : ((X3 @ c_Empty) => ((! [X4:$i] : ((X3 @ X4) => (X3 @ (ordsucc @ X4)))) => (X3 @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n)))))).
% megalodon_source_map (local_fact "c_IHn" "IHn" "")
thf(c_IHn,axiom,(! [X3:$o] : ((! [X4:($i > $i)] : ((! [X5:$o] : (((! [X6:$o] : (((! [X7:$i] : (((c_In @ X7) @ ((c_Sep @ (c_SNoS_5F @ omega)) @ (^ [X8:$i] : ((c_SNoLev @ X8) = n)))) => ((c_In @ (X4 @ X7)) @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n)))) => ((! [X7:$i] : (((c_In @ X7) @ ((c_Sep @ (c_SNoS_5F @ omega)) @ (^ [X8:$i] : ((c_SNoLev @ X8) = n)))) => (! [X8:$i] : (((c_In @ X8) @ ((c_Sep @ (c_SNoS_5F @ omega)) @ (^ [X9:$i] : ((c_SNoLev @ X9) = n)))) => (((X4 @ X7) = (X4 @ X8)) => (X7 = X8)))))) => X6)) => X6)) => ((! [X6:$i] : (((c_In @ X6) @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n)) => (! [X7:$o] : ((! [X8:$i] : ((! [X9:$o] : ((((c_In @ X8) @ ((c_Sep @ (c_SNoS_5F @ omega)) @ (^ [X10:$i] : ((c_SNoLev @ X10) = n)))) => (((X4 @ X8) = X6) => X9)) => X9)) => X7)) => X7)))) => X5)) => X5)) => X3)) => X3))).
% megalodon_source_map (local_fact "c_Hn" "Hn" "")
thf(c_Hn,axiom,(! [X3:($i > $o)] : ((X3 @ c_Empty) => ((! [X4:$i] : ((X3 @ X4) => (X3 @ (ordsucc @ X4)))) => (X3 @ n))))).
% megalodon_source_map (conjecture "conj_c__2Fproject_2Ftmp_2Fsource_5Flinked_5Fstrict_5F100_5Fcorpus_5Ffresh_5F041947_2Fhammer_5F11635_5F105" "/project/tmp/source_linked_strict_100_corpus_fresh_041947/hammer_11635_105" "")
thf(conj_c__2Fproject_2Ftmp_2Fsource_5Flinked_5Fstrict_5F100_5Fcorpus_5Ffresh_5F041947_2Fhammer_5F11635_5F105,conjecture,((((c_If_5Fi @ ((c_In @ n) @ x)) @ (f @ ((binintersect @ x) @ (c_SNoElts_5F @ n)))) @ ((add_5FSNo @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n)) @ (f @ ((binintersect @ x) @ (c_SNoElts_5F @ n))))) = (f @ ((binintersect @ x) @ (c_SNoElts_5F @ n))))).
