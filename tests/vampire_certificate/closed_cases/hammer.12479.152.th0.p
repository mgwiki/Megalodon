% megalodon_origin ((file "/project/Megalodon/examples/hammer/100thms_12_h.mg") (line "12479") (char "152") (kind "aby"))
...
thf(c_Hw_272,axiom,(! [X4:$o] : ((((((c_PNoLt @ (c_SNoLev @ w)) @ (^ [X5:$i] : ((c_In @ X5) @ w))) @ (c_SNoLev @ w_27)) @ (^ [X5:$i] : ((c_In @ X5) @ w_27))) => X4) => (((! [X5:$o] : ((((c_SNoLev @ w) = (c_SNoLev @ w_27)) => ((! [X6:$i] : (((c_In @ X6) @ (c_SNoLev @ w)) => (! [X7:$o] : (((((c_In @ X6) @ w) => ((c_In @ X6) @ w_27)) => ((((c_In @ X6) @ w_27) => ((c_In @ X6) @ w)) => X7)) => X7)))) => X5)) => X5)) => X4) => X4)))).
% megalodon_source_map (local_fact "c_Hw_271" "Hw'1" "")
thf(c_Hw_271,axiom,((c_In @ w_27) @ ((famunion @ omega) @ (^ [X4:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X4)) @ c_Empty))))).
% megalodon_source_map (local_fact "c_Hw_27" "Hw'" "")
thf(c_Hw_27,axiom,(! [X4:$o] : ((((c_In @ w_27) @ ((famunion @ omega) @ (^ [X5:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X5)) @ c_Empty)))) => ((! [X5:$o] : ((((((c_PNoLt @ (c_SNoLev @ w)) @ (^ [X6:$i] : ((c_In @ X6) @ w))) @ (c_SNoLev @ w_27)) @ (^ [X6:$i] : ((c_In @ X6) @ w_27))) => X5) => (((! [X6:$o] : ((((c_SNoLev @ w) = (c_SNoLev @ w_27)) => ((! [X7:$i] : (((c_In @ X7) @ (c_SNoLev @ w)) => (! [X8:$o] : (((((c_In @ X7) @ w) => ((c_In @ X7) @ w_27)) => ((((c_In @ X7) @ w_27) => ((c_In @ X7) @ w)) => X8)) => X8)))) => X6)) => X6)) => X5) => X5))) => X4)) => X4))).
...
thf(c_Hw3,axiom,((c_SNoLt @ w) @ ((c_SNoCut @ ((famunion @ omega) @ (^ [X4:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X4)) @ c_Empty)))) @ ((famunion @ omega) @ (^ [X4:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X4)) @ (ordsucc @ c_Empty))))))).
...
thf(c_Hw,axiom,((c_In @ w) @ (c_SNoL @ ((c_SNoCut @ ((famunion @ omega) @ (^ [X4:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X4)) @ c_Empty)))) @ ((famunion @ omega) @ (^ [X4:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X4)) @ (ordsucc @ c_Empty)))))))).
% megalodon_source_map (local_fact "c_Hv" "Hv" "")
thf(c_Hv,axiom,((c_In @ v) @ (c_SNoR @ x))).
...
% megalodon_source_map (conjecture "conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F12479_5F152" "/project/tmp/megalodon3_source_linked_corpus_250/hammer_12479_152" "")
thf(conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F12479_5F152,conjecture,(c_SNo @ w_27)).
