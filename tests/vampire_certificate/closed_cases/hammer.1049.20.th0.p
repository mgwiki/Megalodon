% megalodon_origin ((file "examples/hammer/100thms_12_h.mg") (line "1049") (char "20") (kind "aby"))
...
thf(c_H4,axiom,((c_In @ y) @ c_Y)).
% megalodon_source_map (local_fact "c_H2" "H2" "")
thf(c_H2,axiom,(((c_Repl @ ((setminus @ c_B) @ ((c_Repl @ ((setminus @ c_A) @ c_Y)) @ f))) @ g) = c_Y)).
% megalodon_source_map (conjecture "conj_c__2Fproject_2Ftmp_2Fsource_5Flinked_5Fstrict_5F100_5Fcorpus_5Ffresh_5F041947_2Fhammer_5F1049_5F20" "/project/tmp/source_linked_strict_100_corpus_fresh_041947/hammer_1049_20" "")
thf(conj_c__2Fproject_2Ftmp_2Fsource_5Flinked_5Fstrict_5F100_5Fcorpus_5Ffresh_5F041947_2Fhammer_5F1049_5F20,conjecture,((c_In @ y) @ ((c_Repl @ ((setminus @ c_B) @ ((c_Repl @ ((setminus @ c_A) @ c_Y)) @ f))) @ g))).
