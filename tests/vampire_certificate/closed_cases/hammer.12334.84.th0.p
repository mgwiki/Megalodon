% megalodon_origin ((file "/project/Megalodon/examples/hammer/100thms_12_h.mg") (line "12334") (char "84") (kind "aby"))
...
% megalodon_source_map (known "mul_5FSNo_5Fpos_5Fpos" "mul_SNo_pos_pos" "d3b05b9692591b95f07be342649cb40d78b96676b4451291f94b808e8f4b8667")
thf(mul_5FSNo_5Fpos_5Fpos,axiom,(! [X0:$i] : (! [X1:$i] : ((c_SNo @ X0) => ((c_SNo @ X1) => (((c_SNoLt @ c_Empty) @ X0) => (((c_SNoLt @ c_Empty) @ X1) => ((c_SNoLt @ c_Empty) @ ((mul_5FSNo @ X0) @ X1))))))))). % d3b05b9692591b95f07be342649cb40d78b96676b4451291f94b808e8f4b8667
...
thf(c_L4,axiom,((c_SNoLt @ c_Empty) @ ((c_SNoCut @ ((famunion @ omega) @ (^ [X1:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X1)) @ c_Empty)))) @ ((famunion @ omega) @ (^ [X1:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X1)) @ (ordsucc @ c_Empty))))))).
% megalodon_source_map (local_fact "c_L3" "L3" "")
thf(c_L3,axiom,(c_SNo @ ((mul_5FSNo @ x) @ ((c_SNoCut @ ((famunion @ omega) @ (^ [X1:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X1)) @ c_Empty)))) @ ((famunion @ omega) @ (^ [X1:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X1)) @ (ordsucc @ c_Empty)))))))).
% megalodon_source_map (local_fact "c_H5" "H5" "")
thf(c_H5,axiom,(! [X1:$i] : ((c_SNo @ X1) => ((! [X2:$i] : (((c_In @ X2) @ ((famunion @ omega) @ (^ [X3:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X3)) @ c_Empty)))) => ((c_SNoLt @ X2) @ X1))) => ((! [X2:$i] : (((c_In @ X2) @ ((famunion @ omega) @ (^ [X3:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X3)) @ (ordsucc @ c_Empty))))) => ((c_SNoLt @ X1) @ X2))) => (! [X2:$o] : (((! [X3:$i] : (((c_In @ X3) @ (c_SNoLev @ ((c_SNoCut @ ((famunion @ omega) @ (^ [X4:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X4)) @ c_Empty)))) @ ((famunion @ omega) @ (^ [X4:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X4)) @ (ordsucc @ c_Empty))))))) => ((c_In @ X3) @ (c_SNoLev @ X1)))) => ((! [X3:$i] : (((c_In @ X3) @ (c_SNoLev @ ((c_SNoCut @ ((famunion @ omega) @ (^ [X4:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X4)) @ c_Empty)))) @ ((famunion @ omega) @ (^ [X4:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X4)) @ (ordsucc @ c_Empty))))))) => (! [X4:$o] : (((((c_In @ X3) @ ((c_SNoCut @ ((famunion @ omega) @ (^ [X5:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X5)) @ c_Empty)))) @ ((famunion @ omega) @ (^ [X5:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X5)) @ (ordsucc @ c_Empty)))))) => ((c_In @ X3) @ X1)) => ((((c_In @ X3) @ X1) => ((c_In @ X3) @ ((c_SNoCut @ ((famunion @ omega) @ (^ [X5:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X5)) @ c_Empty)))) @ ((famunion @ omega) @ (^ [X5:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X5)) @ (ordsucc @ c_Empty))))))) => X4)) => X4)))) => X2)) => X2))))))).
% megalodon_source_map (local_fact "c_H4" "H4" "")
thf(c_H4,axiom,(! [X1:$i] : (((c_In @ X1) @ ((famunion @ omega) @ (^ [X2:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X2)) @ (ordsucc @ c_Empty))))) => ((c_SNoLt @ ((c_SNoCut @ ((famunion @ omega) @ (^ [X2:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X2)) @ c_Empty)))) @ ((famunion @ omega) @ (^ [X2:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X2)) @ (ordsucc @ c_Empty)))))) @ X1)))).
% megalodon_source_map (local_fact "c_H3" "H3" "")
thf(c_H3,axiom,(! [X1:$i] : (((c_In @ X1) @ ((famunion @ omega) @ (^ [X2:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X2)) @ c_Empty)))) => ((c_SNoLt @ X1) @ ((c_SNoCut @ ((famunion @ omega) @ (^ [X2:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X2)) @ c_Empty)))) @ ((famunion @ omega) @ (^ [X2:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X2)) @ (ordsucc @ c_Empty))))))))).
% megalodon_source_map (local_fact "c_H2" "H2" "")
thf(c_H2,axiom,((c_In @ (c_SNoLev @ ((c_SNoCut @ ((famunion @ omega) @ (^ [X1:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X1)) @ c_Empty)))) @ ((famunion @ omega) @ (^ [X1:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X1)) @ (ordsucc @ c_Empty))))))) @ (ordsucc @ ((binunion @ ((famunion @ ((famunion @ omega) @ (^ [X1:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X1)) @ c_Empty)))) @ (^ [X1:$i] : (ordsucc @ (c_SNoLev @ X1))))) @ ((famunion @ ((famunion @ omega) @ (^ [X1:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X1)) @ (ordsucc @ c_Empty))))) @ (^ [X1:$i] : (ordsucc @ (c_SNoLev @ X1)))))))).
% megalodon_source_map (local_fact "c_H1" "H1" "")
thf(c_H1,axiom,(c_SNo @ ((c_SNoCut @ ((famunion @ omega) @ (^ [X1:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X1)) @ c_Empty)))) @ ((famunion @ omega) @ (^ [X1:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X1)) @ (ordsucc @ c_Empty))))))).
% megalodon_source_map (local_fact "c_HLR" "HLR" "")
thf(c_HLR,axiom,(! [X1:$i] : (((c_In @ X1) @ ((famunion @ omega) @ (^ [X2:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X2)) @ c_Empty)))) => (! [X2:$i] : (((c_In @ X2) @ ((famunion @ omega) @ (^ [X3:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X3)) @ (ordsucc @ c_Empty))))) => ((c_SNoLt @ X1) @ X2)))))).
% megalodon_source_map (local_fact "c_HR" "HR" "")
thf(c_HR,axiom,(! [X1:$i] : (((c_In @ X1) @ ((famunion @ omega) @ (^ [X2:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X2)) @ (ordsucc @ c_Empty))))) => (c_SNo @ X1)))).
% megalodon_source_map (local_fact "c_HL" "HL" "")
thf(c_HL,axiom,(! [X1:$i] : (((c_In @ X1) @ ((famunion @ omega) @ (^ [X2:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X2)) @ c_Empty)))) => (c_SNo @ X1)))).
% megalodon_source_map (local_fact "c_HLHR" "HLHR" "")
thf(c_HLHR,axiom,(! [X1:$o] : (((! [X2:$i] : (((c_In @ X2) @ ((famunion @ omega) @ (^ [X3:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X3)) @ c_Empty)))) => (c_SNo @ X2))) => ((! [X2:$i] : (((c_In @ X2) @ ((famunion @ omega) @ (^ [X3:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X3)) @ (ordsucc @ c_Empty))))) => (c_SNo @ X2))) => X1)) => X1))).
% megalodon_source_map (local_fact "c_L2" "L2" "")
thf(c_L2,axiom,(! [X1:$o] : (((! [X2:$o] : (((! [X3:$i] : (((c_In @ X3) @ ((famunion @ omega) @ (^ [X4:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X4)) @ c_Empty)))) => (c_SNo @ X3))) => ((! [X3:$i] : (((c_In @ X3) @ ((famunion @ omega) @ (^ [X4:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X4)) @ (ordsucc @ c_Empty))))) => (c_SNo @ X3))) => X2)) => X2)) => ((! [X2:$i] : (((c_In @ X2) @ ((famunion @ omega) @ (^ [X3:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X3)) @ c_Empty)))) => (! [X3:$i] : (((c_In @ X3) @ ((famunion @ omega) @ (^ [X4:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X4)) @ (ordsucc @ c_Empty))))) => ((c_SNoLt @ X2) @ X3))))) => X1)) => X1))).
% megalodon_source_map (local_fact "c_L1R" "L1R" "")
thf(c_L1R,axiom,(! [X1:$i] : (((c_In @ X1) @ ((famunion @ omega) @ (^ [X2:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X2)) @ (ordsucc @ c_Empty))))) => ((c_SNoLt @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ x) @ X1))))).
% megalodon_source_map (local_fact "c_L1L" "L1L" "")
thf(c_L1L,axiom,(! [X1:$i] : (((c_In @ X1) @ ((famunion @ omega) @ (^ [X2:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X2)) @ c_Empty)))) => ((c_SNoLt @ ((mul_5FSNo @ x) @ X1)) @ (ordsucc @ c_Empty))))).
% megalodon_source_map (local_fact "c_L1" "L1" "")
thf(c_L1,axiom,(! [X1:$i] : ((! [X2:($i > $o)] : ((X2 @ c_Empty) => ((! [X3:$i] : ((X2 @ X3) => (X2 @ (ordsucc @ X3)))) => (X2 @ X1)))) => (! [X2:$o] : (((! [X3:$i] : (((c_In @ X3) @ ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X1)) @ c_Empty)) => (! [X4:$o] : (((c_SNo @ X3) => (((c_SNoLt @ ((mul_5FSNo @ x) @ X3)) @ (ordsucc @ c_Empty)) => X4)) => X4)))) => ((! [X3:$i] : (((c_In @ X3) @ ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X1)) @ (ordsucc @ c_Empty))) => (! [X4:$o] : (((c_SNo @ X3) => (((c_SNoLt @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ x) @ X3)) => X4)) => X4)))) => X2)) => X2))))).
% megalodon_source_map (local_fact "c_Hxpos" "Hxpos" "")
thf(c_Hxpos,axiom,((c_SNoLt @ c_Empty) @ x)).
% megalodon_source_map (local_fact "c_IH" "IH" "")
thf(c_IH,axiom,(! [X1:$i] : (((c_In @ X1) @ (c_SNoS_5F @ (c_SNoLev @ x))) => (((c_SNoLt @ c_Empty) @ X1) => (! [X2:$o] : (((c_SNo @ (recip_5FSNo_5Fpos @ X1)) => ((((mul_5FSNo @ X1) @ (recip_5FSNo_5Fpos @ X1)) = (ordsucc @ c_Empty)) => X2)) => X2)))))).
% megalodon_source_map (local_fact "c_Hx" "Hx" "")
thf(c_Hx,axiom,(c_SNo @ x)).
% megalodon_source_map (conjecture "conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F12334_5F84" "/project/tmp/megalodon3_source_linked_corpus_250/hammer_12334_84" "")
thf(conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F12334_5F84,conjecture,((c_SNoLt @ c_Empty) @ ((mul_5FSNo @ x) @ ((c_SNoCut @ ((famunion @ omega) @ (^ [X1:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X1)) @ c_Empty)))) @ ((famunion @ omega) @ (^ [X1:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X1)) @ (ordsucc @ c_Empty)))))))).
