% megalodon_origin ((file "examples/hammer/100thms_12_h.mg") (line "11870") (char "37") (kind "aby"))
...
% megalodon_source_map (known "c_ReplE_5Fimpred" "ReplE_impred" "5a437ac4e488ce7d17930db96be3a05fedb176499de23c2788527e613f212aa5")
thf(c_ReplE_5Fimpred,axiom,(! [X0:$i] : (! [X1:($i > $i)] : (! [X2:$i] : (((c_In @ X2) @ ((c_Repl @ X0) @ X1)) => (! [X3:$o] : ((! [X4:$i] : (((c_In @ X4) @ X0) => ((X2 = (X1 @ X4)) => X3))) => X3))))))). % 5a437ac4e488ce7d17930db96be3a05fedb176499de23c2788527e613f212aa5
...
% megalodon_source_map (known "ordsuccI1" "ordsuccI1" "1d5d5b7b71ce4bb9a73edbf50070235dcc5bed8bf5dd7baab447bbd91db9807a")
thf(ordsuccI1,axiom,(! [X0:$i] : (! [X1:$i] : (((c_In @ X1) @ X0) => ((c_In @ X1) @ (ordsucc @ X0)))))). % 1d5d5b7b71ce4bb9a73edbf50070235dcc5bed8bf5dd7baab447bbd91db9807a
...
thf(n_tp,type,(n : $i)).
% megalodon_source_map (local_type "c_X_tp" "X" "")
thf(c_X_tp,type,(c_X : $i)).
% megalodon_source_map (local_type "f_tp" "f" "")
thf(f_tp,type,(f : ($i > $i))).
% megalodon_source_map (local_type "c_X_27_tp" "X'" "")
thf(c_X_27_tp,type,(c_X_27 : $i)).
% megalodon_source_map (local_definition "c_X_27_def" "X'" "")
thf(c_X_27_def,definition,(c_X_27 = ((c_Repl @ (ordsucc @ n)) @ (^ [X3:$i] : (f @ X3))))).
% megalodon_source_map (local_fact "c_Hf1" "Hf1" "")
thf(c_Hf1,axiom,(! [X3:$i] : (((c_In @ X3) @ (ordsucc @ (ordsucc @ n))) => ((c_In @ (f @ X3)) @ c_X)))).
% megalodon_source_map (conjecture "conj_c__2Fproject_2Ftmp_2Fsource_5Flinked_5Fstrict_5F100_5Fcorpus_5Ffresh_5F041947_2Fhammer_5F11870_5F37" "/project/tmp/source_linked_strict_100_corpus_fresh_041947/hammer_11870_37" "")
thf(conj_c__2Fproject_2Ftmp_2Fsource_5Flinked_5Fstrict_5F100_5Fcorpus_5Ffresh_5F041947_2Fhammer_5F11870_5F37,conjecture,(! [X3:$i] : (((c_In @ X3) @ ((c_Repl @ (ordsucc @ n)) @ f)) => ((c_In @ X3) @ c_X)))).
