% megalodon_origin ((file "examples/hammer/100thms_12_h.mg") (line "11287") (char "64") (kind "aby"))
...
% megalodon_source_map (known "pos_5Fmul_5FSNo_5FLt" "pos_mul_SNo_Lt" "cc45b1564fb6e160fca709ac04672be251b7bdec3d8a6fc9933464dfe6f1b151")
thf(pos_5Fmul_5FSNo_5FLt,axiom,(! [X0:$i] : (! [X1:$i] : (! [X2:$i] : ((c_SNo @ X0) => (((c_SNoLt @ c_Empty) @ X0) => ((c_SNo @ X1) => ((c_SNo @ X2) => (((c_SNoLt @ X1) @ X2) => ((c_SNoLt @ ((mul_5FSNo @ X0) @ X1)) @ ((mul_5FSNo @ X0) @ X2))))))))))). % cc45b1564fb6e160fca709ac04672be251b7bdec3d8a6fc9933464dfe6f1b151
...
% megalodon_source_map (conjecture "conj_c__2Fproject_2Ftmp_2Fsource_5Flinked_5Fstrict_5F100_5Fcorpus_5Ffresh_5F041947_2Fhammer_5F11287_5F64" "/project/tmp/source_linked_strict_100_corpus_fresh_041947/hammer_11287_64" "")
thf(conj_c__2Fproject_2Ftmp_2Fsource_5Flinked_5Fstrict_5F100_5Fcorpus_5Ffresh_5F041947_2Fhammer_5F11287_5F64,conjecture,((c_SNoLt @ m) @ n)).
