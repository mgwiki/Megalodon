% megalodon_origin ((file "examples/hammer/100thms_12_h.mg") (line "10497") (char "10") (kind "aby"))
...
thf(y_tp,type,(y : $i)).
% megalodon_source_map (local_type "c_P1_tp" "P1" "")
thf(c_P1_tp,type,(c_P1 : ($i > $o))).
% megalodon_source_map (local_definition "c_P1_def" "P1" "")
thf(c_P1_def,definition,(c_P1 = (^ [X6:$i] : (? [X7:$i] : (((c_In @ X7) @ c_Lx) & (? [X8:$i] : (((c_In @ X8) @ c_Ly) & ((c_SNoLe @ ((add_5FSNo @ X6) @ ((mul_5FSNo @ X7) @ X8))) @ ((add_5FSNo @ ((mul_5FSNo @ X7) @ y)) @ ((mul_5FSNo @ x) @ X8)))))))))).
% megalodon_source_map (local_type "c_P2_tp" "P2" "")
thf(c_P2_tp,type,(c_P2 : ($i > $o))).
% megalodon_source_map (local_definition "c_P2_def" "P2" "")
thf(c_P2_def,definition,(c_P2 = (^ [X6:$i] : (? [X7:$i] : (((c_In @ X7) @ c_Rx) & (? [X8:$i] : (((c_In @ X8) @ c_Ry) & ((c_SNoLe @ ((add_5FSNo @ X6) @ ((mul_5FSNo @ X7) @ X8))) @ ((add_5FSNo @ ((mul_5FSNo @ X7) @ y)) @ ((mul_5FSNo @ x) @ X8)))))))))).
% megalodon_source_map (local_type "c_P_tp" "P" "")
thf(c_P_tp,type,(c_P : ($i > $o))).
% megalodon_source_map (local_definition "c_P_def" "P" "")
thf(c_P_def,definition,(c_P = (^ [X6:$i] : (((^ [X7:$i] : (? [X8:$i] : (((c_In @ X8) @ c_Lx) & (? [X9:$i] : (((c_In @ X9) @ c_Ly) & ((c_SNoLe @ ((add_5FSNo @ X7) @ ((mul_5FSNo @ X8) @ X9))) @ ((add_5FSNo @ ((mul_5FSNo @ X8) @ y)) @ ((mul_5FSNo @ x) @ X9)))))))) @ X6) | ((^ [X7:$i] : (? [X8:$i] : (((c_In @ X8) @ c_Rx) & (? [X9:$i] : (((c_In @ X9) @ c_Ry) & ((c_SNoLe @ ((add_5FSNo @ X7) @ ((mul_5FSNo @ X8) @ X9))) @ ((add_5FSNo @ ((mul_5FSNo @ X8) @ y)) @ ((mul_5FSNo @ x) @ X9)))))))) @ X6))))).
...
thf(z_tp,type,(z : $i)).
% megalodon_source_map (conjecture "conj_c__2Fproject_2Ftmp_2Fsource_5Flinked_5Fstrict_5F100_5Fcorpus_5Ffresh_5F041947_2Fhammer_5F10497_5F10" "/project/tmp/source_linked_strict_100_corpus_fresh_041947/hammer_10497_10" "")
thf(conj_c__2Fproject_2Ftmp_2Fsource_5Flinked_5Fstrict_5F100_5Fcorpus_5Ffresh_5F041947_2Fhammer_5F10497_5F10,conjecture,(((c_SNoLt @ ((mul_5FSNo @ x) @ y)) @ z) => ((c_SNoLt @ ((mul_5FSNo @ x) @ y)) @ z))).
