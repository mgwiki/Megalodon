% megalodon_origin ((file "/project/Megalodon/examples/hammer/100thms_12_h.mg") (line "11405") (char "35") (kind "aby"))
...
% megalodon_source_map (conjecture "conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F11405_5F35" "/project/tmp/megalodon3_source_linked_corpus_250/hammer_11405_35" "")
thf(conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F11405_5F35,conjecture,(! [X1:$i] : ((! [X2:($i > $o)] : ((X2 @ c_Empty) => ((! [X3:$i] : ((X2 @ X3) => (X2 @ (ordsucc @ X3)))) => (X2 @ X1)))) => ((c_SNo @ ((exp_5FSNo_5Fnat @ x) @ X1)) => (c_SNo @ ((exp_5FSNo_5Fnat @ x) @ (ordsucc @ X1))))))).
