% megalodon_origin ((file "/project/Megalodon/examples/hammer/100thms_12_h.mg") (line "10990") (char "20") (kind "aby"))
...
thf(c_LrN,axiom,(! [X7:($i > $o)] : ((X7 @ c_Empty) => ((! [X8:$i] : ((X7 @ X8) => (X7 @ (ordsucc @ X8)))) => (X7 @ r))))).
% megalodon_source_map (conjecture "conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F10990_5F20" "/project/tmp/megalodon3_source_linked_corpus_250/hammer_10990_20" "")
thf(conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F10990_5F20,conjecture,(c_SNo @ r)).
