% megalodon_origin ((file "/project/Megalodon/examples/hammer/100thms_12_h.mg") (line "11998") (char "30") (kind "aby"))
...
% megalodon_source_map (known "int_5Fadd_5FSNo" "int_add_SNo" "8470044530cddfd5313e241558e18bc1b8646b4d2c1f5c44b26fc3978c1d631d")
thf(int_5Fadd_5FSNo,axiom,(! [X0:$i] : (((c_In @ X0) @ int) => (! [X1:$i] : (((c_In @ X1) @ int) => ((c_In @ ((add_5FSNo @ X0) @ X1)) @ int)))))). % 8470044530cddfd5313e241558e18bc1b8646b4d2c1f5c44b26fc3978c1d631d
...
thf(m_tp,type,(m : $i)).
% megalodon_source_map (local_type "l_tp" "l" "")
thf(l_tp,type,(l : $i)).
% megalodon_source_map (local_type "n_tp" "n" "")
thf(n_tp,type,(n : $i)).
% megalodon_source_map (local_fact "c_L2kn" "L2kn" "")
thf(c_L2kn,axiom,((c_In @ ((mul_5FSNo @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ k)) @ n)) @ int)).
% megalodon_source_map (local_fact "c_L2lm" "L2lm" "")
thf(c_L2lm,axiom,((c_In @ ((mul_5FSNo @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ l)) @ m)) @ int)).
% megalodon_source_map (conjecture "conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F11998_5F30" "/project/tmp/megalodon3_source_linked_corpus_250/hammer_11998_30" "")
thf(conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F11998_5F30,conjecture,((c_In @ ((add_5FSNo @ ((mul_5FSNo @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ l)) @ m)) @ ((mul_5FSNo @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ k)) @ n))) @ int)).
