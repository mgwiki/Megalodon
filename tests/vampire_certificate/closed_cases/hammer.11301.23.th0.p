% megalodon_origin ((file "/project/Megalodon/examples/hammer/100thms_12_h.mg") (line "11301") (char "23") (kind "aby"))
...
% megalodon_source_map (conjecture "conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F11301_5F23" "/project/tmp/megalodon3_source_linked_corpus_250/hammer_11301_23" "")
thf(conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F11301_5F23,conjecture,(! [X5:($i > $o)] : ((X5 @ c_Empty) => ((! [X6:$i] : ((X5 @ X6) => (X5 @ (ordsucc @ X6)))) => (X5 @ k))))).
