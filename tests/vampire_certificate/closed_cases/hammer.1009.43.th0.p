% megalodon_origin ((file "/project/Megalodon/examples/hammer/100thms_12_h.mg") (line "1009") (char "43") (kind "aby"))
...
% megalodon_source_map (known "image_5Fmonotone" "image_monotone" "b5e911bcfd7b6d0756f915954b0c1b82fe62e2f153bf63869e098334139471b1")
thf(image_5Fmonotone,axiom,(! [X0:($i > $i)] : (! [X1:$i] : (! [X2:$i] : ((! [X3:$i] : (((c_In @ X3) @ X1) => ((c_In @ X3) @ X2))) => (! [X3:$i] : (((c_In @ X3) @ ((c_Repl @ X1) @ X0)) => ((c_In @ X3) @ ((c_Repl @ X2) @ X0))))))))). % b5e911bcfd7b6d0756f915954b0c1b82fe62e2f153bf63869e098334139471b1
% megalodon_source_map (known "setminus_5Fantimonotone" "setminus_antimonotone" "f834915e222d99d9adaad0c8e862bc1384c10d3f4b9ce045b11fb075f120d5f3")
thf(setminus_5Fantimonotone,axiom,(! [X0:$i] : (! [X1:$i] : (! [X2:$i] : ((! [X3:$i] : (((c_In @ X3) @ X1) => ((c_In @ X3) @ X2))) => (! [X3:$i] : (((c_In @ X3) @ ((setminus @ X0) @ X2)) => ((c_In @ X3) @ ((setminus @ X0) @ X1))))))))). % f834915e222d99d9adaad0c8e862bc1384c10d3f4b9ce045b11fb075f120d5f3
% megalodon_source_map (local_type "c_A_tp" "A" "")
thf(c_A_tp,type,(c_A : $i)).
% megalodon_source_map (local_type "c_B_tp" "B" "")
thf(c_B_tp,type,(c_B : $i)).
% megalodon_source_map (local_type "f_tp" "f" "")
thf(f_tp,type,(f : ($i > $i))).
% megalodon_source_map (local_type "g_tp" "g" "")
thf(g_tp,type,(g : ($i > $i))).
% megalodon_source_map (local_type "c_F_tp" "F" "")
thf(c_F_tp,type,(c_F : ($i > $i))).
% megalodon_source_map (local_definition "c_F_def" "F" "")
thf(c_F_def,definition,(c_F = (^ [X4:$i] : ((c_Repl @ ((setminus @ c_B) @ ((c_Repl @ ((setminus @ c_A) @ X4)) @ (^ [X5:$i] : (f @ X5))))) @ (^ [X5:$i] : (g @ X5)))))).
% megalodon_source_map (conjecture "conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F1009_5F43" "/project/tmp/megalodon3_source_linked_corpus_250/hammer_1009_43" "")
thf(conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F1009_5F43,conjecture,(! [X4:$i] : (((c_In @ X4) @ (c_Power @ c_A)) => (! [X5:$i] : (((c_In @ X5) @ (c_Power @ c_A)) => ((! [X6:$i] : (((c_In @ X6) @ X4) => ((c_In @ X6) @ X5))) => (! [X6:$i] : (((c_In @ X6) @ ((c_Repl @ ((setminus @ c_B) @ ((c_Repl @ ((setminus @ c_A) @ X4)) @ f))) @ g)) => ((c_In @ X6) @ ((c_Repl @ ((setminus @ c_B) @ ((c_Repl @ ((setminus @ c_A) @ X5)) @ f))) @ g)))))))))).
