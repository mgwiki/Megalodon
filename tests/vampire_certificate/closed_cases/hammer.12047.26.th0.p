% megalodon_origin ((file "/project/Megalodon/examples/hammer/100thms_12_h.mg") (line "12047") (char "26") (kind "aby"))
...
% megalodon_source_map (known "c_SNo_5Fadd_5FSNo" "SNo_add_SNo" "6aafd837e0a0618c37ad12fb26684a5921d44547ba020d3625be2de433b8e029")
thf(c_SNo_5Fadd_5FSNo,axiom,(! [X0:$i] : (! [X1:$i] : ((c_SNo @ X0) => ((c_SNo @ X1) => (c_SNo @ ((add_5FSNo @ X0) @ X1))))))). % 6aafd837e0a0618c37ad12fb26684a5921d44547ba020d3625be2de433b8e029
...
thf(z_tp,type,(z : $i)).
% megalodon_source_map (local_fact "c_Hz2" "Hz2" "")
thf(c_Hz2,axiom,(c_SNo @ z)).
% megalodon_source_map (local_fact "c_Hy2" "Hy2" "")
thf(c_Hy2,axiom,(c_SNo @ y)).
% megalodon_source_map (conjecture "conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F12047_5F26" "/project/tmp/megalodon3_source_linked_corpus_250/hammer_12047_26" "")
thf(conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F12047_5F26,conjecture,(c_SNo @ ((add_5FSNo @ y) @ z))).
