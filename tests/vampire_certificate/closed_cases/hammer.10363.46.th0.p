% megalodon_origin ((file "examples/hammer/100thms_12_h.mg") (line "10363") (char "46") (kind "aby"))
...
thf(z0_tp,type,(z0 : $i)).
% megalodon_source_map (local_type "w1_tp" "w1" "")
thf(w1_tp,type,(w1 : $i)).
% megalodon_source_map (local_type "z0_27_tp" "z0'" "")
thf(z0_27_tp,type,(z0_27 : $i)).
% megalodon_source_map (local_type "w1_27_tp" "w1'" "")
thf(w1_27_tp,type,(w1_27 : $i)).
% megalodon_source_map (local_fact "c_Hw1_271" "Hw1'1" "")
thf(c_Hw1_271,axiom,((c_In @ w1_27) @ c_Ly)).
...
% megalodon_source_map (local_fact "c_RxLy_27I" "RxLy'I" "")
thf(c_RxLy_27I,axiom,(! [X13:$i] : (((c_In @ X13) @ c_Rx) => (! [X14:$i] : (((c_In @ X14) @ c_Ly) => ((c_In @ ((add_5FSNo @ ((mul_5FSNo @ X13) @ y)) @ ((add_5FSNo @ ((mul_5FSNo @ x) @ X14)) @ (minus_5FSNo @ ((mul_5FSNo @ X13) @ X14))))) @ ((c_Repl @ ((setprod @ c_Rx) @ c_Ly)) @ (^ [X15:$i] : ((add_5FSNo @ ((mul_5FSNo @ ((ap @ X15) @ c_Empty)) @ y)) @ ((add_5FSNo @ ((mul_5FSNo @ x) @ ((ap @ X15) @ (ordsucc @ c_Empty)))) @ (minus_5FSNo @ ((mul_5FSNo @ ((ap @ X15) @ c_Empty)) @ ((ap @ X15) @ (ordsucc @ c_Empty)))))))))))))).
% megalodon_source_map (conjecture "conj_c__2Fproject_2Ftmp_2Fsource_5Flinked_5Fstrict_5F100_5Fcorpus_5Ffresh_5F041947_2Fhammer_5F10363_5F46" "/project/tmp/source_linked_strict_100_corpus_fresh_041947/hammer_10363_46" "")
thf(conj_c__2Fproject_2Ftmp_2Fsource_5Flinked_5Fstrict_5F100_5Fcorpus_5Ffresh_5F041947_2Fhammer_5F10363_5F46,conjecture,((c_SNoLt @ ((c_SNoCut @ ((binunion @ ((c_Repl @ ((setprod @ c_Lx) @ c_Ly)) @ (^ [X13:$i] : ((add_5FSNo @ ((mul_5FSNo @ ((ap @ X13) @ c_Empty)) @ y)) @ ((add_5FSNo @ ((mul_5FSNo @ x) @ ((ap @ X13) @ (ordsucc @ c_Empty)))) @ (minus_5FSNo @ ((mul_5FSNo @ ((ap @ X13) @ c_Empty)) @ ((ap @ X13) @ (ordsucc @ c_Empty))))))))) @ ((c_Repl @ ((setprod @ c_Rx) @ c_Ry)) @ (^ [X13:$i] : ((add_5FSNo @ ((mul_5FSNo @ ((ap @ X13) @ c_Empty)) @ y)) @ ((add_5FSNo @ ((mul_5FSNo @ x) @ ((ap @ X13) @ (ordsucc @ c_Empty)))) @ (minus_5FSNo @ ((mul_5FSNo @ ((ap @ X13) @ c_Empty)) @ ((ap @ X13) @ (ordsucc @ c_Empty)))))))))) @ ((binunion @ ((c_Repl @ ((setprod @ c_Lx) @ c_Ry)) @ (^ [X13:$i] : ((add_5FSNo @ ((mul_5FSNo @ ((ap @ X13) @ c_Empty)) @ y)) @ ((add_5FSNo @ ((mul_5FSNo @ x) @ ((ap @ X13) @ (ordsucc @ c_Empty)))) @ (minus_5FSNo @ ((mul_5FSNo @ ((ap @ X13) @ c_Empty)) @ ((ap @ X13) @ (ordsucc @ c_Empty))))))))) @ ((c_Repl @ ((setprod @ c_Rx) @ c_Ly)) @ (^ [X13:$i] : ((add_5FSNo @ ((mul_5FSNo @ ((ap @ X13) @ c_Empty)) @ y)) @ ((add_5FSNo @ ((mul_5FSNo @ x) @ ((ap @ X13) @ (ordsucc @ c_Empty)))) @ (minus_5FSNo @ ((mul_5FSNo @ ((ap @ X13) @ c_Empty)) @ ((ap @ X13) @ (ordsucc @ c_Empty))))))))))) @ ((add_5FSNo @ ((mul_5FSNo @ z0_27) @ y)) @ ((add_5FSNo @ ((mul_5FSNo @ x) @ w1_27)) @ (minus_5FSNo @ ((mul_5FSNo @ z0_27) @ w1_27)))))).
