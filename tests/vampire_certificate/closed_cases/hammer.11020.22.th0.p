% megalodon_origin ((file "/project/Megalodon/examples/hammer/100thms_12_h.mg") (line "11020") (char "22") (kind "aby"))
...
thf(m_tp,type,(m : $i)).
% megalodon_source_map (local_fact "c_Hm1" "Hm1" "")
thf(c_Hm1,axiom,((c_In @ m) @ omega)).
% megalodon_source_map (conjecture "conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F11020_5F22" "/project/tmp/megalodon3_source_linked_corpus_250/hammer_11020_22" "")
thf(conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F11020_5F22,conjecture,(! [X1:($i > $o)] : ((X1 @ c_Empty) => ((! [X2:$i] : ((X1 @ X2) => (X1 @ (ordsucc @ X2)))) => (X1 @ m))))).
