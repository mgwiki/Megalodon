% megalodon_origin ((file "/project/Megalodon/examples/hammer/100thms_12_h.mg") (line "11574") (char "100") (kind "aby"))
...
% megalodon_source_map (known "c_EmptyE" "EmptyE" "db69db5fe0ab30c62cbb6c6a5585580d13a89b7a739501bf6ab7f69ba07ed65e")
thf(c_EmptyE,axiom,(! [X0:$i] : (((c_In @ X0) @ c_Empty) => (! [X1:$o] : X1)))). % db69db5fe0ab30c62cbb6c6a5585580d13a89b7a739501bf6ab7f69ba07ed65e
...
thf(f_tp,type,(f : ($i > $i))).
% megalodon_source_map (local_definition "f_def" "f" "")
thf(f_def,definition,(f = (^ [X0:$i] : c_Empty))).
% megalodon_source_map (local_type "x_tp" "x" "")
thf(x_tp,type,(x : $i)).
% megalodon_source_map (local_type "alpha_tp" "alpha" "")
thf(alpha_tp,type,(alpha : $i)).
% megalodon_source_map (local_fact "c_Ha" "Ha" "")
thf(c_Ha,axiom,((c_In @ alpha) @ c_Empty)).
% megalodon_source_map (local_fact "c_Hx1d" "Hx1d" "")
thf(c_Hx1d,axiom,(! [X2:$o] : (((! [X3:$i] : (((c_In @ X3) @ x) => ((c_In @ X3) @ (c_SNoElts_5F @ (c_SNoLev @ x))))) => ((! [X3:$i] : (((c_In @ X3) @ (c_SNoLev @ x)) => ((exactly1of2 @ ((c_In @ ((c_SetAdjoin @ X3) @ (c_Sing @ (ordsucc @ c_Empty)))) @ x)) @ ((c_In @ X3) @ x)))) => X2)) => X2))).
% megalodon_source_map (local_fact "c_Hx1c" "Hx1c" "")
thf(c_Hx1c,axiom,(c_SNo @ x)).
% megalodon_source_map (local_fact "c_Hx1b" "Hx1b" "")
thf(c_Hx1b,axiom,(! [X2:$o] : (((! [X3:$i] : (((c_In @ X3) @ (c_SNoLev @ x)) => (! [X4:$i] : (((c_In @ X4) @ X3) => ((c_In @ X4) @ (c_SNoLev @ x)))))) => ((! [X3:$i] : (((c_In @ X3) @ (c_SNoLev @ x)) => (! [X4:$i] : (((c_In @ X4) @ X3) => (! [X5:$i] : (((c_In @ X5) @ X4) => ((c_In @ X5) @ X3))))))) => X2)) => X2))).
% megalodon_source_map (local_fact "c_Hx1a" "Hx1a" "")
thf(c_Hx1a,axiom,((c_In @ (c_SNoLev @ x)) @ omega)).
% megalodon_source_map (local_fact "c_Hx2" "Hx2" "")
thf(c_Hx2,axiom,((c_SNoLev @ x) = c_Empty)).
% megalodon_source_map (local_fact "c_Hx1" "Hx1" "")
thf(c_Hx1,axiom,((c_In @ x) @ (c_SNoS_5F @ omega))).
% megalodon_source_map (local_fact "c_Hx" "Hx" "")
thf(c_Hx,axiom,((c_In @ x) @ ((c_Sep @ (c_SNoS_5F @ omega)) @ (^ [X2:$i] : ((c_SNoLev @ X2) = c_Empty))))).
% megalodon_source_map (conjecture "conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F11574_5F100" "/project/tmp/megalodon3_source_linked_corpus_250/hammer_11574_100" "")
thf(conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F11574_5F100,conjecture,(! [X2:$o] : X2)).
