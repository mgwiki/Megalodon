% megalodon_origin ((file "examples/hammer/100thms_12_h.mg") (line "1032") (char "16") (kind "aby"))
...
% megalodon_source_map (local_type "c_Y_tp" "Y" "")
thf(c_Y_tp,type,(c_Y : $i)).
% megalodon_source_map (local_type "h_tp" "h" "")
thf(h_tp,type,(h : ($i > $i))).
% megalodon_source_map (local_definition "h_def" "h" "")
thf(h_def,definition,(h = (^ [X5:$i] : (((c_If_5Fi @ ((c_In @ X5) @ c_Y)) @ (((inv @ c_B) @ g) @ X5)) @ (f @ X5))))).
% megalodon_source_map (local_type "x_tp" "x" "")
thf(x_tp,type,(x : $i)).
% megalodon_source_map (local_type "y_tp" "y" "")
thf(y_tp,type,(y : $i)).
% megalodon_source_map (local_fact "c_H3" "H3" "")
thf(c_H3,axiom,((c_In @ x) @ c_Y)).
% megalodon_source_map (local_fact "c_H2" "H2" "")
thf(c_H2,axiom,(((c_Repl @ ((setminus @ c_B) @ ((c_Repl @ ((setminus @ c_A) @ c_Y)) @ f))) @ g) = c_Y)).
% megalodon_source_map (conjecture "conj_c__2Fproject_2Ftmp_2Fsource_5Flinked_5Fstrict_5F100_5Fcorpus_5Ffresh_5F041947_2Fhammer_5F1032_5F16" "/project/tmp/source_linked_strict_100_corpus_fresh_041947/hammer_1032_16" "")
thf(conj_c__2Fproject_2Ftmp_2Fsource_5Flinked_5Fstrict_5F100_5Fcorpus_5Ffresh_5F041947_2Fhammer_5F1032_5F16,conjecture,((c_In @ x) @ ((c_Repl @ ((setminus @ c_B) @ ((c_Repl @ ((setminus @ c_A) @ c_Y)) @ f))) @ g))).
