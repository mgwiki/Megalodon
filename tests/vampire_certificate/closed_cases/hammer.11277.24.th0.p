% megalodon_origin ((file "/project/Megalodon/examples/hammer/100thms_12_h.mg") (line "11277") (char "24") (kind "aby"))
...
% megalodon_source_map (conjecture "conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F11277_5F24" "/project/tmp/megalodon3_source_linked_corpus_250/hammer_11277_24" "")
thf(conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F11277_5F24,conjecture,(! [X3:($i > $o)] : ((X3 @ c_Empty) => ((! [X4:$i] : ((X3 @ X4) => (X3 @ (ordsucc @ X4)))) => (X3 @ p))))).
