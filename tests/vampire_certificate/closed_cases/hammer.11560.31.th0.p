% megalodon_origin ((file "examples/hammer/100thms_12_h.mg") (line "11560") (char "31") (kind "aby"))
...
% megalodon_source_map (local_type "i_tp" "i" "")
thf(i_tp,type,(i : $i)).
% megalodon_source_map (local_type "j_tp" "j" "")
thf(j_tp,type,(j : $i)).
% megalodon_source_map (local_fact "c_Hij" "Hij" "")
thf(c_Hij,axiom,(c_Empty = c_Empty)).
% megalodon_source_map (local_fact "c_Hj" "Hj" "")
thf(c_Hj,axiom,((c_In @ j) @ (ordsucc @ c_Empty))).
% megalodon_source_map (local_fact "c_Hi" "Hi" "")
thf(c_Hi,axiom,((c_In @ i) @ (ordsucc @ c_Empty))).
% megalodon_source_map (conjecture "conj_c__2Fproject_2Ftmp_2Fsource_5Flinked_5Fstrict_5F100_5Fcorpus_5Ffresh_5F041947_2Fhammer_5F11560_5F31" "/project/tmp/source_linked_strict_100_corpus_fresh_041947/hammer_11560_31" "")
thf(conj_c__2Fproject_2Ftmp_2Fsource_5Flinked_5Fstrict_5F100_5Fcorpus_5Ffresh_5F041947_2Fhammer_5F11560_5F31,conjecture,(c_Empty = c_Empty)).
