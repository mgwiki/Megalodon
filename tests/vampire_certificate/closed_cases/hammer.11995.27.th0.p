% megalodon_origin ((file "/project/Megalodon/examples/hammer/100thms_12_h.mg") (line "11995") (char "27") (kind "aby"))
...
% megalodon_source_map (known "int_5Fmul_5FSNo" "int_mul_SNo" "1a5465f940a029eb51d3f635ea2bbc8b265c0e75328df51a2a3f4892cc5c890c")
thf(int_5Fmul_5FSNo,axiom,(! [X0:$i] : (((c_In @ X0) @ int) => (! [X1:$i] : (((c_In @ X1) @ int) => ((c_In @ ((mul_5FSNo @ X0) @ X1)) @ int)))))). % 1a5465f940a029eb51d3f635ea2bbc8b265c0e75328df51a2a3f4892cc5c890c
...
thf(n_tp,type,(n : $i)).
% megalodon_source_map (local_fact "c_L2k" "L2k" "")
thf(c_L2k,axiom,((c_In @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ k)) @ int)).
% megalodon_source_map (local_fact "c_Hn" "Hn" "")
thf(c_Hn,axiom,((c_In @ n) @ int)).
% megalodon_source_map (conjecture "conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F11995_5F27" "/project/tmp/megalodon3_source_linked_corpus_250/hammer_11995_27" "")
thf(conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F11995_5F27,conjecture,((c_In @ ((mul_5FSNo @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ k)) @ n)) @ int)).
