% megalodon_origin ((file "examples/hammer/100thms_12_h.mg") (line "11577") (char "51") (kind "aby"))
...
% megalodon_source_map (known "c_In_5F0_5F1" "In_0_1" "4675abc9d31454cce6f27f63bfaacf6fc539a2b864cdd7bb9bf34598e85c9ff3")
thf(c_In_5F0_5F1,axiom,((c_In @ c_Empty) @ (ordsucc @ c_Empty))). % 4675abc9d31454cce6f27f63bfaacf6fc539a2b864cdd7bb9bf34598e85c9ff3
...
thf(c_L1,axiom,(x = c_Empty)).
% megalodon_source_map (local_fact "c_Hx1d" "Hx1d" "")
thf(c_Hx1d,axiom,(! [X1:$o] : (((! [X2:$i] : (((c_In @ X2) @ x) => ((c_In @ X2) @ (c_SNoElts_5F @ (c_SNoLev @ x))))) => ((! [X2:$i] : (((c_In @ X2) @ (c_SNoLev @ x)) => ((exactly1of2 @ ((c_In @ ((c_SetAdjoin @ X2) @ (c_Sing @ (ordsucc @ c_Empty)))) @ x)) @ ((c_In @ X2) @ x)))) => X1)) => X1))).
% megalodon_source_map (local_fact "c_Hx1c" "Hx1c" "")
thf(c_Hx1c,axiom,(c_SNo @ x)).
% megalodon_source_map (local_fact "c_Hx1b" "Hx1b" "")
thf(c_Hx1b,axiom,(! [X1:$o] : (((! [X2:$i] : (((c_In @ X2) @ (c_SNoLev @ x)) => (! [X3:$i] : (((c_In @ X3) @ X2) => ((c_In @ X3) @ (c_SNoLev @ x)))))) => ((! [X2:$i] : (((c_In @ X2) @ (c_SNoLev @ x)) => (! [X3:$i] : (((c_In @ X3) @ X2) => (! [X4:$i] : (((c_In @ X4) @ X3) => ((c_In @ X4) @ X2))))))) => X1)) => X1))).
...
thf(c_Hx,axiom,((c_In @ x) @ ((c_Sep @ (c_SNoS_5F @ omega)) @ (^ [X1:$i] : ((c_SNoLev @ X1) = c_Empty))))).
% megalodon_source_map (conjecture "conj_c__2Fproject_2Ftmp_2Fsource_5Flinked_5Fstrict_5F100_5Fcorpus_5Ffresh_5F041947_2Fhammer_5F11577_5F51" "/project/tmp/source_linked_strict_100_corpus_fresh_041947/hammer_11577_51" "")
thf(conj_c__2Fproject_2Ftmp_2Fsource_5Flinked_5Fstrict_5F100_5Fcorpus_5Ffresh_5F041947_2Fhammer_5F11577_5F51,conjecture,((c_In @ c_Empty) @ (ordsucc @ c_Empty))).
