% megalodon_origin ((file "/project/Megalodon/examples/hammer/100thms_12_h.mg") (line "11413") (char "29") (kind "aby"))
...
thf(x_tp,type,(x : $i)).
% megalodon_source_map (local_fact "c_Lx" "Lx" "")
thf(c_Lx,axiom,(c_SNo @ x)).
% megalodon_source_map (conjecture "conj_c__2Fproject_2Ftmp_2Fsource_5Flinked_5Fstrict_5F100_5Fcorpus_5Ffresh_5F041947_2Fhammer_5F11413_5F29" "/project/tmp/source_linked_strict_100_corpus_fresh_041947/hammer_11413_29" "")
thf(conj_c__2Fproject_2Ftmp_2Fsource_5Flinked_5Fstrict_5F100_5Fcorpus_5Ffresh_5F041947_2Fhammer_5F11413_5F29,conjecture,(! [X1:($i > $o)] : ((X1 @ c_Empty) => ((! [X2:$i] : ((X1 @ X2) => (X1 @ (ordsucc @ X2)))) => (X1 @ ((exp_5FSNo_5Fnat @ x) @ c_Empty)))))).
