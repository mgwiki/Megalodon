% megalodon_origin ((file "examples/hammer/100thms_12_h.mg") (line "11602") (char "25") (kind "aby"))
...
% megalodon_source_map (known "add_5FSNo_5FLt2" "add_SNo_Lt2" "759677c45b73afd86fabc4bad7c0696b368b58d51666f9534c48fc051c8de801")
thf(add_5FSNo_5FLt2,axiom,(! [X0:$i] : (! [X1:$i] : (! [X2:$i] : ((c_SNo @ X0) => ((c_SNo @ X1) => ((c_SNo @ X2) => (((c_SNoLt @ X1) @ X2) => ((c_SNoLt @ ((add_5FSNo @ X0) @ X1)) @ ((add_5FSNo @ X0) @ X2)))))))))). % 759677c45b73afd86fabc4bad7c0696b368b58d51666f9534c48fc051c8de801
...
% megalodon_source_map (conjecture "conj_c__2Fproject_2Ftmp_2Fsource_5Flinked_5Fstrict_5F100_5Fcorpus_5Ffresh_5F041947_2Fhammer_5F11602_5F25" "/project/tmp/source_linked_strict_100_corpus_fresh_041947/hammer_11602_25" "")
thf(conj_c__2Fproject_2Ftmp_2Fsource_5Flinked_5Fstrict_5F100_5Fcorpus_5Ffresh_5F041947_2Fhammer_5F11602_5F25,conjecture,(! [X1:$i] : ((c_SNo @ X1) => (((c_SNoLt @ X1) @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n)) => ((c_SNoLt @ ((add_5FSNo @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n)) @ X1)) @ ((add_5FSNo @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n)) @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n))))))).
