% megalodon_origin ((file "examples/hammer/100thms_12_h.mg") (line "10304") (char "46") (kind "aby"))
...
% megalodon_source_map (known "binunionI1" "binunionI1" "9e9f1f4dffcf252f2a92d22b0643d42fab016ee86072c0d9d927a0865dcb1c66")
thf(binunionI1,axiom,(! [X0:$i] : (! [X1:$i] : (! [X2:$i] : (((c_In @ X2) @ X0) => ((c_In @ X2) @ ((binunion @ X0) @ X1))))))). % 9e9f1f4dffcf252f2a92d22b0643d42fab016ee86072c0d9d927a0865dcb1c66
...
% megalodon_source_map (def "mul_5FSNo_def" "mul_SNo" "f56bf39b8eea93d7f63da529dedb477ae1ab1255c645c47d8915623f364f2d6b")
thf(mul_5FSNo_def,definition,(mul_5FSNo = (c_SNo_5Frec2 @ (^ [X0:$i] : (^ [X1:$i] : (^ [X2:($i > ($i > $i))] : ((c_SNoCut @ ((binunion @ ((c_Repl @ ((setprod @ (c_SNoL @ X0)) @ (c_SNoL @ X1))) @ (^ [X3:$i] : ((add_5FSNo @ ((X2 @ ((ap @ X3) @ c_Empty)) @ X1)) @ ((add_5FSNo @ ((X2 @ X0) @ ((ap @ X3) @ (ordsucc @ c_Empty)))) @ (minus_5FSNo @ ((X2 @ ((ap @ X3) @ c_Empty)) @ ((ap @ X3) @ (ordsucc @ c_Empty))))))))) @ ((c_Repl @ ((setprod @ (c_SNoR @ X0)) @ (c_SNoR @ X1))) @ (^ [X3:$i] : ((add_5FSNo @ ((X2 @ ((ap @ X3) @ c_Empty)) @ X1)) @ ((add_5FSNo @ ((X2 @ X0) @ ((ap @ X3) @ (ordsucc @ c_Empty)))) @ (minus_5FSNo @ ((X2 @ ((ap @ X3) @ c_Empty)) @ ((ap @ X3) @ (ordsucc @ c_Empty)))))))))) @ ((binunion @ ((c_Repl @ ((setprod @ (c_SNoL @ X0)) @ (c_SNoR @ X1))) @ (^ [X3:$i] : ((add_5FSNo @ ((X2 @ ((ap @ X3) @ c_Empty)) @ X1)) @ ((add_5FSNo @ ((X2 @ X0) @ ((ap @ X3) @ (ordsucc @ c_Empty)))) @ (minus_5FSNo @ ((X2 @ ((ap @ X3) @ c_Empty)) @ ((ap @ X3) @ (ordsucc @ c_Empty))))))))) @ ((c_Repl @ ((setprod @ (c_SNoR @ X0)) @ (c_SNoL @ X1))) @ (^ [X3:$i] : ((add_5FSNo @ ((X2 @ ((ap @ X3) @ c_Empty)) @ X1)) @ ((add_5FSNo @ ((X2 @ X0) @ ((ap @ X3) @ (ordsucc @ c_Empty)))) @ (minus_5FSNo @ ((X2 @ ((ap @ X3) @ c_Empty)) @ ((ap @ X3) @ (ordsucc @ c_Empty)))))))))))))))). % f56bf39b8eea93d7f63da529dedb477ae1ab1255c645c47d8915623f364f2d6b
% megalodon_source_map (local_type "c_Lx_tp" "Lx" "")
thf(c_Lx_tp,type,(c_Lx : $i)).
% megalodon_source_map (local_type "c_Rx_tp" "Rx" "")
thf(c_Rx_tp,type,(c_Rx : $i)).
% megalodon_source_map (local_type "c_Ly_tp" "Ly" "")
thf(c_Ly_tp,type,(c_Ly : $i)).
% megalodon_source_map (local_type "c_Ry_tp" "Ry" "")
thf(c_Ry_tp,type,(c_Ry : $i)).
% megalodon_source_map (local_type "x_tp" "x" "")
thf(x_tp,type,(x : $i)).
% megalodon_source_map (local_type "y_tp" "y" "")
thf(y_tp,type,(y : $i)).
% megalodon_source_map (local_type "c_LxLy_27_tp" "LxLy'" "")
thf(c_LxLy_27_tp,type,(c_LxLy_27 : $i)).
% megalodon_source_map (local_definition "c_LxLy_27_def" "LxLy'" "")
thf(c_LxLy_27_def,definition,(c_LxLy_27 = ((c_Repl @ ((setprod @ c_Lx) @ c_Ly)) @ (^ [X6:$i] : ((add_5FSNo @ ((mul_5FSNo @ ((ap @ X6) @ c_Empty)) @ y)) @ ((add_5FSNo @ ((mul_5FSNo @ x) @ ((ap @ X6) @ (ordsucc @ c_Empty)))) @ (minus_5FSNo @ ((mul_5FSNo @ ((ap @ X6) @ c_Empty)) @ ((ap @ X6) @ (ordsucc @ c_Empty)))))))))).
% megalodon_source_map (local_type "c_RxRy_27_tp" "RxRy'" "")
thf(c_RxRy_27_tp,type,(c_RxRy_27 : $i)).
% megalodon_source_map (local_definition "c_RxRy_27_def" "RxRy'" "")
thf(c_RxRy_27_def,definition,(c_RxRy_27 = ((c_Repl @ ((setprod @ c_Rx) @ c_Ry)) @ (^ [X6:$i] : ((add_5FSNo @ ((mul_5FSNo @ ((ap @ X6) @ c_Empty)) @ y)) @ ((add_5FSNo @ ((mul_5FSNo @ x) @ ((ap @ X6) @ (ordsucc @ c_Empty)))) @ (minus_5FSNo @ ((mul_5FSNo @ ((ap @ X6) @ c_Empty)) @ ((ap @ X6) @ (ordsucc @ c_Empty)))))))))).
% megalodon_source_map (local_type "c_LxRy_27_tp" "LxRy'" "")
thf(c_LxRy_27_tp,type,(c_LxRy_27 : $i)).
% megalodon_source_map (local_definition "c_LxRy_27_def" "LxRy'" "")
thf(c_LxRy_27_def,definition,(c_LxRy_27 = ((c_Repl @ ((setprod @ c_Lx) @ c_Ry)) @ (^ [X6:$i] : ((add_5FSNo @ ((mul_5FSNo @ ((ap @ X6) @ c_Empty)) @ y)) @ ((add_5FSNo @ ((mul_5FSNo @ x) @ ((ap @ X6) @ (ordsucc @ c_Empty)))) @ (minus_5FSNo @ ((mul_5FSNo @ ((ap @ X6) @ c_Empty)) @ ((ap @ X6) @ (ordsucc @ c_Empty)))))))))).
% megalodon_source_map (local_type "c_RxLy_27_tp" "RxLy'" "")
thf(c_RxLy_27_tp,type,(c_RxLy_27 : $i)).
% megalodon_source_map (local_definition "c_RxLy_27_def" "RxLy'" "")
thf(c_RxLy_27_def,definition,(c_RxLy_27 = ((c_Repl @ ((setprod @ c_Rx) @ c_Ly)) @ (^ [X6:$i] : ((add_5FSNo @ ((mul_5FSNo @ ((ap @ X6) @ c_Empty)) @ y)) @ ((add_5FSNo @ ((mul_5FSNo @ x) @ ((ap @ X6) @ (ordsucc @ c_Empty)))) @ (minus_5FSNo @ ((mul_5FSNo @ ((ap @ X6) @ c_Empty)) @ ((ap @ X6) @ (ordsucc @ c_Empty)))))))))).
% megalodon_source_map (local_type "v_tp" "v" "")
thf(v_tp,type,(v : $i)).
% megalodon_source_map (local_definition "v_def" "v" "")
thf(v_def,definition,(v = ((c_SNoCut @ ((binunion @ ((c_Repl @ ((setprod @ c_Lx) @ c_Ly)) @ (^ [X6:$i] : ((add_5FSNo @ ((mul_5FSNo @ ((ap @ X6) @ c_Empty)) @ y)) @ ((add_5FSNo @ ((mul_5FSNo @ x) @ ((ap @ X6) @ (ordsucc @ c_Empty)))) @ (minus_5FSNo @ ((mul_5FSNo @ ((ap @ X6) @ c_Empty)) @ ((ap @ X6) @ (ordsucc @ c_Empty))))))))) @ ((c_Repl @ ((setprod @ c_Rx) @ c_Ry)) @ (^ [X6:$i] : ((add_5FSNo @ ((mul_5FSNo @ ((ap @ X6) @ c_Empty)) @ y)) @ ((add_5FSNo @ ((mul_5FSNo @ x) @ ((ap @ X6) @ (ordsucc @ c_Empty)))) @ (minus_5FSNo @ ((mul_5FSNo @ ((ap @ X6) @ c_Empty)) @ ((ap @ X6) @ (ordsucc @ c_Empty)))))))))) @ ((binunion @ ((c_Repl @ ((setprod @ c_Lx) @ c_Ry)) @ (^ [X6:$i] : ((add_5FSNo @ ((mul_5FSNo @ ((ap @ X6) @ c_Empty)) @ y)) @ ((add_5FSNo @ ((mul_5FSNo @ x) @ ((ap @ X6) @ (ordsucc @ c_Empty)))) @ (minus_5FSNo @ ((mul_5FSNo @ ((ap @ X6) @ c_Empty)) @ ((ap @ X6) @ (ordsucc @ c_Empty))))))))) @ ((c_Repl @ ((setprod @ c_Rx) @ c_Ly)) @ (^ [X6:$i] : ((add_5FSNo @ ((mul_5FSNo @ ((ap @ X6) @ c_Empty)) @ y)) @ ((add_5FSNo @ ((mul_5FSNo @ x) @ ((ap @ X6) @ (ordsucc @ c_Empty)))) @ (minus_5FSNo @ ((mul_5FSNo @ ((ap @ X6) @ c_Empty)) @ ((ap @ X6) @ (ordsucc @ c_Empty)))))))))))).
% megalodon_source_map (local_type "c_L_27_tp" "L'" "")
thf(c_L_27_tp,type,(c_L_27 : $i)).
% megalodon_source_map (local_type "c_R_27_tp" "R'" "")
thf(c_R_27_tp,type,(c_R_27 : $i)).
% megalodon_source_map (local_type "z_tp" "z" "")
thf(z_tp,type,(z : $i)).
% megalodon_source_map (local_type "w0_tp" "w0" "")
thf(w0_tp,type,(w0 : $i)).
% megalodon_source_map (local_type "z1_tp" "z1" "")
thf(z1_tp,type,(z1 : $i)).
% megalodon_source_map (local_type "w0_27_tp" "w0'" "")
thf(w0_27_tp,type,(w0_27 : $i)).
% megalodon_source_map (local_type "z1_27_tp" "z1'" "")
thf(z1_27_tp,type,(z1_27 : $i)).
% megalodon_source_map (local_fact "c_Hz1_271" "Hz1'1" "")
thf(c_Hz1_271,axiom,((c_In @ z1_27) @ c_Ry)).
% megalodon_source_map (local_fact "c_Hw0_271" "Hw0'1" "")
thf(c_Hw0_271,axiom,((c_In @ w0_27) @ c_Lx)).
% megalodon_source_map (local_fact "c_Hv4" "Hv4" "")
thf(c_Hv4,axiom,(! [X13:$i] : (((c_In @ X13) @ ((binunion @ ((c_Repl @ ((setprod @ c_Lx) @ c_Ry)) @ (^ [X14:$i] : ((add_5FSNo @ ((mul_5FSNo @ ((ap @ X14) @ c_Empty)) @ y)) @ ((add_5FSNo @ ((mul_5FSNo @ x) @ ((ap @ X14) @ (ordsucc @ c_Empty)))) @ (minus_5FSNo @ ((mul_5FSNo @ ((ap @ X14) @ c_Empty)) @ ((ap @ X14) @ (ordsucc @ c_Empty))))))))) @ ((c_Repl @ ((setprod @ c_Rx) @ c_Ly)) @ (^ [X14:$i] : ((add_5FSNo @ ((mul_5FSNo @ ((ap @ X14) @ c_Empty)) @ y)) @ ((add_5FSNo @ ((mul_5FSNo @ x) @ ((ap @ X14) @ (ordsucc @ c_Empty)))) @ (minus_5FSNo @ ((mul_5FSNo @ ((ap @ X14) @ c_Empty)) @ ((ap @ X14) @ (ordsucc @ c_Empty)))))))))) => ((c_SNoLt @ ((c_SNoCut @ ((binunion @ ((c_Repl @ ((setprod @ c_Lx) @ c_Ly)) @ (^ [X14:$i] : ((add_5FSNo @ ((mul_5FSNo @ ((ap @ X14) @ c_Empty)) @ y)) @ ((add_5FSNo @ ((mul_5FSNo @ x) @ ((ap @ X14) @ (ordsucc @ c_Empty)))) @ (minus_5FSNo @ ((mul_5FSNo @ ((ap @ X14) @ c_Empty)) @ ((ap @ X14) @ (ordsucc @ c_Empty))))))))) @ ((c_Repl @ ((setprod @ c_Rx) @ c_Ry)) @ (^ [X14:$i] : ((add_5FSNo @ ((mul_5FSNo @ ((ap @ X14) @ c_Empty)) @ y)) @ ((add_5FSNo @ ((mul_5FSNo @ x) @ ((ap @ X14) @ (ordsucc @ c_Empty)))) @ (minus_5FSNo @ ((mul_5FSNo @ ((ap @ X14) @ c_Empty)) @ ((ap @ X14) @ (ordsucc @ c_Empty)))))))))) @ ((binunion @ ((c_Repl @ ((setprod @ c_Lx) @ c_Ry)) @ (^ [X14:$i] : ((add_5FSNo @ ((mul_5FSNo @ ((ap @ X14) @ c_Empty)) @ y)) @ ((add_5FSNo @ ((mul_5FSNo @ x) @ ((ap @ X14) @ (ordsucc @ c_Empty)))) @ (minus_5FSNo @ ((mul_5FSNo @ ((ap @ X14) @ c_Empty)) @ ((ap @ X14) @ (ordsucc @ c_Empty))))))))) @ ((c_Repl @ ((setprod @ c_Rx) @ c_Ly)) @ (^ [X14:$i] : ((add_5FSNo @ ((mul_5FSNo @ ((ap @ X14) @ c_Empty)) @ y)) @ ((add_5FSNo @ ((mul_5FSNo @ x) @ ((ap @ X14) @ (ordsucc @ c_Empty)))) @ (minus_5FSNo @ ((mul_5FSNo @ ((ap @ X14) @ c_Empty)) @ ((ap @ X14) @ (ordsucc @ c_Empty))))))))))) @ X13)))).
% megalodon_source_map (local_fact "c_LxRy_27I" "LxRy'I" "")
thf(c_LxRy_27I,axiom,(! [X13:$i] : (((c_In @ X13) @ c_Lx) => (! [X14:$i] : (((c_In @ X14) @ c_Ry) => ((c_In @ ((add_5FSNo @ ((mul_5FSNo @ X13) @ y)) @ ((add_5FSNo @ ((mul_5FSNo @ x) @ X14)) @ (minus_5FSNo @ ((mul_5FSNo @ X13) @ X14))))) @ ((c_Repl @ ((setprod @ c_Lx) @ c_Ry)) @ (^ [X15:$i] : ((add_5FSNo @ ((mul_5FSNo @ ((ap @ X15) @ c_Empty)) @ y)) @ ((add_5FSNo @ ((mul_5FSNo @ x) @ ((ap @ X15) @ (ordsucc @ c_Empty)))) @ (minus_5FSNo @ ((mul_5FSNo @ ((ap @ X15) @ c_Empty)) @ ((ap @ X15) @ (ordsucc @ c_Empty)))))))))))))).
% megalodon_source_map (conjecture "conj_c__2Fproject_2Ftmp_2Fsource_5Flinked_5Fstrict_5F100_5Fcorpus_5Ffresh_5F041947_2Fhammer_5F10304_5F46" "/project/tmp/source_linked_strict_100_corpus_fresh_041947/hammer_10304_46" "")
thf(conj_c__2Fproject_2Ftmp_2Fsource_5Flinked_5Fstrict_5F100_5Fcorpus_5Ffresh_5F041947_2Fhammer_5F10304_5F46,conjecture,((c_SNoLt @ ((c_SNoCut @ ((binunion @ ((c_Repl @ ((setprod @ c_Lx) @ c_Ly)) @ (^ [X13:$i] : ((add_5FSNo @ ((mul_5FSNo @ ((ap @ X13) @ c_Empty)) @ y)) @ ((add_5FSNo @ ((mul_5FSNo @ x) @ ((ap @ X13) @ (ordsucc @ c_Empty)))) @ (minus_5FSNo @ ((mul_5FSNo @ ((ap @ X13) @ c_Empty)) @ ((ap @ X13) @ (ordsucc @ c_Empty))))))))) @ ((c_Repl @ ((setprod @ c_Rx) @ c_Ry)) @ (^ [X13:$i] : ((add_5FSNo @ ((mul_5FSNo @ ((ap @ X13) @ c_Empty)) @ y)) @ ((add_5FSNo @ ((mul_5FSNo @ x) @ ((ap @ X13) @ (ordsucc @ c_Empty)))) @ (minus_5FSNo @ ((mul_5FSNo @ ((ap @ X13) @ c_Empty)) @ ((ap @ X13) @ (ordsucc @ c_Empty)))))))))) @ ((binunion @ ((c_Repl @ ((setprod @ c_Lx) @ c_Ry)) @ (^ [X13:$i] : ((add_5FSNo @ ((mul_5FSNo @ ((ap @ X13) @ c_Empty)) @ y)) @ ((add_5FSNo @ ((mul_5FSNo @ x) @ ((ap @ X13) @ (ordsucc @ c_Empty)))) @ (minus_5FSNo @ ((mul_5FSNo @ ((ap @ X13) @ c_Empty)) @ ((ap @ X13) @ (ordsucc @ c_Empty))))))))) @ ((c_Repl @ ((setprod @ c_Rx) @ c_Ly)) @ (^ [X13:$i] : ((add_5FSNo @ ((mul_5FSNo @ ((ap @ X13) @ c_Empty)) @ y)) @ ((add_5FSNo @ ((mul_5FSNo @ x) @ ((ap @ X13) @ (ordsucc @ c_Empty)))) @ (minus_5FSNo @ ((mul_5FSNo @ ((ap @ X13) @ c_Empty)) @ ((ap @ X13) @ (ordsucc @ c_Empty))))))))))) @ ((add_5FSNo @ ((mul_5FSNo @ w0_27) @ y)) @ ((add_5FSNo @ ((mul_5FSNo @ x) @ z1_27)) @ (minus_5FSNo @ ((mul_5FSNo @ w0_27) @ z1_27)))))).
