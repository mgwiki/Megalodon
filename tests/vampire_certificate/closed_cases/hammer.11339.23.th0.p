% megalodon_origin ((file "/project/Megalodon/examples/hammer/100thms_12_h.mg") (line "11339") (char "23") (kind "aby"))
...
% megalodon_source_map (conjecture "conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F11339_5F23" "/project/tmp/megalodon3_source_linked_corpus_250/hammer_11339_23" "")
thf(conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F11339_5F23,conjecture,(! [X8:($i > $o)] : ((X8 @ c_Empty) => ((! [X9:$i] : ((X8 @ X9) => (X8 @ (ordsucc @ X9)))) => (X8 @ k_27))))).
