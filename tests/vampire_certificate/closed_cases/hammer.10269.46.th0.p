% megalodon_origin ((file "examples/hammer/100thms_12_h.mg") (line "10269") (char "46") (kind "aby"))
...
% megalodon_source_map (known "binunionI2" "binunionI2" "c5d368c671e9b46c609a1d230dfb54bcf83cb15c2467e38febbebbaae3b135e5")
thf(binunionI2,axiom,(! [X0:$i] : (! [X1:$i] : (! [X2:$i] : (((c_In @ X2) @ X1) => ((c_In @ X2) @ ((binunion @ X0) @ X1))))))). % c5d368c671e9b46c609a1d230dfb54bcf83cb15c2467e38febbebbaae3b135e5
...
thf(w_tp,type,(w : $i)).
% megalodon_source_map (local_type "z0_tp" "z0" "")
thf(z0_tp,type,(z0 : $i)).
% megalodon_source_map (local_type "z1_tp" "z1" "")
thf(z1_tp,type,(z1 : $i)).
% megalodon_source_map (local_type "z0_27_tp" "z0'" "")
thf(z0_27_tp,type,(z0_27 : $i)).
...
% megalodon_source_map (local_fact "c_Hz0_271" "Hz0'1" "")
thf(c_Hz0_271,axiom,((c_In @ z0_27) @ c_Rx)).
% megalodon_source_map (local_fact "c_Hv3" "Hv3" "")
thf(c_Hv3,axiom,(! [X13:$i] : (((c_In @ X13) @ ((binunion @ ((c_Repl @ ((setprod @ c_Lx) @ c_Ly)) @ (^ [X14:$i] : ((add_5FSNo @ ((mul_5FSNo @ ((ap @ X14) @ c_Empty)) @ y)) @ ((add_5FSNo @ ((mul_5FSNo @ x) @ ((ap @ X14) @ (ordsucc @ c_Empty)))) @ (minus_5FSNo @ ((mul_5FSNo @ ((ap @ X14) @ c_Empty)) @ ((ap @ X14) @ (ordsucc @ c_Empty))))))))) @ ((c_Repl @ ((setprod @ c_Rx) @ c_Ry)) @ (^ [X14:$i] : ((add_5FSNo @ ((mul_5FSNo @ ((ap @ X14) @ c_Empty)) @ y)) @ ((add_5FSNo @ ((mul_5FSNo @ x) @ ((ap @ X14) @ (ordsucc @ c_Empty)))) @ (minus_5FSNo @ ((mul_5FSNo @ ((ap @ X14) @ c_Empty)) @ ((ap @ X14) @ (ordsucc @ c_Empty)))))))))) => ((c_SNoLt @ X13) @ ((c_SNoCut @ ((binunion @ ((c_Repl @ ((setprod @ c_Lx) @ c_Ly)) @ (^ [X14:$i] : ((add_5FSNo @ ((mul_5FSNo @ ((ap @ X14) @ c_Empty)) @ y)) @ ((add_5FSNo @ ((mul_5FSNo @ x) @ ((ap @ X14) @ (ordsucc @ c_Empty)))) @ (minus_5FSNo @ ((mul_5FSNo @ ((ap @ X14) @ c_Empty)) @ ((ap @ X14) @ (ordsucc @ c_Empty))))))))) @ ((c_Repl @ ((setprod @ c_Rx) @ c_Ry)) @ (^ [X14:$i] : ((add_5FSNo @ ((mul_5FSNo @ ((ap @ X14) @ c_Empty)) @ y)) @ ((add_5FSNo @ ((mul_5FSNo @ x) @ ((ap @ X14) @ (ordsucc @ c_Empty)))) @ (minus_5FSNo @ ((mul_5FSNo @ ((ap @ X14) @ c_Empty)) @ ((ap @ X14) @ (ordsucc @ c_Empty)))))))))) @ ((binunion @ ((c_Repl @ ((setprod @ c_Lx) @ c_Ry)) @ (^ [X14:$i] : ((add_5FSNo @ ((mul_5FSNo @ ((ap @ X14) @ c_Empty)) @ y)) @ ((add_5FSNo @ ((mul_5FSNo @ x) @ ((ap @ X14) @ (ordsucc @ c_Empty)))) @ (minus_5FSNo @ ((mul_5FSNo @ ((ap @ X14) @ c_Empty)) @ ((ap @ X14) @ (ordsucc @ c_Empty))))))))) @ ((c_Repl @ ((setprod @ c_Rx) @ c_Ly)) @ (^ [X14:$i] : ((add_5FSNo @ ((mul_5FSNo @ ((ap @ X14) @ c_Empty)) @ y)) @ ((add_5FSNo @ ((mul_5FSNo @ x) @ ((ap @ X14) @ (ordsucc @ c_Empty)))) @ (minus_5FSNo @ ((mul_5FSNo @ ((ap @ X14) @ c_Empty)) @ ((ap @ X14) @ (ordsucc @ c_Empty)))))))))))))).
% megalodon_source_map (local_fact "c_RxRy_27I" "RxRy'I" "")
thf(c_RxRy_27I,axiom,(! [X13:$i] : (((c_In @ X13) @ c_Rx) => (! [X14:$i] : (((c_In @ X14) @ c_Ry) => ((c_In @ ((add_5FSNo @ ((mul_5FSNo @ X13) @ y)) @ ((add_5FSNo @ ((mul_5FSNo @ x) @ X14)) @ (minus_5FSNo @ ((mul_5FSNo @ X13) @ X14))))) @ ((c_Repl @ ((setprod @ c_Rx) @ c_Ry)) @ (^ [X15:$i] : ((add_5FSNo @ ((mul_5FSNo @ ((ap @ X15) @ c_Empty)) @ y)) @ ((add_5FSNo @ ((mul_5FSNo @ x) @ ((ap @ X15) @ (ordsucc @ c_Empty)))) @ (minus_5FSNo @ ((mul_5FSNo @ ((ap @ X15) @ c_Empty)) @ ((ap @ X15) @ (ordsucc @ c_Empty)))))))))))))).
% megalodon_source_map (conjecture "conj_c__2Fproject_2Ftmp_2Fsource_5Flinked_5Fstrict_5F100_5Fcorpus_5Ffresh_5F041947_2Fhammer_5F10269_5F46" "/project/tmp/source_linked_strict_100_corpus_fresh_041947/hammer_10269_46" "")
thf(conj_c__2Fproject_2Ftmp_2Fsource_5Flinked_5Fstrict_5F100_5Fcorpus_5Ffresh_5F041947_2Fhammer_5F10269_5F46,conjecture,((c_SNoLt @ ((add_5FSNo @ ((mul_5FSNo @ z0_27) @ y)) @ ((add_5FSNo @ ((mul_5FSNo @ x) @ z1_27)) @ (minus_5FSNo @ ((mul_5FSNo @ z0_27) @ z1_27))))) @ ((c_SNoCut @ ((binunion @ ((c_Repl @ ((setprod @ c_Lx) @ c_Ly)) @ (^ [X13:$i] : ((add_5FSNo @ ((mul_5FSNo @ ((ap @ X13) @ c_Empty)) @ y)) @ ((add_5FSNo @ ((mul_5FSNo @ x) @ ((ap @ X13) @ (ordsucc @ c_Empty)))) @ (minus_5FSNo @ ((mul_5FSNo @ ((ap @ X13) @ c_Empty)) @ ((ap @ X13) @ (ordsucc @ c_Empty))))))))) @ ((c_Repl @ ((setprod @ c_Rx) @ c_Ry)) @ (^ [X13:$i] : ((add_5FSNo @ ((mul_5FSNo @ ((ap @ X13) @ c_Empty)) @ y)) @ ((add_5FSNo @ ((mul_5FSNo @ x) @ ((ap @ X13) @ (ordsucc @ c_Empty)))) @ (minus_5FSNo @ ((mul_5FSNo @ ((ap @ X13) @ c_Empty)) @ ((ap @ X13) @ (ordsucc @ c_Empty)))))))))) @ ((binunion @ ((c_Repl @ ((setprod @ c_Lx) @ c_Ry)) @ (^ [X13:$i] : ((add_5FSNo @ ((mul_5FSNo @ ((ap @ X13) @ c_Empty)) @ y)) @ ((add_5FSNo @ ((mul_5FSNo @ x) @ ((ap @ X13) @ (ordsucc @ c_Empty)))) @ (minus_5FSNo @ ((mul_5FSNo @ ((ap @ X13) @ c_Empty)) @ ((ap @ X13) @ (ordsucc @ c_Empty))))))))) @ ((c_Repl @ ((setprod @ c_Rx) @ c_Ly)) @ (^ [X13:$i] : ((add_5FSNo @ ((mul_5FSNo @ ((ap @ X13) @ c_Empty)) @ y)) @ ((add_5FSNo @ ((mul_5FSNo @ x) @ ((ap @ X13) @ (ordsucc @ c_Empty)))) @ (minus_5FSNo @ ((mul_5FSNo @ ((ap @ X13) @ c_Empty)) @ ((ap @ X13) @ (ordsucc @ c_Empty)))))))))))).
