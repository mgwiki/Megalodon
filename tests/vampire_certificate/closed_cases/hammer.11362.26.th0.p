% megalodon_origin ((file "/project/Megalodon/examples/hammer/100thms_12_h.mg") (line "11362") (char "26") (kind "aby"))
...
thf(c_H4,axiom,((c_In @ (g_27 @ k_27_27)) @ omega)).
% megalodon_source_map (conjecture "conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F11362_5F26" "/project/tmp/megalodon3_source_linked_corpus_250/hammer_11362_26" "")
thf(conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F11362_5F26,conjecture,(! [X9:($i > $o)] : ((X9 @ c_Empty) => ((! [X10:$i] : ((X9 @ X10) => (X9 @ (ordsucc @ X10)))) => (X9 @ (g_27 @ k_27_27)))))).
