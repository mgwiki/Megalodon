% megalodon_origin ((file "/project/Megalodon/examples/hammer/100thms_12_h.mg") (line "12204") (char "84") (kind "aby"))
...
% megalodon_source_map (known "c_SNo_5Fminus_5FSNo" "SNo_minus_SNo" "5fc6b424fa17791172da437df8be1755f600b86002fd5d0270e07122f49bdcc0")
thf(c_SNo_5Fminus_5FSNo,axiom,(! [X0:$i] : ((c_SNo @ X0) => (c_SNo @ (minus_5FSNo @ X0))))). % 5fc6b424fa17791172da437df8be1755f600b86002fd5d0270e07122f49bdcc0
...
% megalodon_source_map (known "mul_5FSNo_5Fassoc" "mul_SNo_assoc" "486865c3188385931c49f470667cf40aed4fd0ae74607f2310f86efc829888ba")
thf(mul_5FSNo_5Fassoc,axiom,(! [X0:$i] : (! [X1:$i] : (! [X2:$i] : ((c_SNo @ X0) => ((c_SNo @ X1) => ((c_SNo @ X2) => (((mul_5FSNo @ X0) @ ((mul_5FSNo @ X1) @ X2)) = ((mul_5FSNo @ ((mul_5FSNo @ X0) @ X1)) @ X2))))))))). % 486865c3188385931c49f470667cf40aed4fd0ae74607f2310f86efc829888ba
...
thf(r_tp,type,(r : ($i > $i))).
% megalodon_source_map (local_definition "r_def" "r" "")
thf(r_def,definition,(r = ((c_SNo_5Frecipaux @ x) @ g))).
% megalodon_source_map (local_type "x_27_tp" "x'" "")
thf(x_27_tp,type,(x_27 : $i)).
% megalodon_source_map (local_type "y_tp" "y" "")
thf(y_tp,type,(y : $i)).
% megalodon_source_map (local_type "y_27_tp" "y'" "")
thf(y_27_tp,type,(y_27 : $i)).
% megalodon_source_map (local_fact "c_Hgx_272" "Hgx'2" "")
thf(c_Hgx_272,axiom,(((mul_5FSNo @ x_27) @ (g @ x_27)) = (ordsucc @ c_Empty))).
% megalodon_source_map (local_fact "c_Hgx_271" "Hgx'1" "")
thf(c_Hgx_271,axiom,(c_SNo @ (g @ x_27))).
% megalodon_source_map (local_fact "c_Hx_271" "Hx'1" "")
thf(c_Hx_271,axiom,(c_SNo @ x_27)).
% megalodon_source_map (local_fact "c_Hy_27" "Hy'" "")
thf(c_Hy_27,axiom,(y_27 = ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ ((add_5FSNo @ x_27) @ (minus_5FSNo @ x))) @ y))) @ (g @ x_27)))).
% megalodon_source_map (local_fact "c_Hy" "Hy" "")
thf(c_Hy,axiom,(c_SNo @ y)).
% megalodon_source_map (local_fact "c_Hx_27pos" "Hx'pos" "")
thf(c_Hx_27pos,axiom,((c_SNoLt @ c_Empty) @ x_27)).
% megalodon_source_map (local_fact "c_Hx_27" "Hx'" "")
thf(c_Hx_27,axiom,((c_In @ x_27) @ (c_SNoS_5F @ (c_SNoLev @ x)))).
% megalodon_source_map (local_fact "c_L1" "L1" "")
thf(c_L1,axiom,(! [X5:$i] : (((c_In @ X5) @ (c_SNoS_5F @ (c_SNoLev @ x))) => (((c_SNoLt @ c_Empty) @ X5) => (! [X6:$i] : (! [X7:$i] : ((c_SNo @ X6) => ((X7 = ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ ((add_5FSNo @ X5) @ (minus_5FSNo @ x))) @ X6))) @ (g @ X5))) => (c_SNo @ X7))))))))).
% megalodon_source_map (local_fact "c_Hg" "Hg" "")
thf(c_Hg,axiom,(! [X5:$i] : (((c_In @ X5) @ (c_SNoS_5F @ (c_SNoLev @ x))) => (((c_SNoLt @ c_Empty) @ X5) => (! [X6:$o] : (((c_SNo @ (g @ X5)) => ((((mul_5FSNo @ X5) @ (g @ X5)) = (ordsucc @ c_Empty)) => X6)) => X6)))))).
...
% megalodon_source_map (conjecture "conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F12204_5F84" "/project/tmp/megalodon3_source_linked_corpus_250/hammer_12204_84" "")
thf(conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F12204_5F84,conjecture,(((mul_5FSNo @ (minus_5FSNo @ x)) @ ((mul_5FSNo @ y) @ (minus_5FSNo @ x))) = ((mul_5FSNo @ ((mul_5FSNo @ (minus_5FSNo @ x)) @ y)) @ (minus_5FSNo @ x)))).
