% megalodon_origin ((file "/project/Megalodon/examples/hammer/100thms_12_h.mg") (line "12352") (char "125") (kind "aby"))
...
% megalodon_source_map (local_type "w_27_27_tp" "w''" "")
thf(w_27_27_tp,type,(w_27_27 : $i)).
% megalodon_source_map (local_definition "w_27_27_def" "w''" "")
thf(w_27_27_def,definition,(w_27_27 = ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ ((add_5FSNo @ v) @ (minus_5FSNo @ x))) @ w_27))) @ (recip_5FSNo_5Fpos @ v)))).
% megalodon_source_map (local_fact "c_H8" "H8" "")
thf(c_H8,axiom,(! [X4:$o] : ((((((c_PNoLt @ (c_SNoLev @ ((mul_5FSNo @ ((add_5FSNo @ (minus_5FSNo @ v)) @ x)) @ w_27))) @ (^ [X5:$i] : ((c_In @ X5) @ ((mul_5FSNo @ ((add_5FSNo @ (minus_5FSNo @ v)) @ x)) @ w_27)))) @ (c_SNoLev @ ((mul_5FSNo @ ((add_5FSNo @ (minus_5FSNo @ v)) @ x)) @ w))) @ (^ [X5:$i] : ((c_In @ X5) @ ((mul_5FSNo @ ((add_5FSNo @ (minus_5FSNo @ v)) @ x)) @ w)))) => X4) => (((! [X5:$o] : ((((c_SNoLev @ ((mul_5FSNo @ ((add_5FSNo @ (minus_5FSNo @ v)) @ x)) @ w_27)) = (c_SNoLev @ ((mul_5FSNo @ ((add_5FSNo @ (minus_5FSNo @ v)) @ x)) @ w))) => ((! [X6:$i] : (((c_In @ X6) @ (c_SNoLev @ ((mul_5FSNo @ ((add_5FSNo @ (minus_5FSNo @ v)) @ x)) @ w_27))) => (! [X7:$o] : (((((c_In @ X6) @ ((mul_5FSNo @ ((add_5FSNo @ (minus_5FSNo @ v)) @ x)) @ w_27)) => ((c_In @ X6) @ ((mul_5FSNo @ ((add_5FSNo @ (minus_5FSNo @ v)) @ x)) @ w))) => ((((c_In @ X6) @ ((mul_5FSNo @ ((add_5FSNo @ (minus_5FSNo @ v)) @ x)) @ w)) => ((c_In @ X6) @ ((mul_5FSNo @ ((add_5FSNo @ (minus_5FSNo @ v)) @ x)) @ w_27))) => X7)) => X7)))) => X5)) => X5)) => X4) => X4)))).
% megalodon_source_map (local_fact "c_Hw_27_27" "Hw''" "")
thf(c_Hw_27_27,axiom,((c_In @ ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ ((add_5FSNo @ v) @ (minus_5FSNo @ x))) @ w_27))) @ (recip_5FSNo_5Fpos @ v))) @ ((famunion @ omega) @ (^ [X4:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X4)) @ c_Empty))))).
...
% megalodon_source_map (local_fact "c_Hvpos" "Hvpos" "")
thf(c_Hvpos,axiom,((c_SNoLt @ c_Empty) @ v)).
% megalodon_source_map (local_fact "c_HvS" "HvS" "")
thf(c_HvS,axiom,((c_In @ v) @ (c_SNoS_5F @ (c_SNoLev @ x)))).
% megalodon_source_map (local_fact "c_Hw_27" "Hw'" "")
thf(c_Hw_27,axiom,(c_SNo @ w_27)).
...
% megalodon_source_map (conjecture "conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F12352_5F125" "/project/tmp/megalodon3_source_linked_corpus_250/hammer_12352_125" "")
thf(conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F12352_5F125,conjecture,(c_SNo @ ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ ((add_5FSNo @ v) @ (minus_5FSNo @ x))) @ w_27))) @ (recip_5FSNo_5Fpos @ v)))).
