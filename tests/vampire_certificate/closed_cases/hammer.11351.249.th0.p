% megalodon_origin ((file "examples/hammer/100thms_12_h.mg") (line "11351") (char "249") (kind "aby"))
...
% megalodon_source_map (known "omega_5FSNo" "omega_SNo" "4db46e69c527658700c8e8d4094e99be3332a20c2cf96d073256ad0c0923280d")
thf(omega_5FSNo,axiom,(! [X0:$i] : (((c_In @ X0) @ omega) => (c_SNo @ X0)))). % 4db46e69c527658700c8e8d4094e99be3332a20c2cf96d073256ad0c0923280d
...
thf(n_tp,type,(n : $i)).
% megalodon_source_map (local_type "p_tp" "p" "")
thf(p_tp,type,(p : $i)).
% megalodon_source_map (local_type "m_tp" "m" "")
thf(m_tp,type,(m : $i)).
% megalodon_source_map (local_type "k_tp" "k" "")
thf(k_tp,type,(k : $i)).
% megalodon_source_map (local_type "f_tp" "f" "")
thf(f_tp,type,(f : ($i > $i))).
% megalodon_source_map (local_type "g_tp" "g" "")
thf(g_tp,type,(g : ($i > $i))).
% megalodon_source_map (local_type "k_27_tp" "k'" "")
thf(k_27_tp,type,(k_27 : $i)).
% megalodon_source_map (local_type "g_27_tp" "g'" "")
thf(g_27_tp,type,(g_27 : ($i > $i))).
% megalodon_source_map (local_type "k_27_27_tp" "k''" "")
thf(k_27_27_tp,type,(k_27_27 : $i)).
% megalodon_source_map (local_fact "c_LPg_27k_27_27N" "LPg'k''N" "")
thf(c_LPg_27k_27_27N,axiom,((c_In @ ((c_Pi_5FSNo @ g_27) @ k_27_27)) @ omega)).
% megalodon_source_map (local_fact "c_L6" "L6" "")
thf(c_L6,axiom,(! [X9:$i] : (((c_In @ X9) @ k_27_27) => (! [X10:$o] : (((! [X11:$o] : (((! [X12:$o] : ((((c_In @ (g_27 @ X9)) @ omega) => (((c_In @ (ordsucc @ c_Empty)) @ (g_27 @ X9)) => X12)) => X12)) => ((! [X12:$i] : (((c_In @ X12) @ omega) => ((! [X13:$o] : (((! [X14:$o] : ((((c_In @ X12) @ omega) => (((c_In @ (g_27 @ X9)) @ omega) => X14)) => X14)) => ((! [X14:$o] : ((! [X15:$i] : ((! [X16:$o] : ((((c_In @ X15) @ omega) => ((((mul_5Fnat @ X12) @ X15) = (g_27 @ X9)) => X16)) => X16)) => X14)) => X14)) => X13)) => X13)) => (! [X13:$o] : (((X12 = (ordsucc @ c_Empty)) => X13) => (((X12 = (g_27 @ X9)) => X13) => X13)))))) => X11)) => X11)) => ((! [X11:$i] : (((c_In @ X11) @ X9) => (! [X12:$o] : ((((((c_PNoLt @ (c_SNoLev @ (g_27 @ X9))) @ (^ [X13:$i] : ((c_In @ X13) @ (g_27 @ X9)))) @ (c_SNoLev @ (g_27 @ X11))) @ (^ [X13:$i] : ((c_In @ X13) @ (g_27 @ X11)))) => X12) => (((! [X13:$o] : ((((c_SNoLev @ (g_27 @ X9)) = (c_SNoLev @ (g_27 @ X11))) => ((! [X14:$i] : (((c_In @ X14) @ (c_SNoLev @ (g_27 @ X9))) => (! [X15:$o] : (((((c_In @ X14) @ (g_27 @ X9)) => ((c_In @ X14) @ (g_27 @ X11))) => ((((c_In @ X14) @ (g_27 @ X11)) => ((c_In @ X14) @ (g_27 @ X9))) => X15)) => X15)))) => X13)) => X13)) => X12) => X12))))) => X10)) => X10))))).
% megalodon_source_map (local_fact "c_Hk_27k_27_27" "Hk'k''" "")
thf(c_Hk_27k_27_27,axiom,(k_27 = (ordsucc @ k_27_27))).
% megalodon_source_map (local_fact "c_Hk_27_27" "Hk''" "")
thf(c_Hk_27_27,axiom,(! [X9:($i > $o)] : ((X9 @ c_Empty) => ((! [X10:$i] : ((X9 @ X10) => (X9 @ (ordsucc @ X10)))) => (X9 @ k_27_27))))).
% megalodon_source_map (local_fact "c_H" "H" "")
thf(c_H,axiom,(! [X9:$o] : (((! [X10:($i > $o)] : ((X10 @ c_Empty) => ((! [X11:$i] : ((X10 @ X11) => (X10 @ (ordsucc @ X11)))) => (X10 @ k_27_27)))) => ((k_27 = (ordsucc @ k_27_27)) => X9)) => X9))).
% megalodon_source_map (local_fact "c_H_src2" "H" "")
thf(c_H_src2,axiom,(! [X9:$o] : ((! [X10:$i] : ((! [X11:$o] : (((! [X12:($i > $o)] : ((X12 @ c_Empty) => ((! [X13:$i] : ((X12 @ X13) => (X12 @ (ordsucc @ X13)))) => (X12 @ X10)))) => ((k_27 = (ordsucc @ X10)) => X11)) => X11)) => X9)) => X9))).
% megalodon_source_map (local_fact "c_Lk_27N" "Lk'N" "")
thf(c_Lk_27N,axiom,(! [X9:($i > $o)] : ((X9 @ c_Empty) => ((! [X10:$i] : ((X9 @ X10) => (X9 @ (ordsucc @ X10)))) => (X9 @ k_27))))).
% megalodon_source_map (local_fact "c_Lg_272" "Lg'2" "")
thf(c_Lg_272,axiom,(! [X9:$i] : (((c_In @ X9) @ k_27) => ((c_In @ (g_27 @ X9)) @ omega)))).
% megalodon_source_map (local_fact "c_Lg_271" "Lg'1" "")
thf(c_Lg_271,axiom,(! [X9:$i] : (((c_In @ X9) @ k_27) => (! [X10:$o] : (((! [X11:$o] : ((((c_In @ (g_27 @ X9)) @ omega) => (((c_In @ (ordsucc @ c_Empty)) @ (g_27 @ X9)) => X11)) => X11)) => ((! [X11:$i] : (((c_In @ X11) @ omega) => ((! [X12:$o] : (((! [X13:$o] : ((((c_In @ X11) @ omega) => (((c_In @ (g_27 @ X9)) @ omega) => X13)) => X13)) => ((! [X13:$o] : ((! [X14:$i] : ((! [X15:$o] : ((((c_In @ X14) @ omega) => ((((mul_5Fnat @ X11) @ X14) = (g_27 @ X9)) => X15)) => X15)) => X13)) => X13)) => X12)) => X12)) => (! [X12:$o] : (((X11 = (ordsucc @ c_Empty)) => X12) => (((X11 = (g_27 @ X9)) => X12) => X12)))))) => X10)) => X10))))).
% megalodon_source_map (local_fact "c_Hg_27k_27" "Hg'k'" "")
thf(c_Hg_27k_27,axiom,(((c_Pi_5FSNo @ g_27) @ k_27) = n)).
% megalodon_source_map (local_fact "c_Hg_27" "Hg'" "")
thf(c_Hg_27,axiom,(! [X9:$i] : (((c_In @ X9) @ k_27) => (! [X10:$o] : (((! [X11:$o] : (((! [X12:$o] : ((((c_In @ (g_27 @ X9)) @ omega) => (((c_In @ (ordsucc @ c_Empty)) @ (g_27 @ X9)) => X12)) => X12)) => ((! [X12:$i] : (((c_In @ X12) @ omega) => ((! [X13:$o] : (((! [X14:$o] : ((((c_In @ X12) @ omega) => (((c_In @ (g_27 @ X9)) @ omega) => X14)) => X14)) => ((! [X14:$o] : ((! [X15:$i] : ((! [X16:$o] : ((((c_In @ X15) @ omega) => ((((mul_5Fnat @ X12) @ X15) = (g_27 @ X9)) => X16)) => X16)) => X14)) => X14)) => X13)) => X13)) => (! [X13:$o] : (((X12 = (ordsucc @ c_Empty)) => X13) => (((X12 = (g_27 @ X9)) => X13) => X13)))))) => X11)) => X11)) => ((! [X11:$i] : (((c_In @ X11) @ X9) => (! [X12:$o] : ((((((c_PNoLt @ (c_SNoLev @ (g_27 @ X9))) @ (^ [X13:$i] : ((c_In @ X13) @ (g_27 @ X9)))) @ (c_SNoLev @ (g_27 @ X11))) @ (^ [X13:$i] : ((c_In @ X13) @ (g_27 @ X11)))) => X12) => (((! [X13:$o] : ((((c_SNoLev @ (g_27 @ X9)) = (c_SNoLev @ (g_27 @ X11))) => ((! [X14:$i] : (((c_In @ X14) @ (c_SNoLev @ (g_27 @ X9))) => (! [X15:$o] : (((((c_In @ X14) @ (g_27 @ X9)) => ((c_In @ X14) @ (g_27 @ X11))) => ((((c_In @ X14) @ (g_27 @ X11)) => ((c_In @ X14) @ (g_27 @ X9))) => X15)) => X15)))) => X13)) => X13)) => X12) => X12))))) => X10)) => X10))))).
% megalodon_source_map (local_fact "c_Hk_27" "Hk'" "")
thf(c_Hk_27,axiom,((c_In @ k_27) @ omega)).
% megalodon_source_map (local_fact "c_Hgi" "Hgi" "")
thf(c_Hgi,axiom,(! [X9:$i] : (((c_In @ X9) @ k) => ((g @ X9) = (f @ X9))))).
% megalodon_source_map (local_fact "c_Hgk" "Hgk" "")
thf(c_Hgk,axiom,((g @ k) = p)).
% megalodon_source_map (local_fact "c_H_src3" "H" "")
thf(c_H_src3,axiom,(! [X9:$o] : ((((g @ k) = p) => ((! [X10:$i] : (((c_In @ X10) @ k) => ((g @ X10) = (f @ X10)))) => X9)) => X9))).
% megalodon_source_map (local_fact "c_Lg" "Lg" "")
thf(c_Lg,axiom,(! [X9:$o] : ((! [X10:($i > $i)] : ((! [X11:$o] : ((((X10 @ k) = p) => ((! [X12:$i] : (((c_In @ X12) @ k) => ((X10 @ X12) = (f @ X12)))) => X11)) => X11)) => X9)) => X9))).
% megalodon_source_map (local_fact "c_Lf2" "Lf2" "")
thf(c_Lf2,axiom,(! [X9:$i] : (((c_In @ X9) @ k) => ((c_In @ (f @ X9)) @ omega)))).
% megalodon_source_map (local_fact "c_Lf1" "Lf1" "")
thf(c_Lf1,axiom,(! [X9:$i] : (((c_In @ X9) @ k) => (! [X10:$o] : (((! [X11:$o] : ((((c_In @ (f @ X9)) @ omega) => (((c_In @ (ordsucc @ c_Empty)) @ (f @ X9)) => X11)) => X11)) => ((! [X11:$i] : (((c_In @ X11) @ omega) => ((! [X12:$o] : (((! [X13:$o] : ((((c_In @ X11) @ omega) => (((c_In @ (f @ X9)) @ omega) => X13)) => X13)) => ((! [X13:$o] : ((! [X14:$i] : ((! [X15:$o] : ((((c_In @ X14) @ omega) => ((((mul_5Fnat @ X11) @ X14) = (f @ X9)) => X15)) => X15)) => X13)) => X13)) => X12)) => X12)) => (! [X12:$o] : (((X11 = (ordsucc @ c_Empty)) => X12) => (((X11 = (f @ X9)) => X12) => X12)))))) => X10)) => X10))))).
% megalodon_source_map (local_fact "c_LkN" "LkN" "")
thf(c_LkN,axiom,(! [X9:($i > $o)] : ((X9 @ c_Empty) => ((! [X10:$i] : ((X9 @ X10) => (X9 @ (ordsucc @ X10)))) => (X9 @ k))))).
% megalodon_source_map (local_fact "c_Huniq" "Huniq" "")
thf(c_Huniq,axiom,(! [X9:$i] : (((c_In @ X9) @ omega) => (! [X10:($i > $i)] : ((! [X11:$i] : (((c_In @ X11) @ X9) => (! [X12:$o] : (((! [X13:$o] : (((! [X14:$o] : ((((c_In @ (X10 @ X11)) @ omega) => (((c_In @ (ordsucc @ c_Empty)) @ (X10 @ X11)) => X14)) => X14)) => ((! [X14:$i] : (((c_In @ X14) @ omega) => ((! [X15:$o] : (((! [X16:$o] : ((((c_In @ X14) @ omega) => (((c_In @ (X10 @ X11)) @ omega) => X16)) => X16)) => ((! [X16:$o] : ((! [X17:$i] : ((! [X18:$o] : ((((c_In @ X17) @ omega) => ((((mul_5Fnat @ X14) @ X17) = (X10 @ X11)) => X18)) => X18)) => X16)) => X16)) => X15)) => X15)) => (! [X15:$o] : (((X14 = (ordsucc @ c_Empty)) => X15) => (((X14 = (X10 @ X11)) => X15) => X15)))))) => X13)) => X13)) => ((! [X13:$i] : (((c_In @ X13) @ X11) => (! [X14:$o] : ((((((c_PNoLt @ (c_SNoLev @ (X10 @ X11))) @ (^ [X15:$i] : ((c_In @ X15) @ (X10 @ X11)))) @ (c_SNoLev @ (X10 @ X13))) @ (^ [X15:$i] : ((c_In @ X15) @ (X10 @ X13)))) => X14) => (((! [X15:$o] : ((((c_SNoLev @ (X10 @ X11)) = (c_SNoLev @ (X10 @ X13))) => ((! [X16:$i] : (((c_In @ X16) @ (c_SNoLev @ (X10 @ X11))) => (! [X17:$o] : (((((c_In @ X16) @ (X10 @ X11)) => ((c_In @ X16) @ (X10 @ X13))) => ((((c_In @ X16) @ (X10 @ X13)) => ((c_In @ X16) @ (X10 @ X11))) => X17)) => X17)))) => X15)) => X15)) => X14) => X14))))) => X12)) => X12)))) => ((((c_Pi_5FSNo @ X10) @ X9) = m) => (! [X11:$o] : (((X9 = k) => ((! [X12:$i] : (((c_In @ X12) @ k) => ((X10 @ X12) = (f @ X12)))) => X11)) => X11)))))))).
% megalodon_source_map (local_fact "c_Hfkm" "Hfkm" "")
thf(c_Hfkm,axiom,(((c_Pi_5FSNo @ f) @ k) = m)).
% megalodon_source_map (local_fact "c_Hf" "Hf" "")
thf(c_Hf,axiom,(! [X9:$i] : (((c_In @ X9) @ k) => (! [X10:$o] : (((! [X11:$o] : (((! [X12:$o] : ((((c_In @ (f @ X9)) @ omega) => (((c_In @ (ordsucc @ c_Empty)) @ (f @ X9)) => X12)) => X12)) => ((! [X12:$i] : (((c_In @ X12) @ omega) => ((! [X13:$o] : (((! [X14:$o] : ((((c_In @ X12) @ omega) => (((c_In @ (f @ X9)) @ omega) => X14)) => X14)) => ((! [X14:$o] : ((! [X15:$i] : ((! [X16:$o] : ((((c_In @ X15) @ omega) => ((((mul_5Fnat @ X12) @ X15) = (f @ X9)) => X16)) => X16)) => X14)) => X14)) => X13)) => X13)) => (! [X13:$o] : (((X12 = (ordsucc @ c_Empty)) => X13) => (((X12 = (f @ X9)) => X13) => X13)))))) => X11)) => X11)) => ((! [X11:$i] : (((c_In @ X11) @ X9) => (! [X12:$o] : ((((((c_PNoLt @ (c_SNoLev @ (f @ X9))) @ (^ [X13:$i] : ((c_In @ X13) @ (f @ X9)))) @ (c_SNoLev @ (f @ X11))) @ (^ [X13:$i] : ((c_In @ X13) @ (f @ X11)))) => X12) => (((! [X13:$o] : ((((c_SNoLev @ (f @ X9)) = (c_SNoLev @ (f @ X11))) => ((! [X14:$i] : (((c_In @ X14) @ (c_SNoLev @ (f @ X9))) => (! [X15:$o] : (((((c_In @ X14) @ (f @ X9)) => ((c_In @ X14) @ (f @ X11))) => ((((c_In @ X14) @ (f @ X11)) => ((c_In @ X14) @ (f @ X9))) => X15)) => X15)))) => X13)) => X13)) => X12) => X12))))) => X10)) => X10))))).
% megalodon_source_map (local_fact "c_H_src4" "H" "")
thf(c_H_src4,axiom,(! [X9:$o] : (((! [X10:$i] : (((c_In @ X10) @ k) => (! [X11:$o] : (((! [X12:$o] : (((! [X13:$o] : ((((c_In @ (f @ X10)) @ omega) => (((c_In @ (ordsucc @ c_Empty)) @ (f @ X10)) => X13)) => X13)) => ((! [X13:$i] : (((c_In @ X13) @ omega) => ((! [X14:$o] : (((! [X15:$o] : ((((c_In @ X13) @ omega) => (((c_In @ (f @ X10)) @ omega) => X15)) => X15)) => ((! [X15:$o] : ((! [X16:$i] : ((! [X17:$o] : ((((c_In @ X16) @ omega) => ((((mul_5Fnat @ X13) @ X16) = (f @ X10)) => X17)) => X17)) => X15)) => X15)) => X14)) => X14)) => (! [X14:$o] : (((X13 = (ordsucc @ c_Empty)) => X14) => (((X13 = (f @ X10)) => X14) => X14)))))) => X12)) => X12)) => ((! [X12:$i] : (((c_In @ X12) @ X10) => (! [X13:$o] : ((((((c_PNoLt @ (c_SNoLev @ (f @ X10))) @ (^ [X14:$i] : ((c_In @ X14) @ (f @ X10)))) @ (c_SNoLev @ (f @ X12))) @ (^ [X14:$i] : ((c_In @ X14) @ (f @ X12)))) => X13) => (((! [X14:$o] : ((((c_SNoLev @ (f @ X10)) = (c_SNoLev @ (f @ X12))) => ((! [X15:$i] : (((c_In @ X15) @ (c_SNoLev @ (f @ X10))) => (! [X16:$o] : (((((c_In @ X15) @ (f @ X10)) => ((c_In @ X15) @ (f @ X12))) => ((((c_In @ X15) @ (f @ X12)) => ((c_In @ X15) @ (f @ X10))) => X16)) => X16)))) => X14)) => X14)) => X13) => X13))))) => X11)) => X11)))) => ((((c_Pi_5FSNo @ f) @ k) = m) => X9)) => X9))).
% megalodon_source_map (local_fact "c_H_src5" "H" "")
thf(c_H_src5,axiom,(! [X9:$o] : (((! [X10:$o] : (((! [X11:$i] : (((c_In @ X11) @ k) => (! [X12:$o] : (((! [X13:$o] : (((! [X14:$o] : ((((c_In @ (f @ X11)) @ omega) => (((c_In @ (ordsucc @ c_Empty)) @ (f @ X11)) => X14)) => X14)) => ((! [X14:$i] : (((c_In @ X14) @ omega) => ((! [X15:$o] : (((! [X16:$o] : ((((c_In @ X14) @ omega) => (((c_In @ (f @ X11)) @ omega) => X16)) => X16)) => ((! [X16:$o] : ((! [X17:$i] : ((! [X18:$o] : ((((c_In @ X17) @ omega) => ((((mul_5Fnat @ X14) @ X17) = (f @ X11)) => X18)) => X18)) => X16)) => X16)) => X15)) => X15)) => (! [X15:$o] : (((X14 = (ordsucc @ c_Empty)) => X15) => (((X14 = (f @ X11)) => X15) => X15)))))) => X13)) => X13)) => ((! [X13:$i] : (((c_In @ X13) @ X11) => (! [X14:$o] : ((((((c_PNoLt @ (c_SNoLev @ (f @ X11))) @ (^ [X15:$i] : ((c_In @ X15) @ (f @ X11)))) @ (c_SNoLev @ (f @ X13))) @ (^ [X15:$i] : ((c_In @ X15) @ (f @ X13)))) => X14) => (((! [X15:$o] : ((((c_SNoLev @ (f @ X11)) = (c_SNoLev @ (f @ X13))) => ((! [X16:$i] : (((c_In @ X16) @ (c_SNoLev @ (f @ X11))) => (! [X17:$o] : (((((c_In @ X16) @ (f @ X11)) => ((c_In @ X16) @ (f @ X13))) => ((((c_In @ X16) @ (f @ X13)) => ((c_In @ X16) @ (f @ X11))) => X17)) => X17)))) => X15)) => X15)) => X14) => X14))))) => X12)) => X12)))) => ((((c_Pi_5FSNo @ f) @ k) = m) => X10)) => X10)) => ((! [X10:$i] : (((c_In @ X10) @ omega) => (! [X11:($i > $i)] : ((! [X12:$i] : (((c_In @ X12) @ X10) => (! [X13:$o] : (((! [X14:$o] : (((! [X15:$o] : ((((c_In @ (X11 @ X12)) @ omega) => (((c_In @ (ordsucc @ c_Empty)) @ (X11 @ X12)) => X15)) => X15)) => ((! [X15:$i] : (((c_In @ X15) @ omega) => ((! [X16:$o] : (((! [X17:$o] : ((((c_In @ X15) @ omega) => (((c_In @ (X11 @ X12)) @ omega) => X17)) => X17)) => ((! [X17:$o] : ((! [X18:$i] : ((! [X19:$o] : ((((c_In @ X18) @ omega) => ((((mul_5Fnat @ X15) @ X18) = (X11 @ X12)) => X19)) => X19)) => X17)) => X17)) => X16)) => X16)) => (! [X16:$o] : (((X15 = (ordsucc @ c_Empty)) => X16) => (((X15 = (X11 @ X12)) => X16) => X16)))))) => X14)) => X14)) => ((! [X14:$i] : (((c_In @ X14) @ X12) => (! [X15:$o] : ((((((c_PNoLt @ (c_SNoLev @ (X11 @ X12))) @ (^ [X16:$i] : ((c_In @ X16) @ (X11 @ X12)))) @ (c_SNoLev @ (X11 @ X14))) @ (^ [X16:$i] : ((c_In @ X16) @ (X11 @ X14)))) => X15) => (((! [X16:$o] : ((((c_SNoLev @ (X11 @ X12)) = (c_SNoLev @ (X11 @ X14))) => ((! [X17:$i] : (((c_In @ X17) @ (c_SNoLev @ (X11 @ X12))) => (! [X18:$o] : (((((c_In @ X17) @ (X11 @ X12)) => ((c_In @ X17) @ (X11 @ X14))) => ((((c_In @ X17) @ (X11 @ X14)) => ((c_In @ X17) @ (X11 @ X12))) => X18)) => X18)))) => X16)) => X16)) => X15) => X15))))) => X13)) => X13)))) => ((((c_Pi_5FSNo @ X11) @ X10) = m) => (! [X12:$o] : (((X10 = k) => ((! [X13:$i] : (((c_In @ X13) @ k) => ((X11 @ X13) = (f @ X13)))) => X12)) => X12))))))) => X9)) => X9))).
% megalodon_source_map (local_fact "c_H_src6" "H" "")
thf(c_H_src6,axiom,(! [X9:$o] : ((! [X10:($i > $i)] : ((! [X11:$o] : (((! [X12:$o] : (((! [X13:$i] : (((c_In @ X13) @ k) => (! [X14:$o] : (((! [X15:$o] : (((! [X16:$o] : ((((c_In @ (X10 @ X13)) @ omega) => (((c_In @ (ordsucc @ c_Empty)) @ (X10 @ X13)) => X16)) => X16)) => ((! [X16:$i] : (((c_In @ X16) @ omega) => ((! [X17:$o] : (((! [X18:$o] : ((((c_In @ X16) @ omega) => (((c_In @ (X10 @ X13)) @ omega) => X18)) => X18)) => ((! [X18:$o] : ((! [X19:$i] : ((! [X20:$o] : ((((c_In @ X19) @ omega) => ((((mul_5Fnat @ X16) @ X19) = (X10 @ X13)) => X20)) => X20)) => X18)) => X18)) => X17)) => X17)) => (! [X17:$o] : (((X16 = (ordsucc @ c_Empty)) => X17) => (((X16 = (X10 @ X13)) => X17) => X17)))))) => X15)) => X15)) => ((! [X15:$i] : (((c_In @ X15) @ X13) => (! [X16:$o] : ((((((c_PNoLt @ (c_SNoLev @ (X10 @ X13))) @ (^ [X17:$i] : ((c_In @ X17) @ (X10 @ X13)))) @ (c_SNoLev @ (X10 @ X15))) @ (^ [X17:$i] : ((c_In @ X17) @ (X10 @ X15)))) => X16) => (((! [X17:$o] : ((((c_SNoLev @ (X10 @ X13)) = (c_SNoLev @ (X10 @ X15))) => ((! [X18:$i] : (((c_In @ X18) @ (c_SNoLev @ (X10 @ X13))) => (! [X19:$o] : (((((c_In @ X18) @ (X10 @ X13)) => ((c_In @ X18) @ (X10 @ X15))) => ((((c_In @ X18) @ (X10 @ X15)) => ((c_In @ X18) @ (X10 @ X13))) => X19)) => X19)))) => X17)) => X17)) => X16) => X16))))) => X14)) => X14)))) => ((((c_Pi_5FSNo @ X10) @ k) = m) => X12)) => X12)) => ((! [X12:$i] : (((c_In @ X12) @ omega) => (! [X13:($i > $i)] : ((! [X14:$i] : (((c_In @ X14) @ X12) => (! [X15:$o] : (((! [X16:$o] : (((! [X17:$o] : ((((c_In @ (X13 @ X14)) @ omega) => (((c_In @ (ordsucc @ c_Empty)) @ (X13 @ X14)) => X17)) => X17)) => ((! [X17:$i] : (((c_In @ X17) @ omega) => ((! [X18:$o] : (((! [X19:$o] : ((((c_In @ X17) @ omega) => (((c_In @ (X13 @ X14)) @ omega) => X19)) => X19)) => ((! [X19:$o] : ((! [X20:$i] : ((! [X21:$o] : ((((c_In @ X20) @ omega) => ((((mul_5Fnat @ X17) @ X20) = (X13 @ X14)) => X21)) => X21)) => X19)) => X19)) => X18)) => X18)) => (! [X18:$o] : (((X17 = (ordsucc @ c_Empty)) => X18) => (((X17 = (X13 @ X14)) => X18) => X18)))))) => X16)) => X16)) => ((! [X16:$i] : (((c_In @ X16) @ X14) => (! [X17:$o] : ((((((c_PNoLt @ (c_SNoLev @ (X13 @ X14))) @ (^ [X18:$i] : ((c_In @ X18) @ (X13 @ X14)))) @ (c_SNoLev @ (X13 @ X16))) @ (^ [X18:$i] : ((c_In @ X18) @ (X13 @ X16)))) => X17) => (((! [X18:$o] : ((((c_SNoLev @ (X13 @ X14)) = (c_SNoLev @ (X13 @ X16))) => ((! [X19:$i] : (((c_In @ X19) @ (c_SNoLev @ (X13 @ X14))) => (! [X20:$o] : (((((c_In @ X19) @ (X13 @ X14)) => ((c_In @ X19) @ (X13 @ X16))) => ((((c_In @ X19) @ (X13 @ X16)) => ((c_In @ X19) @ (X13 @ X14))) => X20)) => X20)))) => X18)) => X18)) => X17) => X17))))) => X15)) => X15)))) => ((((c_Pi_5FSNo @ X13) @ X12) = m) => (! [X14:$o] : (((X12 = k) => ((! [X15:$i] : (((c_In @ X15) @ k) => ((X13 @ X15) = (X10 @ X15)))) => X14)) => X14))))))) => X11)) => X11)) => X9)) => X9))).
% megalodon_source_map (local_fact "c_Hk" "Hk" "")
thf(c_Hk,axiom,((c_In @ k) @ omega)).
% megalodon_source_map (local_fact "c_H_src7" "H" "")
thf(c_H_src7,axiom,(! [X9:$o] : ((((c_In @ k) @ omega) => ((! [X10:$o] : ((! [X11:($i > $i)] : ((! [X12:$o] : (((! [X13:$o] : (((! [X14:$i] : (((c_In @ X14) @ k) => (! [X15:$o] : (((! [X16:$o] : (((! [X17:$o] : ((((c_In @ (X11 @ X14)) @ omega) => (((c_In @ (ordsucc @ c_Empty)) @ (X11 @ X14)) => X17)) => X17)) => ((! [X17:$i] : (((c_In @ X17) @ omega) => ((! [X18:$o] : (((! [X19:$o] : ((((c_In @ X17) @ omega) => (((c_In @ (X11 @ X14)) @ omega) => X19)) => X19)) => ((! [X19:$o] : ((! [X20:$i] : ((! [X21:$o] : ((((c_In @ X20) @ omega) => ((((mul_5Fnat @ X17) @ X20) = (X11 @ X14)) => X21)) => X21)) => X19)) => X19)) => X18)) => X18)) => (! [X18:$o] : (((X17 = (ordsucc @ c_Empty)) => X18) => (((X17 = (X11 @ X14)) => X18) => X18)))))) => X16)) => X16)) => ((! [X16:$i] : (((c_In @ X16) @ X14) => (! [X17:$o] : ((((((c_PNoLt @ (c_SNoLev @ (X11 @ X14))) @ (^ [X18:$i] : ((c_In @ X18) @ (X11 @ X14)))) @ (c_SNoLev @ (X11 @ X16))) @ (^ [X18:$i] : ((c_In @ X18) @ (X11 @ X16)))) => X17) => (((! [X18:$o] : ((((c_SNoLev @ (X11 @ X14)) = (c_SNoLev @ (X11 @ X16))) => ((! [X19:$i] : (((c_In @ X19) @ (c_SNoLev @ (X11 @ X14))) => (! [X20:$o] : (((((c_In @ X19) @ (X11 @ X14)) => ((c_In @ X19) @ (X11 @ X16))) => ((((c_In @ X19) @ (X11 @ X16)) => ((c_In @ X19) @ (X11 @ X14))) => X20)) => X20)))) => X18)) => X18)) => X17) => X17))))) => X15)) => X15)))) => ((((c_Pi_5FSNo @ X11) @ k) = m) => X13)) => X13)) => ((! [X13:$i] : (((c_In @ X13) @ omega) => (! [X14:($i > $i)] : ((! [X15:$i] : (((c_In @ X15) @ X13) => (! [X16:$o] : (((! [X17:$o] : (((! [X18:$o] : ((((c_In @ (X14 @ X15)) @ omega) => (((c_In @ (ordsucc @ c_Empty)) @ (X14 @ X15)) => X18)) => X18)) => ((! [X18:$i] : (((c_In @ X18) @ omega) => ((! [X19:$o] : (((! [X20:$o] : ((((c_In @ X18) @ omega) => (((c_In @ (X14 @ X15)) @ omega) => X20)) => X20)) => ((! [X20:$o] : ((! [X21:$i] : ((! [X22:$o] : ((((c_In @ X21) @ omega) => ((((mul_5Fnat @ X18) @ X21) = (X14 @ X15)) => X22)) => X22)) => X20)) => X20)) => X19)) => X19)) => (! [X19:$o] : (((X18 = (ordsucc @ c_Empty)) => X19) => (((X18 = (X14 @ X15)) => X19) => X19)))))) => X17)) => X17)) => ((! [X17:$i] : (((c_In @ X17) @ X15) => (! [X18:$o] : ((((((c_PNoLt @ (c_SNoLev @ (X14 @ X15))) @ (^ [X19:$i] : ((c_In @ X19) @ (X14 @ X15)))) @ (c_SNoLev @ (X14 @ X17))) @ (^ [X19:$i] : ((c_In @ X19) @ (X14 @ X17)))) => X18) => (((! [X19:$o] : ((((c_SNoLev @ (X14 @ X15)) = (c_SNoLev @ (X14 @ X17))) => ((! [X20:$i] : (((c_In @ X20) @ (c_SNoLev @ (X14 @ X15))) => (! [X21:$o] : (((((c_In @ X20) @ (X14 @ X15)) => ((c_In @ X20) @ (X14 @ X17))) => ((((c_In @ X20) @ (X14 @ X17)) => ((c_In @ X20) @ (X14 @ X15))) => X21)) => X21)))) => X19)) => X19)) => X18) => X18))))) => X16)) => X16)))) => ((((c_Pi_5FSNo @ X14) @ X13) = m) => (! [X15:$o] : (((X13 = k) => ((! [X16:$i] : (((c_In @ X16) @ k) => ((X14 @ X16) = (X11 @ X16)))) => X15)) => X15))))))) => X12)) => X12)) => X10)) => X10)) => X9)) => X9))).
% megalodon_source_map (local_fact "c_L5" "L5" "")
thf(c_L5,axiom,((c_In @ c_Empty) @ m)).
% megalodon_source_map (local_fact "c_L4" "L4" "")
thf(c_L4,axiom,((c_In @ m) @ n)).
% megalodon_source_map (local_fact "c_L3" "L3" "")
thf(c_L3,axiom,((c_SNoLt @ m) @ n)).
% megalodon_source_map (local_fact "c_Lmpos" "Lmpos" "")
thf(c_Lmpos,axiom,((c_SNoLt @ c_Empty) @ m)).
% megalodon_source_map (local_fact "c_L1p" "L1p" "")
thf(c_L1p,axiom,((c_SNoLt @ (ordsucc @ c_Empty)) @ p)).
% megalodon_source_map (local_fact "c_Lmp" "Lmp" "")
thf(c_Lmp,axiom,(((mul_5FSNo @ m) @ p) = n)).
% megalodon_source_map (local_fact "c_Lpo" "Lpo" "")
thf(c_Lpo,axiom,(! [X9:$o] : (((! [X10:$i] : (((c_In @ X10) @ p) => (! [X11:$i] : (((c_In @ X11) @ X10) => ((c_In @ X11) @ p))))) => ((! [X10:$i] : (((c_In @ X10) @ p) => (! [X11:$i] : (((c_In @ X11) @ X10) => (! [X12:$i] : (((c_In @ X12) @ X11) => ((c_In @ X12) @ X10))))))) => X9)) => X9))).
% megalodon_source_map (local_fact "c_LpN" "LpN" "")
thf(c_LpN,axiom,(! [X9:($i > $o)] : ((X9 @ c_Empty) => ((! [X10:$i] : ((X9 @ X10) => (X9 @ (ordsucc @ X10)))) => (X9 @ p))))).
% megalodon_source_map (local_fact "c_LpS" "LpS" "")
thf(c_LpS,axiom,(c_SNo @ p)).
% megalodon_source_map (local_fact "c_Lmo" "Lmo" "")
thf(c_Lmo,axiom,(! [X9:$o] : (((! [X10:$i] : (((c_In @ X10) @ m) => (! [X11:$i] : (((c_In @ X11) @ X10) => ((c_In @ X11) @ m))))) => ((! [X10:$i] : (((c_In @ X10) @ m) => (! [X11:$i] : (((c_In @ X11) @ X10) => (! [X12:$i] : (((c_In @ X12) @ X11) => ((c_In @ X12) @ X10))))))) => X9)) => X9))).
% megalodon_source_map (local_fact "c_LmN" "LmN" "")
thf(c_LmN,axiom,(! [X9:($i > $o)] : ((X9 @ c_Empty) => ((! [X10:$i] : ((X9 @ X10) => (X9 @ (ordsucc @ X10)))) => (X9 @ m))))).
% megalodon_source_map (local_fact "c_LmS" "LmS" "")
thf(c_LmS,axiom,(c_SNo @ m)).
% megalodon_source_map (local_fact "c_Hpm" "Hpm" "")
thf(c_Hpm,axiom,(((mul_5FSNo @ p) @ m) = n)).
% megalodon_source_map (local_fact "c_Hm" "Hm" "")
thf(c_Hm,axiom,((c_In @ m) @ omega)).
% megalodon_source_map (local_fact "c_H_src8" "H" "")
thf(c_H_src8,axiom,(! [X9:$o] : ((((c_In @ m) @ omega) => ((((mul_5Fnat @ p) @ m) = n) => X9)) => X9))).
% megalodon_source_map (local_fact "c_H_src9" "H" "")
thf(c_H_src9,axiom,(! [X9:$o] : ((! [X10:$i] : ((! [X11:$o] : ((((c_In @ X10) @ omega) => ((((mul_5Fnat @ p) @ X10) = n) => X11)) => X11)) => X9)) => X9))).
% megalodon_source_map (local_fact "c_H1p" "H1p" "")
thf(c_H1p,axiom,((c_In @ (ordsucc @ c_Empty)) @ p)).
% megalodon_source_map (local_fact "c_HpN" "HpN" "")
thf(c_HpN,axiom,((c_In @ p) @ omega)).
% megalodon_source_map (local_fact "c_H_src10" "H" "")
thf(c_H_src10,axiom,(! [X9:$o] : ((((c_In @ p) @ omega) => (((c_In @ (ordsucc @ c_Empty)) @ p) => X9)) => X9))).
% megalodon_source_map (local_fact "c_Hpleast" "Hpleast" "")
thf(c_Hpleast,axiom,(! [X9:$i] : (((c_In @ X9) @ p) => ((! [X10:$o] : (((! [X11:$o] : (((! [X12:$o] : ((((c_In @ X9) @ omega) => (((c_In @ (ordsucc @ c_Empty)) @ X9) => X12)) => X12)) => ((! [X12:$i] : (((c_In @ X12) @ omega) => ((! [X13:$o] : (((! [X14:$o] : ((((c_In @ X12) @ omega) => (((c_In @ X9) @ omega) => X14)) => X14)) => ((! [X14:$o] : ((! [X15:$i] : ((! [X16:$o] : ((((c_In @ X15) @ omega) => ((((mul_5Fnat @ X12) @ X15) = X9) => X16)) => X16)) => X14)) => X14)) => X13)) => X13)) => (! [X13:$o] : (((X12 = (ordsucc @ c_Empty)) => X13) => (((X12 = X9) => X13) => X13)))))) => X11)) => X11)) => ((! [X11:$o] : (((! [X12:$o] : ((((c_In @ X9) @ omega) => (((c_In @ n) @ omega) => X12)) => X12)) => ((! [X12:$o] : ((! [X13:$i] : ((! [X14:$o] : ((((c_In @ X13) @ omega) => ((((mul_5Fnat @ X9) @ X13) = n) => X14)) => X14)) => X12)) => X12)) => X11)) => X11)) => X10)) => X10)) => (! [X10:$o] : X10))))).
% megalodon_source_map (local_fact "c_Hpn" "Hpn" "")
thf(c_Hpn,axiom,(! [X9:$o] : (((! [X10:$o] : ((((c_In @ p) @ omega) => (((c_In @ n) @ omega) => X10)) => X10)) => ((! [X10:$o] : ((! [X11:$i] : ((! [X12:$o] : ((((c_In @ X11) @ omega) => ((((mul_5Fnat @ p) @ X11) = n) => X12)) => X12)) => X10)) => X10)) => X9)) => X9))).
% megalodon_source_map (local_fact "c_Hpp" "Hpp" "")
thf(c_Hpp,axiom,(! [X9:$o] : (((! [X10:$o] : ((((c_In @ p) @ omega) => (((c_In @ (ordsucc @ c_Empty)) @ p) => X10)) => X10)) => ((! [X10:$i] : (((c_In @ X10) @ omega) => ((! [X11:$o] : (((! [X12:$o] : ((((c_In @ X10) @ omega) => (((c_In @ p) @ omega) => X12)) => X12)) => ((! [X12:$o] : ((! [X13:$i] : ((! [X14:$o] : ((((c_In @ X13) @ omega) => ((((mul_5Fnat @ X10) @ X13) = p) => X14)) => X14)) => X12)) => X12)) => X11)) => X11)) => (! [X11:$o] : (((X10 = (ordsucc @ c_Empty)) => X11) => (((X10 = p) => X11) => X11)))))) => X9)) => X9))).
% megalodon_source_map (local_fact "c_H_src11" "H" "")
thf(c_H_src11,axiom,(! [X9:$o] : (((! [X10:$o] : (((! [X11:$o] : ((((c_In @ p) @ omega) => (((c_In @ (ordsucc @ c_Empty)) @ p) => X11)) => X11)) => ((! [X11:$i] : (((c_In @ X11) @ omega) => ((! [X12:$o] : (((! [X13:$o] : ((((c_In @ X11) @ omega) => (((c_In @ p) @ omega) => X13)) => X13)) => ((! [X13:$o] : ((! [X14:$i] : ((! [X15:$o] : ((((c_In @ X14) @ omega) => ((((mul_5Fnat @ X11) @ X14) = p) => X15)) => X15)) => X13)) => X13)) => X12)) => X12)) => (! [X12:$o] : (((X11 = (ordsucc @ c_Empty)) => X12) => (((X11 = p) => X12) => X12)))))) => X10)) => X10)) => ((! [X10:$o] : (((! [X11:$o] : ((((c_In @ p) @ omega) => (((c_In @ n) @ omega) => X11)) => X11)) => ((! [X11:$o] : ((! [X12:$i] : ((! [X13:$o] : ((((c_In @ X12) @ omega) => ((((mul_5Fnat @ p) @ X12) = n) => X13)) => X13)) => X11)) => X11)) => X10)) => X10)) => X9)) => X9))).
% megalodon_source_map (local_fact "c_Hpo" "Hpo" "")
thf(c_Hpo,axiom,(! [X9:$o] : (((! [X10:$i] : (((c_In @ X10) @ p) => (! [X11:$i] : (((c_In @ X11) @ X10) => ((c_In @ X11) @ p))))) => ((! [X10:$i] : (((c_In @ X10) @ p) => (! [X11:$i] : (((c_In @ X11) @ X10) => (! [X12:$i] : (((c_In @ X12) @ X11) => ((c_In @ X12) @ X10))))))) => X9)) => X9))).
% megalodon_source_map (local_fact "c_H_src12" "H" "")
thf(c_H_src12,axiom,(! [X9:$o] : (((! [X10:$o] : (((! [X11:$i] : (((c_In @ X11) @ p) => (! [X12:$i] : (((c_In @ X12) @ X11) => ((c_In @ X12) @ p))))) => ((! [X11:$i] : (((c_In @ X11) @ p) => (! [X12:$i] : (((c_In @ X12) @ X11) => (! [X13:$i] : (((c_In @ X13) @ X12) => ((c_In @ X13) @ X11))))))) => X10)) => X10)) => ((! [X10:$o] : (((! [X11:$o] : (((! [X12:$o] : ((((c_In @ p) @ omega) => (((c_In @ (ordsucc @ c_Empty)) @ p) => X12)) => X12)) => ((! [X12:$i] : (((c_In @ X12) @ omega) => ((! [X13:$o] : (((! [X14:$o] : ((((c_In @ X12) @ omega) => (((c_In @ p) @ omega) => X14)) => X14)) => ((! [X14:$o] : ((! [X15:$i] : ((! [X16:$o] : ((((c_In @ X15) @ omega) => ((((mul_5Fnat @ X12) @ X15) = p) => X16)) => X16)) => X14)) => X14)) => X13)) => X13)) => (! [X13:$o] : (((X12 = (ordsucc @ c_Empty)) => X13) => (((X12 = p) => X13) => X13)))))) => X11)) => X11)) => ((! [X11:$o] : (((! [X12:$o] : ((((c_In @ p) @ omega) => (((c_In @ n) @ omega) => X12)) => X12)) => ((! [X12:$o] : ((! [X13:$i] : ((! [X14:$o] : ((((c_In @ X13) @ omega) => ((((mul_5Fnat @ p) @ X13) = n) => X14)) => X14)) => X12)) => X12)) => X11)) => X11)) => X10)) => X10)) => X9)) => X9))).
% megalodon_source_map (local_fact "c_H_src13" "H" "")
thf(c_H_src13,axiom,(! [X9:$o] : (((! [X10:$o] : (((! [X11:$o] : (((! [X12:$i] : (((c_In @ X12) @ p) => (! [X13:$i] : (((c_In @ X13) @ X12) => ((c_In @ X13) @ p))))) => ((! [X12:$i] : (((c_In @ X12) @ p) => (! [X13:$i] : (((c_In @ X13) @ X12) => (! [X14:$i] : (((c_In @ X14) @ X13) => ((c_In @ X14) @ X12))))))) => X11)) => X11)) => ((! [X11:$o] : (((! [X12:$o] : (((! [X13:$o] : ((((c_In @ p) @ omega) => (((c_In @ (ordsucc @ c_Empty)) @ p) => X13)) => X13)) => ((! [X13:$i] : (((c_In @ X13) @ omega) => ((! [X14:$o] : (((! [X15:$o] : ((((c_In @ X13) @ omega) => (((c_In @ p) @ omega) => X15)) => X15)) => ((! [X15:$o] : ((! [X16:$i] : ((! [X17:$o] : ((((c_In @ X16) @ omega) => ((((mul_5Fnat @ X13) @ X16) = p) => X17)) => X17)) => X15)) => X15)) => X14)) => X14)) => (! [X14:$o] : (((X13 = (ordsucc @ c_Empty)) => X14) => (((X13 = p) => X14) => X14)))))) => X12)) => X12)) => ((! [X12:$o] : (((! [X13:$o] : ((((c_In @ p) @ omega) => (((c_In @ n) @ omega) => X13)) => X13)) => ((! [X13:$o] : ((! [X14:$i] : ((! [X15:$o] : ((((c_In @ X14) @ omega) => ((((mul_5Fnat @ p) @ X14) = n) => X15)) => X15)) => X13)) => X13)) => X12)) => X12)) => X11)) => X11)) => X10)) => X10)) => ((! [X10:$i] : (((c_In @ X10) @ p) => ((! [X11:$o] : (((! [X12:$o] : (((! [X13:$o] : ((((c_In @ X10) @ omega) => (((c_In @ (ordsucc @ c_Empty)) @ X10) => X13)) => X13)) => ((! [X13:$i] : (((c_In @ X13) @ omega) => ((! [X14:$o] : (((! [X15:$o] : ((((c_In @ X13) @ omega) => (((c_In @ X10) @ omega) => X15)) => X15)) => ((! [X15:$o] : ((! [X16:$i] : ((! [X17:$o] : ((((c_In @ X16) @ omega) => ((((mul_5Fnat @ X13) @ X16) = X10) => X17)) => X17)) => X15)) => X15)) => X14)) => X14)) => (! [X14:$o] : (((X13 = (ordsucc @ c_Empty)) => X14) => (((X13 = X10) => X14) => X14)))))) => X12)) => X12)) => ((! [X12:$o] : (((! [X13:$o] : ((((c_In @ X10) @ omega) => (((c_In @ n) @ omega) => X13)) => X13)) => ((! [X13:$o] : ((! [X14:$i] : ((! [X15:$o] : ((((c_In @ X14) @ omega) => ((((mul_5Fnat @ X10) @ X14) = n) => X15)) => X15)) => X13)) => X13)) => X12)) => X12)) => X11)) => X11)) => (! [X11:$o] : X11)))) => X9)) => X9))).
% megalodon_source_map (local_fact "c_L2" "L2" "")
thf(c_L2,axiom,(! [X9:$o] : ((! [X10:$i] : ((! [X11:$o] : (((! [X12:$o] : (((! [X13:$o] : (((! [X14:$i] : (((c_In @ X14) @ X10) => (! [X15:$i] : (((c_In @ X15) @ X14) => ((c_In @ X15) @ X10))))) => ((! [X14:$i] : (((c_In @ X14) @ X10) => (! [X15:$i] : (((c_In @ X15) @ X14) => (! [X16:$i] : (((c_In @ X16) @ X15) => ((c_In @ X16) @ X14))))))) => X13)) => X13)) => ((! [X13:$o] : (((! [X14:$o] : (((! [X15:$o] : ((((c_In @ X10) @ omega) => (((c_In @ (ordsucc @ c_Empty)) @ X10) => X15)) => X15)) => ((! [X15:$i] : (((c_In @ X15) @ omega) => ((! [X16:$o] : (((! [X17:$o] : ((((c_In @ X15) @ omega) => (((c_In @ X10) @ omega) => X17)) => X17)) => ((! [X17:$o] : ((! [X18:$i] : ((! [X19:$o] : ((((c_In @ X18) @ omega) => ((((mul_5Fnat @ X15) @ X18) = X10) => X19)) => X19)) => X17)) => X17)) => X16)) => X16)) => (! [X16:$o] : (((X15 = (ordsucc @ c_Empty)) => X16) => (((X15 = X10) => X16) => X16)))))) => X14)) => X14)) => ((! [X14:$o] : (((! [X15:$o] : ((((c_In @ X10) @ omega) => (((c_In @ n) @ omega) => X15)) => X15)) => ((! [X15:$o] : ((! [X16:$i] : ((! [X17:$o] : ((((c_In @ X16) @ omega) => ((((mul_5Fnat @ X10) @ X16) = n) => X17)) => X17)) => X15)) => X15)) => X14)) => X14)) => X13)) => X13)) => X12)) => X12)) => ((! [X12:$i] : (((c_In @ X12) @ X10) => ((! [X13:$o] : (((! [X14:$o] : (((! [X15:$o] : ((((c_In @ X12) @ omega) => (((c_In @ (ordsucc @ c_Empty)) @ X12) => X15)) => X15)) => ((! [X15:$i] : (((c_In @ X15) @ omega) => ((! [X16:$o] : (((! [X17:$o] : ((((c_In @ X15) @ omega) => (((c_In @ X12) @ omega) => X17)) => X17)) => ((! [X17:$o] : ((! [X18:$i] : ((! [X19:$o] : ((((c_In @ X18) @ omega) => ((((mul_5Fnat @ X15) @ X18) = X12) => X19)) => X19)) => X17)) => X17)) => X16)) => X16)) => (! [X16:$o] : (((X15 = (ordsucc @ c_Empty)) => X16) => (((X15 = X12) => X16) => X16)))))) => X14)) => X14)) => ((! [X14:$o] : (((! [X15:$o] : ((((c_In @ X12) @ omega) => (((c_In @ n) @ omega) => X15)) => X15)) => ((! [X15:$o] : ((! [X16:$i] : ((! [X17:$o] : ((((c_In @ X16) @ omega) => ((((mul_5Fnat @ X12) @ X16) = n) => X17)) => X17)) => X15)) => X15)) => X14)) => X14)) => X13)) => X13)) => (! [X13:$o] : X13)))) => X11)) => X11)) => X9)) => X9))).
% megalodon_source_map (local_fact "c_L1" "L1" "")
thf(c_L1,axiom,((c_In @ (ordsucc @ c_Empty)) @ n)).
% megalodon_source_map (local_fact "c_Lno" "Lno" "")
thf(c_Lno,axiom,(! [X9:$o] : (((! [X10:$i] : (((c_In @ X10) @ n) => (! [X11:$i] : (((c_In @ X11) @ X10) => ((c_In @ X11) @ n))))) => ((! [X10:$i] : (((c_In @ X10) @ n) => (! [X11:$i] : (((c_In @ X11) @ X10) => (! [X12:$i] : (((c_In @ X12) @ X11) => ((c_In @ X12) @ X10))))))) => X9)) => X9))).
% megalodon_source_map (local_fact "c_LnS" "LnS" "")
thf(c_LnS,axiom,(c_SNo @ n)).
% megalodon_source_map (local_fact "c_H2" "H2" "")
thf(c_H2,axiom,((n = (ordsucc @ c_Empty)) => (! [X9:$o] : X9))).
% megalodon_source_map (local_fact "c_Ln" "Ln" "")
thf(c_Ln,axiom,((c_In @ n) @ omega)).
% megalodon_source_map (local_fact "c_H1" "H1" "")
thf(c_H1,axiom,((c_In @ c_Empty) @ n)).
% megalodon_source_map (local_fact "c_IH" "IH" "")
thf(c_IH,axiom,(! [X9:$i] : (((c_In @ X9) @ n) => (((c_In @ c_Empty) @ X9) => (! [X10:$o] : ((! [X11:$i] : ((! [X12:$o] : ((((c_In @ X11) @ omega) => ((! [X13:$o] : ((! [X14:($i > $i)] : ((! [X15:$o] : (((! [X16:$o] : (((! [X17:$i] : (((c_In @ X17) @ X11) => (! [X18:$o] : (((! [X19:$o] : (((! [X20:$o] : ((((c_In @ (X14 @ X17)) @ omega) => (((c_In @ (ordsucc @ c_Empty)) @ (X14 @ X17)) => X20)) => X20)) => ((! [X20:$i] : (((c_In @ X20) @ omega) => ((! [X21:$o] : (((! [X22:$o] : ((((c_In @ X20) @ omega) => (((c_In @ (X14 @ X17)) @ omega) => X22)) => X22)) => ((! [X22:$o] : ((! [X23:$i] : ((! [X24:$o] : ((((c_In @ X23) @ omega) => ((((mul_5Fnat @ X20) @ X23) = (X14 @ X17)) => X24)) => X24)) => X22)) => X22)) => X21)) => X21)) => (! [X21:$o] : (((X20 = (ordsucc @ c_Empty)) => X21) => (((X20 = (X14 @ X17)) => X21) => X21)))))) => X19)) => X19)) => ((! [X19:$i] : (((c_In @ X19) @ X17) => (! [X20:$o] : ((((((c_PNoLt @ (c_SNoLev @ (X14 @ X17))) @ (^ [X21:$i] : ((c_In @ X21) @ (X14 @ X17)))) @ (c_SNoLev @ (X14 @ X19))) @ (^ [X21:$i] : ((c_In @ X21) @ (X14 @ X19)))) => X20) => (((! [X21:$o] : ((((c_SNoLev @ (X14 @ X17)) = (c_SNoLev @ (X14 @ X19))) => ((! [X22:$i] : (((c_In @ X22) @ (c_SNoLev @ (X14 @ X17))) => (! [X23:$o] : (((((c_In @ X22) @ (X14 @ X17)) => ((c_In @ X22) @ (X14 @ X19))) => ((((c_In @ X22) @ (X14 @ X19)) => ((c_In @ X22) @ (X14 @ X17))) => X23)) => X23)))) => X21)) => X21)) => X20) => X20))))) => X18)) => X18)))) => ((((c_Pi_5FSNo @ X14) @ X11) = X9) => X16)) => X16)) => ((! [X16:$i] : (((c_In @ X16) @ omega) => (! [X17:($i > $i)] : ((! [X18:$i] : (((c_In @ X18) @ X16) => (! [X19:$o] : (((! [X20:$o] : (((! [X21:$o] : ((((c_In @ (X17 @ X18)) @ omega) => (((c_In @ (ordsucc @ c_Empty)) @ (X17 @ X18)) => X21)) => X21)) => ((! [X21:$i] : (((c_In @ X21) @ omega) => ((! [X22:$o] : (((! [X23:$o] : ((((c_In @ X21) @ omega) => (((c_In @ (X17 @ X18)) @ omega) => X23)) => X23)) => ((! [X23:$o] : ((! [X24:$i] : ((! [X25:$o] : ((((c_In @ X24) @ omega) => ((((mul_5Fnat @ X21) @ X24) = (X17 @ X18)) => X25)) => X25)) => X23)) => X23)) => X22)) => X22)) => (! [X22:$o] : (((X21 = (ordsucc @ c_Empty)) => X22) => (((X21 = (X17 @ X18)) => X22) => X22)))))) => X20)) => X20)) => ((! [X20:$i] : (((c_In @ X20) @ X18) => (! [X21:$o] : ((((((c_PNoLt @ (c_SNoLev @ (X17 @ X18))) @ (^ [X22:$i] : ((c_In @ X22) @ (X17 @ X18)))) @ (c_SNoLev @ (X17 @ X20))) @ (^ [X22:$i] : ((c_In @ X22) @ (X17 @ X20)))) => X21) => (((! [X22:$o] : ((((c_SNoLev @ (X17 @ X18)) = (c_SNoLev @ (X17 @ X20))) => ((! [X23:$i] : (((c_In @ X23) @ (c_SNoLev @ (X17 @ X18))) => (! [X24:$o] : (((((c_In @ X23) @ (X17 @ X18)) => ((c_In @ X23) @ (X17 @ X20))) => ((((c_In @ X23) @ (X17 @ X20)) => ((c_In @ X23) @ (X17 @ X18))) => X24)) => X24)))) => X22)) => X22)) => X21) => X21))))) => X19)) => X19)))) => ((((c_Pi_5FSNo @ X17) @ X16) = X9) => (! [X18:$o] : (((X16 = X11) => ((! [X19:$i] : (((c_In @ X19) @ X11) => ((X17 @ X19) = (X14 @ X19)))) => X18)) => X18))))))) => X15)) => X15)) => X13)) => X13)) => X12)) => X12)) => X10)) => X10)))))).
% megalodon_source_map (local_fact "c_Hn" "Hn" "")
thf(c_Hn,axiom,(! [X9:($i > $o)] : ((X9 @ c_Empty) => ((! [X10:$i] : ((X9 @ X10) => (X9 @ (ordsucc @ X10)))) => (X9 @ n))))).
% megalodon_source_map (conjecture "conj_c__2Fproject_2Ftmp_2Fsource_5Flinked_5Fstrict_5F100_5Fcorpus_5Ffresh_5F041947_2Fhammer_5F11351_5F249" "/project/tmp/source_linked_strict_100_corpus_fresh_041947/hammer_11351_249" "")
thf(conj_c__2Fproject_2Ftmp_2Fsource_5Flinked_5Fstrict_5F100_5Fcorpus_5Ffresh_5F041947_2Fhammer_5F11351_5F249,conjecture,(c_SNo @ ((c_Pi_5FSNo @ g_27) @ k_27_27))).
