% megalodon_origin ((file "examples/hammer/100thms_12_h.mg") (line "11531") (char "26") (kind "aby"))
...
thf(n_tp,type,(n : $i)).
% megalodon_source_map (local_fact "c_Len" "Len" "")
thf(c_Len,axiom,(c_SNo @ (eps_5F @ n))).
% megalodon_source_map (local_fact "c_Lem" "Lem" "")
thf(c_Lem,axiom,(c_SNo @ (eps_5F @ m))).
% megalodon_source_map (conjecture "conj_c__2Fproject_2Ftmp_2Fsource_5Flinked_5Fstrict_5F100_5Fcorpus_5Ffresh_5F041947_2Fhammer_5F11531_5F26" "/project/tmp/source_linked_strict_100_corpus_fresh_041947/hammer_11531_26" "")
thf(conj_c__2Fproject_2Ftmp_2Fsource_5Flinked_5Fstrict_5F100_5Fcorpus_5Ffresh_5F041947_2Fhammer_5F11531_5F26,conjecture,(c_SNo @ ((mul_5FSNo @ (eps_5F @ m)) @ (eps_5F @ n)))).
