% megalodon_origin ((file "/project/Megalodon/examples/hammer/100thms_12_h.mg") (line "11967") (char "25") (kind "aby"))
...
thf(m_tp,type,(m : $i)).
% megalodon_source_map (local_fact "c_Lm" "Lm" "")
thf(c_Lm,axiom,(c_SNo @ m)).
% megalodon_source_map (local_fact "c_Lek" "Lek" "")
thf(c_Lek,axiom,(c_SNo @ (eps_5F @ k))).
% megalodon_source_map (conjecture "conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F11967_5F25" "/project/tmp/megalodon3_source_linked_corpus_250/hammer_11967_25" "")
thf(conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F11967_5F25,conjecture,(c_SNo @ ((mul_5FSNo @ (eps_5F @ k)) @ m))).
