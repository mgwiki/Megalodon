% megalodon_origin ((file "examples/hammer/100thms_12_h.mg") (line "11428") (char "35") (kind "aby"))
...
% megalodon_source_map (known "omega_5Fordsucc" "omega_ordsucc" "f88efc1bceb13c969121ead8cc2c43f0ce2f1c2aeeab14ec80e7cbae241b81b8")
thf(omega_5Fordsucc,axiom,(! [X0:$i] : (((c_In @ X0) @ omega) => ((c_In @ (ordsucc @ X0)) @ omega)))). % f88efc1bceb13c969121ead8cc2c43f0ce2f1c2aeeab14ec80e7cbae241b81b8
...
% megalodon_source_map (known "c_SNo_5Feps_5Fpos" "SNo_eps_pos" "0b490342ca66792c71340524f1aa07719c0c07289d2d56aaae97eb838f5cacd6")
thf(c_SNo_5Feps_5Fpos,axiom,(! [X0:$i] : (((c_In @ X0) @ omega) => ((c_SNoLt @ c_Empty) @ (eps_5F @ X0))))). % 0b490342ca66792c71340524f1aa07719c0c07289d2d56aaae97eb838f5cacd6
...
thf(x_tp,type,(x : $i)).
% megalodon_source_map (local_definition "x_def" "x" "")
thf(x_def,definition,(x = (eps_5F @ (ordsucc @ n)))).
% megalodon_source_map (local_fact "c_Ln" "Ln" "")
thf(c_Ln,axiom,((c_In @ n) @ omega)).
% megalodon_source_map (conjecture "conj_c__2Fproject_2Ftmp_2Fsource_5Flinked_5Fstrict_5F100_5Fcorpus_5Ffresh_5F041947_2Fhammer_5F11428_5F35" "/project/tmp/source_linked_strict_100_corpus_fresh_041947/hammer_11428_35" "")
thf(conj_c__2Fproject_2Ftmp_2Fsource_5Flinked_5Fstrict_5F100_5Fcorpus_5Ffresh_5F041947_2Fhammer_5F11428_5F35,conjecture,((c_SNoLt @ c_Empty) @ (eps_5F @ (ordsucc @ n)))).
