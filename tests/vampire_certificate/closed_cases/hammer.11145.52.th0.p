% megalodon_origin ((file "/project/Megalodon/examples/hammer/100thms_12_h.mg") (line "11145") (char "52") (kind "aby"))
...
% megalodon_source_map (known "mul_5FSNo_5FIn_5Fomega" "mul_SNo_In_omega" "f4015fb6b89cc9918460b7475d37f56eddd61aa8a138170b5f9d63669ad7dca2")
thf(mul_5FSNo_5FIn_5Fomega,axiom,(! [X0:$i] : (((c_In @ X0) @ omega) => (! [X1:$i] : (((c_In @ X1) @ omega) => ((c_In @ ((mul_5FSNo @ X0) @ X1)) @ omega)))))). % f4015fb6b89cc9918460b7475d37f56eddd61aa8a138170b5f9d63669ad7dca2
...
% megalodon_source_map (known "c_Pi_5FSNo_5FS" "Pi_SNo_S" "48da2836f97d0dd91a6c71641aeb3af9b3b768fb9d04ba03312dce39e5eb5742")
thf(c_Pi_5FSNo_5FS,axiom,(! [X0:($i > $i)] : (! [X1:$i] : ((! [X2:($i > $o)] : ((X2 @ c_Empty) => ((! [X3:$i] : ((X2 @ X3) => (X2 @ (ordsucc @ X3)))) => (X2 @ X1)))) => (((c_Pi_5FSNo @ X0) @ (ordsucc @ X1)) = ((mul_5FSNo @ ((c_Pi_5FSNo @ X0) @ X1)) @ (X0 @ X1))))))). % 48da2836f97d0dd91a6c71641aeb3af9b3b768fb9d04ba03312dce39e5eb5742
% megalodon_source_map (local_type "f_tp" "f" "")
thf(f_tp,type,(f : ($i > $i))).
% megalodon_source_map (conjecture "conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F11145_5F52" "/project/tmp/megalodon3_source_linked_corpus_250/hammer_11145_52" "")
thf(conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F11145_5F52,conjecture,(! [X1:$i] : ((! [X2:($i > $o)] : ((X2 @ c_Empty) => ((! [X3:$i] : ((X2 @ X3) => (X2 @ (ordsucc @ X3)))) => (X2 @ X1)))) => (((! [X2:$i] : (((c_In @ X2) @ X1) => ((c_In @ (f @ X2)) @ omega))) => ((c_In @ ((c_Pi_5FSNo @ f) @ X1)) @ omega)) => ((! [X2:$i] : (((c_In @ X2) @ (ordsucc @ X1)) => ((c_In @ (f @ X2)) @ omega))) => ((c_In @ ((c_Pi_5FSNo @ f) @ (ordsucc @ X1))) @ omega)))))).
