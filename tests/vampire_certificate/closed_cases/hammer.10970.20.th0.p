% megalodon_origin ((file "/project/Megalodon/examples/hammer/100thms_12_h.mg") (line "10970") (char "20") (kind "aby"))
...
thf(n_tp,type,(n : $i)).
% megalodon_source_map (local_fact "c_LdN" "LdN" "")
thf(c_LdN,axiom,(! [X5:($i > $o)] : ((X5 @ c_Empty) => ((! [X6:$i] : ((X5 @ X6) => (X5 @ (ordsucc @ X6)))) => (X5 @ d))))).
% megalodon_source_map (conjecture "conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F10970_5F20" "/project/tmp/megalodon3_source_linked_corpus_250/hammer_10970_20" "")
thf(conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F10970_5F20,conjecture,(c_SNo @ d)).
