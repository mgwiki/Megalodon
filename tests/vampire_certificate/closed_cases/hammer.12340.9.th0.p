% megalodon_origin ((file "/project/Megalodon/examples/hammer/100thms_12_h.mg") (line "12340") (char "9") (kind "aby"))
...
% megalodon_source_map (conjecture "conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F12340_5F9" "/project/tmp/megalodon3_source_linked_corpus_250/hammer_12340_9" "")
thf(conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F12340_5F9,conjecture,(c_SNo @ ((c_SNoCut @ ((famunion @ omega) @ (^ [X1:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X1)) @ c_Empty)))) @ ((famunion @ omega) @ (^ [X1:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X1)) @ (ordsucc @ c_Empty))))))).
