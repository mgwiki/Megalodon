% megalodon_origin ((file "examples/hammer/100thms_12_h.mg") (line "11703") (char "242") (kind "aby"))
...
% megalodon_source_map (known "add_5FSNo_5Fcancel_5FL" "add_SNo_cancel_L" "3f9f0821c9c0345a8ac0542c7724549fd6f110a6c49b60b21e47a6f79ed69c2c")
thf(add_5FSNo_5Fcancel_5FL,axiom,(! [X0:$i] : (! [X1:$i] : (! [X2:$i] : ((c_SNo @ X0) => ((c_SNo @ X1) => ((c_SNo @ X2) => ((((add_5FSNo @ X0) @ X1) = ((add_5FSNo @ X0) @ X2)) => (X1 = X2))))))))). % 3f9f0821c9c0345a8ac0542c7724549fd6f110a6c49b60b21e47a6f79ed69c2c
...
% megalodon_source_map (def "exp_5FSNo_5Fnat_def" "exp_SNo_nat" "6ec032f955c377b8953cff1c37d3572125487a6587167afb5fdec25c2350b3c3")
thf(exp_5FSNo_5Fnat_def,definition,(exp_5FSNo_5Fnat = (^ [X0:$i] : (^ [X1:$i] : (((nat_5Fprimrec @ (ordsucc @ c_Empty)) @ (^ [X2:$i] : (^ [X3:$i] : ((mul_5FSNo @ X0) @ X3)))) @ X1))))). % 6ec032f955c377b8953cff1c37d3572125487a6587167afb5fdec25c2350b3c3
...
thf(g_tp,type,(g : ($i > $i))).
% megalodon_source_map (local_type "u_tp" "u" "")
thf(u_tp,type,(u : $i)).
% megalodon_source_map (local_type "v_tp" "v" "")
thf(v_tp,type,(v : $i)).
% megalodon_source_map (local_fact "c_Hguv" "Hguv" "")
thf(c_Hguv,axiom,(((add_5FSNo @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n)) @ (f @ ((binintersect @ u) @ (c_SNoElts_5F @ n)))) = ((add_5FSNo @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n)) @ (f @ ((binintersect @ v) @ (c_SNoElts_5F @ n)))))).
% megalodon_source_map (local_fact "c_H2" "H2" "")
thf(c_H2,axiom,(((c_In @ n) @ v) => (! [X5:$o] : X5))).
% megalodon_source_map (local_fact "c_H1" "H1" "")
thf(c_H1,axiom,(((c_In @ n) @ u) => (! [X5:$o] : X5))).
% megalodon_source_map (local_fact "c_LnLv" "LnLv" "")
thf(c_LnLv,axiom,((c_In @ n) @ (c_SNoLev @ v))).
% megalodon_source_map (local_fact "c_LnLu" "LnLu" "")
thf(c_LnLu,axiom,((c_In @ n) @ (c_SNoLev @ u))).
% megalodon_source_map (local_fact "c_Lfv4" "Lfv4" "")
thf(c_Lfv4,axiom,((c_SNoLt @ (f @ ((binintersect @ v) @ (c_SNoElts_5F @ n)))) @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n))).
% megalodon_source_map (local_fact "c_Lfv3" "Lfv3" "")
thf(c_Lfv3,axiom,(c_SNo @ (f @ ((binintersect @ v) @ (c_SNoElts_5F @ n))))).
% megalodon_source_map (local_fact "c_Lfv2" "Lfv2" "")
thf(c_Lfv2,axiom,(! [X5:$o] : (((! [X6:$i] : (((c_In @ X6) @ (f @ ((binintersect @ v) @ (c_SNoElts_5F @ n)))) => (! [X7:$i] : (((c_In @ X7) @ X6) => ((c_In @ X7) @ (f @ ((binintersect @ v) @ (c_SNoElts_5F @ n)))))))) => ((! [X6:$i] : (((c_In @ X6) @ (f @ ((binintersect @ v) @ (c_SNoElts_5F @ n)))) => (! [X7:$i] : (((c_In @ X7) @ X6) => (! [X8:$i] : (((c_In @ X8) @ X7) => ((c_In @ X8) @ X6))))))) => X5)) => X5))).
% megalodon_source_map (local_fact "c_Lfv1" "Lfv1" "")
thf(c_Lfv1,axiom,(! [X5:($i > $o)] : ((X5 @ c_Empty) => ((! [X6:$i] : ((X5 @ X6) => (X5 @ (ordsucc @ X6)))) => (X5 @ (f @ ((binintersect @ v) @ (c_SNoElts_5F @ n)))))))).
% megalodon_source_map (local_fact "c_Hv3" "Hv3" "")
thf(c_Hv3,axiom,((c_SNoLev @ ((binintersect @ v) @ (c_SNoElts_5F @ n))) = n)).
% megalodon_source_map (local_fact "c_Hv2" "Hv2" "")
thf(c_Hv2,axiom,(c_SNo @ ((binintersect @ v) @ (c_SNoElts_5F @ n)))).
% megalodon_source_map (local_fact "c_Hv1" "Hv1" "")
thf(c_Hv1,axiom,((c_In @ ((binintersect @ v) @ (c_SNoElts_5F @ n))) @ ((c_Sep @ (c_SNoS_5F @ omega)) @ (^ [X5:$i] : ((c_SNoLev @ X5) = n))))).
% megalodon_source_map (local_fact "c_Hv0b" "Hv0b" "")
thf(c_Hv0b,axiom,((c_SNoLev @ v) = (ordsucc @ n))).
% megalodon_source_map (local_fact "c_Hv0a" "Hv0a" "")
thf(c_Hv0a,axiom,(c_SNo @ v)).
% megalodon_source_map (local_fact "c_Lfu4" "Lfu4" "")
thf(c_Lfu4,axiom,((c_SNoLt @ (f @ ((binintersect @ u) @ (c_SNoElts_5F @ n)))) @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n))).
% megalodon_source_map (local_fact "c_Lfu3" "Lfu3" "")
thf(c_Lfu3,axiom,(c_SNo @ (f @ ((binintersect @ u) @ (c_SNoElts_5F @ n))))).
% megalodon_source_map (local_fact "c_Lfu2" "Lfu2" "")
thf(c_Lfu2,axiom,(! [X5:$o] : (((! [X6:$i] : (((c_In @ X6) @ (f @ ((binintersect @ u) @ (c_SNoElts_5F @ n)))) => (! [X7:$i] : (((c_In @ X7) @ X6) => ((c_In @ X7) @ (f @ ((binintersect @ u) @ (c_SNoElts_5F @ n)))))))) => ((! [X6:$i] : (((c_In @ X6) @ (f @ ((binintersect @ u) @ (c_SNoElts_5F @ n)))) => (! [X7:$i] : (((c_In @ X7) @ X6) => (! [X8:$i] : (((c_In @ X8) @ X7) => ((c_In @ X8) @ X6))))))) => X5)) => X5))).
% megalodon_source_map (local_fact "c_Lfu1" "Lfu1" "")
thf(c_Lfu1,axiom,(! [X5:($i > $o)] : ((X5 @ c_Empty) => ((! [X6:$i] : ((X5 @ X6) => (X5 @ (ordsucc @ X6)))) => (X5 @ (f @ ((binintersect @ u) @ (c_SNoElts_5F @ n)))))))).
% megalodon_source_map (local_fact "c_Hu3" "Hu3" "")
thf(c_Hu3,axiom,((c_SNoLev @ ((binintersect @ u) @ (c_SNoElts_5F @ n))) = n)).
% megalodon_source_map (local_fact "c_Hu2" "Hu2" "")
thf(c_Hu2,axiom,(c_SNo @ ((binintersect @ u) @ (c_SNoElts_5F @ n)))).
% megalodon_source_map (local_fact "c_Hu1" "Hu1" "")
thf(c_Hu1,axiom,((c_In @ ((binintersect @ u) @ (c_SNoElts_5F @ n))) @ ((c_Sep @ (c_SNoS_5F @ omega)) @ (^ [X5:$i] : ((c_SNoLev @ X5) = n))))).
% megalodon_source_map (local_fact "c_Hu0b" "Hu0b" "")
thf(c_Hu0b,axiom,((c_SNoLev @ u) = (ordsucc @ n))).
% megalodon_source_map (local_fact "c_Hu0a" "Hu0a" "")
thf(c_Hu0a,axiom,(c_SNo @ u)).
% megalodon_source_map (local_fact "c_Hv" "Hv" "")
thf(c_Hv,axiom,((c_In @ v) @ ((c_Sep @ (c_SNoS_5F @ omega)) @ (^ [X5:$i] : ((c_SNoLev @ X5) = (ordsucc @ n)))))).
% megalodon_source_map (local_fact "c_Hu" "Hu" "")
thf(c_Hu,axiom,((c_In @ u) @ ((c_Sep @ (c_SNoS_5F @ omega)) @ (^ [X5:$i] : ((c_SNoLev @ X5) = (ordsucc @ n)))))).
% megalodon_source_map (local_fact "c_Hg2" "Hg2" "")
thf(c_Hg2,axiom,(! [X5:$i] : ((((c_In @ n) @ X5) => (! [X6:$o] : X6)) => ((g @ X5) = ((add_5FSNo @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n)) @ (f @ ((binintersect @ X5) @ (c_SNoElts_5F @ n)))))))).
% megalodon_source_map (local_fact "c_Hg1" "Hg1" "")
thf(c_Hg1,axiom,(! [X5:$i] : (((c_In @ n) @ X5) => ((g @ X5) = (f @ ((binintersect @ X5) @ (c_SNoElts_5F @ n))))))).
% megalodon_source_map (local_fact "c_H" "H" "")
thf(c_H,axiom,(! [X5:$o] : (((! [X6:$i] : (((c_In @ n) @ X6) => ((g @ X6) = (f @ ((binintersect @ X6) @ (c_SNoElts_5F @ n)))))) => ((! [X6:$i] : ((((c_In @ n) @ X6) => (! [X7:$o] : X7)) => ((g @ X6) = ((add_5FSNo @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n)) @ (f @ ((binintersect @ X6) @ (c_SNoElts_5F @ n))))))) => X5)) => X5))).
% megalodon_source_map (local_fact "c_Lg" "Lg" "")
thf(c_Lg,axiom,(! [X5:$o] : ((! [X6:($i > $i)] : ((! [X7:$o] : (((! [X8:$i] : (((c_In @ n) @ X8) => ((X6 @ X8) = (f @ ((binintersect @ X8) @ (c_SNoElts_5F @ n)))))) => ((! [X8:$i] : ((((c_In @ n) @ X8) => (! [X9:$o] : X9)) => ((X6 @ X8) = ((add_5FSNo @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n)) @ (f @ ((binintersect @ X8) @ (c_SNoElts_5F @ n))))))) => X7)) => X7)) => X5)) => X5))).
% megalodon_source_map (local_fact "c_Lf" "Lf" "")
thf(c_Lf,axiom,(! [X5:$i] : (((c_In @ X5) @ ((c_Sep @ (c_SNoS_5F @ omega)) @ (^ [X6:$i] : ((c_SNoLev @ X6) = (ordsucc @ n))))) => (! [X6:$o] : (((! [X7:($i > $o)] : ((X7 @ c_Empty) => ((! [X8:$i] : ((X7 @ X8) => (X7 @ (ordsucc @ X8)))) => (X7 @ (f @ ((binintersect @ X5) @ (c_SNoElts_5F @ n))))))) => ((! [X7:$o] : (((! [X8:$i] : (((c_In @ X8) @ (f @ ((binintersect @ X5) @ (c_SNoElts_5F @ n)))) => (! [X9:$i] : (((c_In @ X9) @ X8) => ((c_In @ X9) @ (f @ ((binintersect @ X5) @ (c_SNoElts_5F @ n)))))))) => ((! [X8:$i] : (((c_In @ X8) @ (f @ ((binintersect @ X5) @ (c_SNoElts_5F @ n)))) => (! [X9:$i] : (((c_In @ X9) @ X8) => (! [X10:$i] : (((c_In @ X10) @ X9) => ((c_In @ X10) @ X8))))))) => X7)) => X7)) => ((c_SNo @ (f @ ((binintersect @ X5) @ (c_SNoElts_5F @ n)))) => (((c_SNoLt @ (f @ ((binintersect @ X5) @ (c_SNoElts_5F @ n)))) @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n)) => X6)))) => X6))))).
% megalodon_source_map (local_fact "c_L2" "L2" "")
thf(c_L2,axiom,(! [X5:$i] : (((c_In @ X5) @ ((c_Sep @ (c_SNoS_5F @ omega)) @ (^ [X6:$i] : ((c_SNoLev @ X6) = (ordsucc @ n))))) => (! [X6:$o] : (((c_SNo @ X5) => (((c_SNoLev @ X5) = (ordsucc @ n)) => (((c_In @ ((binintersect @ X5) @ (c_SNoElts_5F @ n))) @ ((c_Sep @ (c_SNoS_5F @ omega)) @ (^ [X7:$i] : ((c_SNoLev @ X7) = n)))) => ((c_SNo @ ((binintersect @ X5) @ (c_SNoElts_5F @ n))) => (((c_SNoLev @ ((binintersect @ X5) @ (c_SNoElts_5F @ n))) = n) => X6))))) => X6))))).
% megalodon_source_map (local_fact "c_Hf3" "Hf3" "")
thf(c_Hf3,axiom,(! [X5:$i] : (((c_In @ X5) @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n)) => (! [X6:$o] : ((! [X7:$i] : ((! [X8:$o] : ((((c_In @ X7) @ ((c_Sep @ (c_SNoS_5F @ omega)) @ (^ [X9:$i] : ((c_SNoLev @ X9) = n)))) => (((f @ X7) = X5) => X8)) => X8)) => X6)) => X6))))).
% megalodon_source_map (local_fact "c_Hf2" "Hf2" "")
thf(c_Hf2,axiom,(! [X5:$i] : (((c_In @ X5) @ ((c_Sep @ (c_SNoS_5F @ omega)) @ (^ [X6:$i] : ((c_SNoLev @ X6) = n)))) => (! [X6:$i] : (((c_In @ X6) @ ((c_Sep @ (c_SNoS_5F @ omega)) @ (^ [X7:$i] : ((c_SNoLev @ X7) = n)))) => (((f @ X5) = (f @ X6)) => (X5 = X6))))))).
% megalodon_source_map (local_fact "c_Hf1" "Hf1" "")
thf(c_Hf1,axiom,(! [X5:$i] : (((c_In @ X5) @ ((c_Sep @ (c_SNoS_5F @ omega)) @ (^ [X6:$i] : ((c_SNoLev @ X6) = n)))) => ((c_In @ (f @ X5)) @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n))))).
% megalodon_source_map (local_fact "c_Hf" "Hf" "")
thf(c_Hf,axiom,(! [X5:$o] : (((! [X6:$o] : (((! [X7:$i] : (((c_In @ X7) @ ((c_Sep @ (c_SNoS_5F @ omega)) @ (^ [X8:$i] : ((c_SNoLev @ X8) = n)))) => ((c_In @ (f @ X7)) @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n)))) => ((! [X7:$i] : (((c_In @ X7) @ ((c_Sep @ (c_SNoS_5F @ omega)) @ (^ [X8:$i] : ((c_SNoLev @ X8) = n)))) => (! [X8:$i] : (((c_In @ X8) @ ((c_Sep @ (c_SNoS_5F @ omega)) @ (^ [X9:$i] : ((c_SNoLev @ X9) = n)))) => (((f @ X7) = (f @ X8)) => (X7 = X8)))))) => X6)) => X6)) => ((! [X6:$i] : (((c_In @ X6) @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n)) => (! [X7:$o] : ((! [X8:$i] : ((! [X9:$o] : ((((c_In @ X8) @ ((c_Sep @ (c_SNoS_5F @ omega)) @ (^ [X10:$i] : ((c_SNoLev @ X10) = n)))) => (((f @ X8) = X6) => X9)) => X9)) => X7)) => X7)))) => X5)) => X5))).
% megalodon_source_map (local_fact "c_L2nLt2n2n" "L2nLt2n2n" "")
thf(c_L2nLt2n2n,axiom,((c_SNoLt @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n)) @ ((add_5FSNo @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n)) @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n)))).
% megalodon_source_map (local_fact "c_L2npLt2n2n" "L2npLt2n2n" "")
thf(c_L2npLt2n2n,axiom,(! [X5:$i] : ((c_SNo @ X5) => (((c_SNoLt @ X5) @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n)) => ((c_SNoLt @ ((add_5FSNo @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n)) @ X5)) @ ((add_5FSNo @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n)) @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n))))))).
% megalodon_source_map (local_fact "c_L2n2n3" "L2n2n3" "")
thf(c_L2n2n3,axiom,(c_SNo @ ((add_5FSNo @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n)) @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n)))).
% megalodon_source_map (local_fact "c_L2n2n2" "L2n2n2" "")
thf(c_L2n2n2,axiom,(! [X5:$o] : (((! [X6:$i] : (((c_In @ X6) @ ((add_5FSNo @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n)) @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n))) => (! [X7:$i] : (((c_In @ X7) @ X6) => ((c_In @ X7) @ ((add_5FSNo @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n)) @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n))))))) => ((! [X6:$i] : (((c_In @ X6) @ ((add_5FSNo @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n)) @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n))) => (! [X7:$i] : (((c_In @ X7) @ X6) => (! [X8:$i] : (((c_In @ X8) @ X7) => ((c_In @ X8) @ X6))))))) => X5)) => X5))).
% megalodon_source_map (local_fact "c_L2n2n1" "L2n2n1" "")
thf(c_L2n2n1,axiom,(! [X5:($i > $o)] : ((X5 @ c_Empty) => ((! [X6:$i] : ((X5 @ X6) => (X5 @ (ordsucc @ X6)))) => (X5 @ ((add_5FSNo @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n)) @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n))))))).
% megalodon_source_map (local_fact "c_L2n3" "L2n3" "")
thf(c_L2n3,axiom,(c_SNo @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n))).
% megalodon_source_map (local_fact "c_L2n2" "L2n2" "")
thf(c_L2n2,axiom,(! [X5:$o] : (((! [X6:$i] : (((c_In @ X6) @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n)) => (! [X7:$i] : (((c_In @ X7) @ X6) => ((c_In @ X7) @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n)))))) => ((! [X6:$i] : (((c_In @ X6) @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n)) => (! [X7:$i] : (((c_In @ X7) @ X6) => (! [X8:$i] : (((c_In @ X8) @ X7) => ((c_In @ X8) @ X6))))))) => X5)) => X5))).
% megalodon_source_map (local_fact "c_L2n1" "L2n1" "")
thf(c_L2n1,axiom,(! [X5:($i > $o)] : ((X5 @ c_Empty) => ((! [X6:$i] : ((X5 @ X6) => (X5 @ (ordsucc @ X6)))) => (X5 @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n)))))).
% megalodon_source_map (local_fact "c_IHn" "IHn" "")
thf(c_IHn,axiom,(! [X5:$o] : ((! [X6:($i > $i)] : ((! [X7:$o] : (((! [X8:$o] : (((! [X9:$i] : (((c_In @ X9) @ ((c_Sep @ (c_SNoS_5F @ omega)) @ (^ [X10:$i] : ((c_SNoLev @ X10) = n)))) => ((c_In @ (X6 @ X9)) @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n)))) => ((! [X9:$i] : (((c_In @ X9) @ ((c_Sep @ (c_SNoS_5F @ omega)) @ (^ [X10:$i] : ((c_SNoLev @ X10) = n)))) => (! [X10:$i] : (((c_In @ X10) @ ((c_Sep @ (c_SNoS_5F @ omega)) @ (^ [X11:$i] : ((c_SNoLev @ X11) = n)))) => (((X6 @ X9) = (X6 @ X10)) => (X9 = X10)))))) => X8)) => X8)) => ((! [X8:$i] : (((c_In @ X8) @ ((exp_5FSNo_5Fnat @ (ordsucc @ (ordsucc @ c_Empty))) @ n)) => (! [X9:$o] : ((! [X10:$i] : ((! [X11:$o] : ((((c_In @ X10) @ ((c_Sep @ (c_SNoS_5F @ omega)) @ (^ [X12:$i] : ((c_SNoLev @ X12) = n)))) => (((X6 @ X10) = X8) => X11)) => X11)) => X9)) => X9)))) => X7)) => X7)) => X5)) => X5))).
% megalodon_source_map (local_fact "c_Hn" "Hn" "")
thf(c_Hn,axiom,(! [X5:($i > $o)] : ((X5 @ c_Empty) => ((! [X6:$i] : ((X5 @ X6) => (X5 @ (ordsucc @ X6)))) => (X5 @ n))))).
% megalodon_source_map (conjecture "conj_c__2Fproject_2Ftmp_2Fsource_5Flinked_5Fstrict_5F100_5Fcorpus_5Ffresh_5F041947_2Fhammer_5F11703_5F242" "/project/tmp/source_linked_strict_100_corpus_fresh_041947/hammer_11703_242" "")
thf(conj_c__2Fproject_2Ftmp_2Fsource_5Flinked_5Fstrict_5F100_5Fcorpus_5Ffresh_5F041947_2Fhammer_5F11703_5F242,conjecture,((f @ ((binintersect @ u) @ (c_SNoElts_5F @ n))) = (f @ ((binintersect @ v) @ (c_SNoElts_5F @ n))))).
