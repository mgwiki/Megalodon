% megalodon_origin ((file "/project/Megalodon/examples/hammer/100thms_12_h.mg") (line "12430") (char "152") (kind "aby"))
...
thf(int,type,(int : $i)).
% megalodon_source_map (type "divides_5Fint" "divides_int" "")
thf(divides_5Fint,type,(divides_5Fint : ($i > ($i > $o)))).
% megalodon_source_map (def "divides_5Fint_def" "divides_int" "d276f2dfb1476a71df81f0b8734bd5a4d2f97aec7458d5454984c5b810b377b5")
thf(divides_5Fint_def,definition,(divides_5Fint = (^ [X0:$i] : (^ [X1:$i] : ((((c_In @ X0) @ int) & ((c_In @ X1) @ int)) & (? [X2:$i] : (((c_In @ X2) @ int) & (((mul_5FSNo @ X0) @ X2) = X1)))))))). % d276f2dfb1476a71df81f0b8734bd5a4d2f97aec7458d5454984c5b810b377b5
% megalodon_source_map (type "gcd_5Freln" "gcd_reln" "")
thf(gcd_5Freln,type,(gcd_5Freln : ($i > ($i > ($i > $o))))).
% megalodon_source_map (def "gcd_5Freln_def" "gcd_reln" "cabb2e5877aa0d0224ff2032620989bcd7d3b5fc276da8c7d81ed0c99a4026e5")
thf(gcd_5Freln_def,definition,(gcd_5Freln = (^ [X0:$i] : (^ [X1:$i] : (^ [X2:$i] : ((((divides_5Fint @ X2) @ X0) & ((divides_5Fint @ X2) @ X1)) & (! [X3:$i] : (((divides_5Fint @ X3) @ X0) => (((divides_5Fint @ X3) @ X1) => ((c_SNoLe @ X3) @ X2)))))))))). % cabb2e5877aa0d0224ff2032620989bcd7d3b5fc276da8c7d81ed0c99a4026e5
% megalodon_source_map (type "int_5Flin_5Fcomb" "int_lin_comb" "")
thf(int_5Flin_5Fcomb,type,(int_5Flin_5Fcomb : ($i > ($i > ($i > $o))))).
% megalodon_source_map (def "int_5Flin_5Fcomb_def" "int_lin_comb" "98cc47d45e63357147c24ddd21e6ba5a9fcbbaad5c13bd9da6b828fb66a96fee")
thf(int_5Flin_5Fcomb_def,definition,(int_5Flin_5Fcomb = (^ [X0:$i] : (^ [X1:$i] : (^ [X2:$i] : (((((c_In @ X0) @ int) & ((c_In @ X1) @ int)) & ((c_In @ X2) @ int)) & (? [X3:$i] : (((c_In @ X3) @ int) & (? [X4:$i] : (((c_In @ X4) @ int) & (((add_5FSNo @ ((mul_5FSNo @ X3) @ X0)) @ ((mul_5FSNo @ X4) @ X1)) = X2))))))))))). % 98cc47d45e63357147c24ddd21e6ba5a9fcbbaad5c13bd9da6b828fb66a96fee
% megalodon_source_map (type "c_Pi_5FSNo" "Pi_SNo" "")
thf(c_Pi_5FSNo,type,(c_Pi_5FSNo : (($i > $i) > ($i > $i)))).
% megalodon_source_map (def "c_Pi_5FSNo_def" "Pi_SNo" "5e88e6e3717c02ef80e4725de4b34b359ca6a8a994e1005a601a1dbc8f8b1043")
thf(c_Pi_5FSNo_def,definition,(c_Pi_5FSNo = (^ [X0:($i > $i)] : (^ [X1:$i] : (((nat_5Fprimrec @ (ordsucc @ c_Empty)) @ (^ [X2:$i] : (^ [X3:$i] : ((mul_5FSNo @ X3) @ (X0 @ X2))))) @ X1))))). % 5e88e6e3717c02ef80e4725de4b34b359ca6a8a994e1005a601a1dbc8f8b1043
% megalodon_source_map (type "nonincrfinseq" "nonincrfinseq" "")
thf(nonincrfinseq,type,(nonincrfinseq : (($i > $o) > ($i > (($i > $i) > $o))))).
% megalodon_source_map (def "nonincrfinseq_def" "nonincrfinseq" "2421ecac829536a9a4fb1136bae07a50bd533d1d30098880243b795a6c5f2696")
thf(nonincrfinseq_def,definition,(nonincrfinseq = (^ [X0:($i > $o)] : (^ [X1:$i] : (^ [X2:($i > $i)] : (! [X3:$i] : (((c_In @ X3) @ X1) => ((X0 @ (X2 @ X3)) & (! [X4:$i] : (((c_In @ X4) @ X3) => ((c_SNoLe @ (X2 @ X3)) @ (X2 @ X4)))))))))))). % 2421ecac829536a9a4fb1136bae07a50bd533d1d30098880243b795a6c5f2696
% megalodon_source_map (type "exp_5FSNo_5Fnat" "exp_SNo_nat" "")
thf(exp_5FSNo_5Fnat,type,(exp_5FSNo_5Fnat : ($i > ($i > $i)))).
% megalodon_source_map (type "c_SNo_5Fmax_5Fof" "SNo_max_of" "")
thf(c_SNo_5Fmax_5Fof,type,(c_SNo_5Fmax_5Fof : ($i > ($i > $o)))).
% megalodon_source_map (def "c_SNo_5Fmax_5Fof_def" "SNo_max_of" "d0d2bab5bec1b01114c5a666525127b2277b5d0dfd077db28064bc5de6e0307c")
thf(c_SNo_5Fmax_5Fof_def,definition,(c_SNo_5Fmax_5Fof = (^ [X0:$i] : (^ [X1:$i] : ((((c_In @ X1) @ X0) & (c_SNo @ X1)) & (! [X2:$i] : (((c_In @ X2) @ X0) => ((c_SNo @ X2) => ((c_SNoLe @ X2) @ X1))))))))). % d0d2bab5bec1b01114c5a666525127b2277b5d0dfd077db28064bc5de6e0307c
% megalodon_source_map (type "c_SNo_5Fmin_5Fof" "SNo_min_of" "")
thf(c_SNo_5Fmin_5Fof,type,(c_SNo_5Fmin_5Fof : ($i > ($i > $o)))).
% megalodon_source_map (def "c_SNo_5Fmin_5Fof_def" "SNo_min_of" "40f47924a1c2c540d43c739db83802689c2dd8fe91b5277b7ee16229de2ef804")
thf(c_SNo_5Fmin_5Fof_def,definition,(c_SNo_5Fmin_5Fof = (^ [X0:$i] : (^ [X1:$i] : ((((c_In @ X1) @ X0) & (c_SNo @ X1)) & (! [X2:$i] : (((c_In @ X2) @ X0) => ((c_SNo @ X2) => ((c_SNoLe @ X1) @ X2))))))))). % 40f47924a1c2c540d43c739db83802689c2dd8fe91b5277b7ee16229de2ef804
% megalodon_source_map (type "diadic_5Frational_5Fp" "diadic_rational_p" "")
thf(diadic_5Frational_5Fp,type,(diadic_5Frational_5Fp : ($i > $o))).
% megalodon_source_map (def "diadic_5Frational_5Fp_def" "diadic_rational_p" "62c4a99438162b47740f55abb9c751741db76e9023d39f3ee5b117fbb7fd3157")
thf(diadic_5Frational_5Fp_def,definition,(diadic_5Frational_5Fp = (^ [X0:$i] : (? [X1:$i] : (((c_In @ X1) @ omega) & (? [X2:$i] : (((c_In @ X2) @ int) & (X0 = ((mul_5FSNo @ (eps_5F @ X1)) @ X2))))))))). % 62c4a99438162b47740f55abb9c751741db76e9023d39f3ee5b117fbb7fd3157
% megalodon_source_map (type "c_SNoL_5Fpos" "SNoL_pos" "")
thf(c_SNoL_5Fpos,type,(c_SNoL_5Fpos : ($i > $i))).
% megalodon_source_map (def "c_SNoL_5Fpos_def" "SNoL_pos" "f7bb926f042d1a569d3bce5167206a30984d5cdf49c83e0242b8fd5242855f5b")
thf(c_SNoL_5Fpos_def,definition,(c_SNoL_5Fpos = (^ [X0:$i] : ((c_Sep @ (c_SNoL @ X0)) @ (^ [X1:$i] : ((c_SNoLt @ c_Empty) @ X1)))))). % f7bb926f042d1a569d3bce5167206a30984d5cdf49c83e0242b8fd5242855f5b
% megalodon_source_map (type "c_SNo_5Frecipauxset" "SNo_recipauxset" "")
thf(c_SNo_5Frecipauxset,type,(c_SNo_5Frecipauxset : ($i > ($i > ($i > (($i > $i) > $i)))))).
% megalodon_source_map (def "c_SNo_5Frecipauxset_def" "SNo_recipauxset" "a28ab2600cf271dad5d12bf60b3830be9e01661b89c5d2c6ed686565245fe8d8")
thf(c_SNo_5Frecipauxset_def,definition,(c_SNo_5Frecipauxset = (^ [X0:$i] : (^ [X1:$i] : (^ [X2:$i] : (^ [X3:($i > $i)] : ((famunion @ X0) @ (^ [X4:$i] : ((c_Repl @ X2) @ (^ [X5:$i] : ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ ((add_5FSNo @ X5) @ (minus_5FSNo @ X1))) @ X4))) @ (X3 @ X5)))))))))))). % a28ab2600cf271dad5d12bf60b3830be9e01661b89c5d2c6ed686565245fe8d8
% megalodon_source_map (type "c_SNo_5Frecipaux" "SNo_recipaux" "")
thf(c_SNo_5Frecipaux,type,(c_SNo_5Frecipaux : ($i > (($i > $i) > ($i > $i))))).
% megalodon_source_map (def "c_SNo_5Frecipaux_def" "SNo_recipaux" "50206d8bf968870ba6e40f410263f57c7e932249403e412af22a5842cdcd0a3b")
thf(c_SNo_5Frecipaux_def,definition,(c_SNo_5Frecipaux = (^ [X0:$i] : (^ [X1:($i > $i)] : ((nat_5Fprimrec @ ((c_Sigma @ (ordsucc @ (ordsucc @ c_Empty))) @ (^ [X2:$i] : (((c_If_5Fi @ (X2 = c_Empty)) @ (c_Sing @ c_Empty)) @ c_Empty)))) @ (^ [X2:$i] : (^ [X3:$i] : ((c_Sigma @ (ordsucc @ (ordsucc @ c_Empty))) @ (^ [X4:$i] : (((c_If_5Fi @ (X4 = c_Empty)) @ ((binunion @ ((binunion @ ((ap @ X3) @ c_Empty)) @ ((((c_SNo_5Frecipauxset @ ((ap @ X3) @ c_Empty)) @ X0) @ (c_SNoR @ X0)) @ X1))) @ ((((c_SNo_5Frecipauxset @ ((ap @ X3) @ (ordsucc @ c_Empty))) @ X0) @ (c_SNoL_5Fpos @ X0)) @ X1))) @ ((binunion @ ((binunion @ ((ap @ X3) @ (ordsucc @ c_Empty))) @ ((((c_SNo_5Frecipauxset @ ((ap @ X3) @ c_Empty)) @ X0) @ (c_SNoL_5Fpos @ X0)) @ X1))) @ ((((c_SNo_5Frecipauxset @ ((ap @ X3) @ (ordsucc @ c_Empty))) @ X0) @ (c_SNoR @ X0)) @ X1)))))))))))). % 50206d8bf968870ba6e40f410263f57c7e932249403e412af22a5842cdcd0a3b
% megalodon_source_map (type "recip_5FSNo_5Fpos" "recip_SNo_pos" "")
thf(recip_5FSNo_5Fpos,type,(recip_5FSNo_5Fpos : ($i > $i))).
% megalodon_source_map (def "recip_5FSNo_5Fpos_def" "recip_SNo_pos" "88ed11f2dead5b0e5f3c28c04f2c1d5ed89566ba1ab8122ea402434686300b1d")
thf(recip_5FSNo_5Fpos_def,definition,(recip_5FSNo_5Fpos = (c_SNo_5Frec_5Fi @ (^ [X0:$i] : (^ [X1:($i > $i)] : ((c_SNoCut @ ((famunion @ omega) @ (^ [X2:$i] : ((ap @ (((c_SNo_5Frecipaux @ X0) @ X1) @ X2)) @ c_Empty)))) @ ((famunion @ omega) @ (^ [X2:$i] : ((ap @ (((c_SNo_5Frecipaux @ X0) @ X1) @ X2)) @ (ordsucc @ c_Empty)))))))))). % 88ed11f2dead5b0e5f3c28c04f2c1d5ed89566ba1ab8122ea402434686300b1d
% megalodon_source_map (local_type "c_G_tp" "G" "")
thf(c_G_tp,type,(c_G : ($i > (($i > $i) > $i)))).
% megalodon_source_map (local_definition "c_G_def" "G" "")
thf(c_G_def,definition,(c_G = (^ [X0:$i] : (^ [X1:($i > $i)] : ((c_SNoCut @ ((famunion @ omega) @ (^ [X2:$i] : ((ap @ (((c_SNo_5Frecipaux @ X0) @ X1) @ X2)) @ c_Empty)))) @ ((famunion @ omega) @ (^ [X2:$i] : ((ap @ (((c_SNo_5Frecipaux @ X0) @ X1) @ X2)) @ (ordsucc @ c_Empty))))))))).
% megalodon_source_map (local_type "x_tp" "x" "")
thf(x_tp,type,(x : $i)).
% megalodon_source_map (local_type "c_L_tp" "L" "")
thf(c_L_tp,type,(c_L : $i)).
% megalodon_source_map (local_definition "c_L_def" "L" "")
thf(c_L_def,definition,(c_L = ((famunion @ omega) @ (^ [X1:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X1)) @ c_Empty))))).
% megalodon_source_map (local_type "c_R_tp" "R" "")
thf(c_R_tp,type,(c_R : $i)).
% megalodon_source_map (local_definition "c_R_def" "R" "")
thf(c_R_def,definition,(c_R = ((famunion @ omega) @ (^ [X1:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X1)) @ (ordsucc @ c_Empty)))))).
% megalodon_source_map (local_type "y_tp" "y" "")
thf(y_tp,type,(y : $i)).
% megalodon_source_map (local_definition "y_def" "y" "")
thf(y_def,definition,(y = ((c_SNoCut @ ((famunion @ omega) @ (^ [X1:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X1)) @ c_Empty)))) @ ((famunion @ omega) @ (^ [X1:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X1)) @ (ordsucc @ c_Empty))))))).
% megalodon_source_map (local_type "v_tp" "v" "")
thf(v_tp,type,(v : $i)).
% megalodon_source_map (local_type "w_tp" "w" "")
thf(w_tp,type,(w : $i)).
% megalodon_source_map (local_type "w_27_tp" "w'" "")
thf(w_27_tp,type,(w_27 : $i)).
% megalodon_source_map (local_fact "c_Hw_272" "Hw'2" "")
thf(c_Hw_272,axiom,(! [X4:$o] : ((((((c_PNoLt @ (c_SNoLev @ w_27)) @ (^ [X5:$i] : ((c_In @ X5) @ w_27))) @ (c_SNoLev @ w)) @ (^ [X5:$i] : ((c_In @ X5) @ w))) => X4) => (((! [X5:$o] : ((((c_SNoLev @ w_27) = (c_SNoLev @ w)) => ((! [X6:$i] : (((c_In @ X6) @ (c_SNoLev @ w_27)) => (! [X7:$o] : (((((c_In @ X6) @ w_27) => ((c_In @ X6) @ w)) => ((((c_In @ X6) @ w) => ((c_In @ X6) @ w_27)) => X7)) => X7)))) => X5)) => X5)) => X4) => X4)))).
% megalodon_source_map (local_fact "c_Hw_271" "Hw'1" "")
thf(c_Hw_271,axiom,((c_In @ w_27) @ ((famunion @ omega) @ (^ [X4:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X4)) @ (ordsucc @ c_Empty)))))).
% megalodon_source_map (local_fact "c_Hw_27" "Hw'" "")
thf(c_Hw_27,axiom,(! [X4:$o] : ((((c_In @ w_27) @ ((famunion @ omega) @ (^ [X5:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X5)) @ (ordsucc @ c_Empty))))) => ((! [X5:$o] : ((((((c_PNoLt @ (c_SNoLev @ w_27)) @ (^ [X6:$i] : ((c_In @ X6) @ w_27))) @ (c_SNoLev @ w)) @ (^ [X6:$i] : ((c_In @ X6) @ w))) => X5) => (((! [X6:$o] : ((((c_SNoLev @ w_27) = (c_SNoLev @ w)) => ((! [X7:$i] : (((c_In @ X7) @ (c_SNoLev @ w_27)) => (! [X8:$o] : (((((c_In @ X7) @ w_27) => ((c_In @ X7) @ w)) => ((((c_In @ X7) @ w) => ((c_In @ X7) @ w_27)) => X8)) => X8)))) => X6)) => X6)) => X5) => X5))) => X4)) => X4))).
% megalodon_source_map (local_fact "c_Lxw" "Lxw" "")
thf(c_Lxw,axiom,(c_SNo @ ((mul_5FSNo @ x) @ w))).
% megalodon_source_map (local_fact "c_LvS" "LvS" "")
thf(c_LvS,axiom,((c_In @ v) @ (c_SNoS_5F @ (c_SNoLev @ x)))).
% megalodon_source_map (local_fact "c_Hw3" "Hw3" "")
thf(c_Hw3,axiom,((c_SNoLt @ ((c_SNoCut @ ((famunion @ omega) @ (^ [X4:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X4)) @ c_Empty)))) @ ((famunion @ omega) @ (^ [X4:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X4)) @ (ordsucc @ c_Empty)))))) @ w)).
% megalodon_source_map (local_fact "c_Hw2" "Hw2" "")
thf(c_Hw2,axiom,((c_In @ (c_SNoLev @ w)) @ (c_SNoLev @ ((c_SNoCut @ ((famunion @ omega) @ (^ [X4:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X4)) @ c_Empty)))) @ ((famunion @ omega) @ (^ [X4:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X4)) @ (ordsucc @ c_Empty)))))))).
% megalodon_source_map (local_fact "c_Hw1" "Hw1" "")
thf(c_Hw1,axiom,(c_SNo @ w)).
% megalodon_source_map (local_fact "c_Hv3" "Hv3" "")
thf(c_Hv3,axiom,((c_SNoLt @ v) @ x)).
% megalodon_source_map (local_fact "c_Hv2" "Hv2" "")
thf(c_Hv2,axiom,((c_In @ (c_SNoLev @ v)) @ (c_SNoLev @ x))).
% megalodon_source_map (local_fact "c_Hv1" "Hv1" "")
thf(c_Hv1,axiom,(c_SNo @ v)).
% megalodon_source_map (local_fact "c_H7" "H7" "")
thf(c_H7,axiom,(! [X4:$o] : ((((((c_PNoLt @ (c_SNoLev @ ((add_5FSNo @ ((mul_5FSNo @ v) @ ((c_SNoCut @ ((famunion @ omega) @ (^ [X5:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X5)) @ c_Empty)))) @ ((famunion @ omega) @ (^ [X5:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X5)) @ (ordsucc @ c_Empty))))))) @ ((mul_5FSNo @ x) @ w)))) @ (^ [X5:$i] : ((c_In @ X5) @ ((add_5FSNo @ ((mul_5FSNo @ v) @ ((c_SNoCut @ ((famunion @ omega) @ (^ [X6:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X6)) @ c_Empty)))) @ ((famunion @ omega) @ (^ [X6:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X6)) @ (ordsucc @ c_Empty))))))) @ ((mul_5FSNo @ x) @ w))))) @ (c_SNoLev @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ v) @ w)))) @ (^ [X5:$i] : ((c_In @ X5) @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ v) @ w))))) => X4) => (((! [X5:$o] : ((((c_SNoLev @ ((add_5FSNo @ ((mul_5FSNo @ v) @ ((c_SNoCut @ ((famunion @ omega) @ (^ [X6:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X6)) @ c_Empty)))) @ ((famunion @ omega) @ (^ [X6:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X6)) @ (ordsucc @ c_Empty))))))) @ ((mul_5FSNo @ x) @ w))) = (c_SNoLev @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ v) @ w)))) => ((! [X6:$i] : (((c_In @ X6) @ (c_SNoLev @ ((add_5FSNo @ ((mul_5FSNo @ v) @ ((c_SNoCut @ ((famunion @ omega) @ (^ [X7:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X7)) @ c_Empty)))) @ ((famunion @ omega) @ (^ [X7:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X7)) @ (ordsucc @ c_Empty))))))) @ ((mul_5FSNo @ x) @ w)))) => (! [X7:$o] : (((((c_In @ X6) @ ((add_5FSNo @ ((mul_5FSNo @ v) @ ((c_SNoCut @ ((famunion @ omega) @ (^ [X8:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X8)) @ c_Empty)))) @ ((famunion @ omega) @ (^ [X8:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X8)) @ (ordsucc @ c_Empty))))))) @ ((mul_5FSNo @ x) @ w))) => ((c_In @ X6) @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ v) @ w)))) => ((((c_In @ X6) @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ v) @ w))) => ((c_In @ X6) @ ((add_5FSNo @ ((mul_5FSNo @ v) @ ((c_SNoCut @ ((famunion @ omega) @ (^ [X8:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X8)) @ c_Empty)))) @ ((famunion @ omega) @ (^ [X8:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X8)) @ (ordsucc @ c_Empty))))))) @ ((mul_5FSNo @ x) @ w)))) => X7)) => X7)))) => X5)) => X5)) => X4) => X4)))).
% megalodon_source_map (local_fact "c_Hw" "Hw" "")
thf(c_Hw,axiom,((c_In @ w) @ (c_SNoR @ ((c_SNoCut @ ((famunion @ omega) @ (^ [X4:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X4)) @ c_Empty)))) @ ((famunion @ omega) @ (^ [X4:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X4)) @ (ordsucc @ c_Empty)))))))).
% megalodon_source_map (local_fact "c_Hv" "Hv" "")
thf(c_Hv,axiom,((c_In @ v) @ (c_SNoL @ x))).
% megalodon_source_map (local_fact "c_L9" "L9" "")
thf(c_L9,axiom,(! [X4:$i] : (! [X5:$i] : (! [X6:$i] : ((c_SNo @ X4) => ((c_SNo @ X5) => ((c_SNo @ X6) => (((c_In @ X4) @ (c_SNoS_5F @ (c_SNoLev @ x))) => (((c_SNoLt @ c_Empty) @ X4) => ((! [X7:$o] : ((((((c_PNoLt @ (c_SNoLev @ ((add_5FSNo @ ((mul_5FSNo @ X4) @ ((c_SNoCut @ ((famunion @ omega) @ (^ [X8:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X8)) @ c_Empty)))) @ ((famunion @ omega) @ (^ [X8:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X8)) @ (ordsucc @ c_Empty))))))) @ ((mul_5FSNo @ x) @ X5)))) @ (^ [X8:$i] : ((c_In @ X8) @ ((add_5FSNo @ ((mul_5FSNo @ X4) @ ((c_SNoCut @ ((famunion @ omega) @ (^ [X9:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X9)) @ c_Empty)))) @ ((famunion @ omega) @ (^ [X9:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X9)) @ (ordsucc @ c_Empty))))))) @ ((mul_5FSNo @ x) @ X5))))) @ (c_SNoLev @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ X4) @ X5)))) @ (^ [X8:$i] : ((c_In @ X8) @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ X4) @ X5))))) => X7) => (((! [X8:$o] : ((((c_SNoLev @ ((add_5FSNo @ ((mul_5FSNo @ X4) @ ((c_SNoCut @ ((famunion @ omega) @ (^ [X9:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X9)) @ c_Empty)))) @ ((famunion @ omega) @ (^ [X9:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X9)) @ (ordsucc @ c_Empty))))))) @ ((mul_5FSNo @ x) @ X5))) = (c_SNoLev @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ X4) @ X5)))) => ((! [X9:$i] : (((c_In @ X9) @ (c_SNoLev @ ((add_5FSNo @ ((mul_5FSNo @ X4) @ ((c_SNoCut @ ((famunion @ omega) @ (^ [X10:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X10)) @ c_Empty)))) @ ((famunion @ omega) @ (^ [X10:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X10)) @ (ordsucc @ c_Empty))))))) @ ((mul_5FSNo @ x) @ X5)))) => (! [X10:$o] : (((((c_In @ X9) @ ((add_5FSNo @ ((mul_5FSNo @ X4) @ ((c_SNoCut @ ((famunion @ omega) @ (^ [X11:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X11)) @ c_Empty)))) @ ((famunion @ omega) @ (^ [X11:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X11)) @ (ordsucc @ c_Empty))))))) @ ((mul_5FSNo @ x) @ X5))) => ((c_In @ X9) @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ X4) @ X5)))) => ((((c_In @ X9) @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ X4) @ X5))) => ((c_In @ X9) @ ((add_5FSNo @ ((mul_5FSNo @ X4) @ ((c_SNoCut @ ((famunion @ omega) @ (^ [X11:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X11)) @ c_Empty)))) @ ((famunion @ omega) @ (^ [X11:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X11)) @ (ordsucc @ c_Empty))))))) @ ((mul_5FSNo @ x) @ X5)))) => X10)) => X10)))) => X8)) => X8)) => X7) => X7))) => (((c_In @ ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ ((add_5FSNo @ X4) @ (minus_5FSNo @ x))) @ X6))) @ (recip_5FSNo_5Fpos @ X4))) @ ((famunion @ omega) @ (^ [X7:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X7)) @ c_Empty)))) => ((! [X7:$o] : ((((((c_PNoLt @ (c_SNoLev @ ((mul_5FSNo @ ((add_5FSNo @ (minus_5FSNo @ X4)) @ x)) @ X6))) @ (^ [X8:$i] : ((c_In @ X8) @ ((mul_5FSNo @ ((add_5FSNo @ (minus_5FSNo @ X4)) @ x)) @ X6)))) @ (c_SNoLev @ ((mul_5FSNo @ ((add_5FSNo @ (minus_5FSNo @ X4)) @ x)) @ X5))) @ (^ [X8:$i] : ((c_In @ X8) @ ((mul_5FSNo @ ((add_5FSNo @ (minus_5FSNo @ X4)) @ x)) @ X5)))) => X7) => (((! [X8:$o] : ((((c_SNoLev @ ((mul_5FSNo @ ((add_5FSNo @ (minus_5FSNo @ X4)) @ x)) @ X6)) = (c_SNoLev @ ((mul_5FSNo @ ((add_5FSNo @ (minus_5FSNo @ X4)) @ x)) @ X5))) => ((! [X9:$i] : (((c_In @ X9) @ (c_SNoLev @ ((mul_5FSNo @ ((add_5FSNo @ (minus_5FSNo @ X4)) @ x)) @ X6))) => (! [X10:$o] : (((((c_In @ X9) @ ((mul_5FSNo @ ((add_5FSNo @ (minus_5FSNo @ X4)) @ x)) @ X6)) => ((c_In @ X9) @ ((mul_5FSNo @ ((add_5FSNo @ (minus_5FSNo @ X4)) @ x)) @ X5))) => ((((c_In @ X9) @ ((mul_5FSNo @ ((add_5FSNo @ (minus_5FSNo @ X4)) @ x)) @ X5)) => ((c_In @ X9) @ ((mul_5FSNo @ ((add_5FSNo @ (minus_5FSNo @ X4)) @ x)) @ X6))) => X10)) => X10)))) => X8)) => X8)) => X7) => X7))) => (! [X7:$o] : X7))))))))))))).
% megalodon_source_map (local_fact "c_L8" "L8" "")
thf(c_L8,axiom,((c_In @ (ordsucc @ c_Empty)) @ (c_SNoR @ ((mul_5FSNo @ x) @ ((c_SNoCut @ ((famunion @ omega) @ (^ [X4:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X4)) @ c_Empty)))) @ ((famunion @ omega) @ (^ [X4:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X4)) @ (ordsucc @ c_Empty))))))))).
% megalodon_source_map (local_fact "c_H6" "H6" "")
thf(c_H6,axiom,((c_SNoLt @ ((mul_5FSNo @ x) @ ((c_SNoCut @ ((famunion @ omega) @ (^ [X4:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X4)) @ c_Empty)))) @ ((famunion @ omega) @ (^ [X4:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X4)) @ (ordsucc @ c_Empty))))))) @ (ordsucc @ c_Empty))).
% megalodon_source_map (local_fact "c_HC" "HC" "")
thf(c_HC,axiom,((((mul_5FSNo @ x) @ ((c_SNoCut @ ((famunion @ omega) @ (^ [X4:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X4)) @ c_Empty)))) @ ((famunion @ omega) @ (^ [X4:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X4)) @ (ordsucc @ c_Empty)))))) = (ordsucc @ c_Empty)) => (! [X4:$o] : X4))).
% megalodon_source_map (local_fact "c_L7" "L7" "")
thf(c_L7,axiom,(! [X4:$i] : (((c_In @ X4) @ (c_SNoR @ ((c_SNoCut @ ((famunion @ omega) @ (^ [X5:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X5)) @ c_Empty)))) @ ((famunion @ omega) @ (^ [X5:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X5)) @ (ordsucc @ c_Empty))))))) => (! [X5:$o] : ((! [X6:$i] : ((! [X7:$o] : ((((c_In @ X6) @ ((famunion @ omega) @ (^ [X8:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X8)) @ (ordsucc @ c_Empty))))) => ((! [X8:$o] : ((((((c_PNoLt @ (c_SNoLev @ X6)) @ (^ [X9:$i] : ((c_In @ X9) @ X6))) @ (c_SNoLev @ X4)) @ (^ [X9:$i] : ((c_In @ X9) @ X4))) => X8) => (((! [X9:$o] : ((((c_SNoLev @ X6) = (c_SNoLev @ X4)) => ((! [X10:$i] : (((c_In @ X10) @ (c_SNoLev @ X6)) => (! [X11:$o] : (((((c_In @ X10) @ X6) => ((c_In @ X10) @ X4)) => ((((c_In @ X10) @ X4) => ((c_In @ X10) @ X6)) => X11)) => X11)))) => X9)) => X9)) => X8) => X8))) => X7)) => X7)) => X5)) => X5))))).
% megalodon_source_map (local_fact "c_L6" "L6" "")
thf(c_L6,axiom,(! [X4:$i] : (((c_In @ X4) @ (c_SNoL @ ((c_SNoCut @ ((famunion @ omega) @ (^ [X5:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X5)) @ c_Empty)))) @ ((famunion @ omega) @ (^ [X5:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X5)) @ (ordsucc @ c_Empty))))))) => (! [X5:$o] : ((! [X6:$i] : ((! [X7:$o] : ((((c_In @ X6) @ ((famunion @ omega) @ (^ [X8:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X8)) @ c_Empty)))) => ((! [X8:$o] : ((((((c_PNoLt @ (c_SNoLev @ X4)) @ (^ [X9:$i] : ((c_In @ X9) @ X4))) @ (c_SNoLev @ X6)) @ (^ [X9:$i] : ((c_In @ X9) @ X6))) => X8) => (((! [X9:$o] : ((((c_SNoLev @ X4) = (c_SNoLev @ X6)) => ((! [X10:$i] : (((c_In @ X10) @ (c_SNoLev @ X4)) => (! [X11:$o] : (((((c_In @ X10) @ X4) => ((c_In @ X10) @ X6)) => ((((c_In @ X10) @ X6) => ((c_In @ X10) @ X4)) => X11)) => X11)))) => X9)) => X9)) => X8) => X8))) => X7)) => X7)) => X5)) => X5))))).
% megalodon_source_map (local_fact "c_L5" "L5" "")
thf(c_L5,axiom,((c_SNoLt @ c_Empty) @ ((mul_5FSNo @ x) @ ((c_SNoCut @ ((famunion @ omega) @ (^ [X4:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X4)) @ c_Empty)))) @ ((famunion @ omega) @ (^ [X4:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X4)) @ (ordsucc @ c_Empty)))))))).
% megalodon_source_map (local_fact "c_L4" "L4" "")
thf(c_L4,axiom,((c_SNoLt @ c_Empty) @ ((c_SNoCut @ ((famunion @ omega) @ (^ [X4:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X4)) @ c_Empty)))) @ ((famunion @ omega) @ (^ [X4:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X4)) @ (ordsucc @ c_Empty))))))).
% megalodon_source_map (local_fact "c_L3" "L3" "")
thf(c_L3,axiom,(c_SNo @ ((mul_5FSNo @ x) @ ((c_SNoCut @ ((famunion @ omega) @ (^ [X4:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X4)) @ c_Empty)))) @ ((famunion @ omega) @ (^ [X4:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X4)) @ (ordsucc @ c_Empty)))))))).
% megalodon_source_map (local_fact "c_H5" "H5" "")
thf(c_H5,axiom,(! [X4:$i] : ((c_SNo @ X4) => ((! [X5:$i] : (((c_In @ X5) @ ((famunion @ omega) @ (^ [X6:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X6)) @ c_Empty)))) => ((c_SNoLt @ X5) @ X4))) => ((! [X5:$i] : (((c_In @ X5) @ ((famunion @ omega) @ (^ [X6:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X6)) @ (ordsucc @ c_Empty))))) => ((c_SNoLt @ X4) @ X5))) => (! [X5:$o] : (((! [X6:$i] : (((c_In @ X6) @ (c_SNoLev @ ((c_SNoCut @ ((famunion @ omega) @ (^ [X7:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X7)) @ c_Empty)))) @ ((famunion @ omega) @ (^ [X7:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X7)) @ (ordsucc @ c_Empty))))))) => ((c_In @ X6) @ (c_SNoLev @ X4)))) => ((! [X6:$i] : (((c_In @ X6) @ (c_SNoLev @ ((c_SNoCut @ ((famunion @ omega) @ (^ [X7:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X7)) @ c_Empty)))) @ ((famunion @ omega) @ (^ [X7:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X7)) @ (ordsucc @ c_Empty))))))) => (! [X7:$o] : (((((c_In @ X6) @ ((c_SNoCut @ ((famunion @ omega) @ (^ [X8:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X8)) @ c_Empty)))) @ ((famunion @ omega) @ (^ [X8:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X8)) @ (ordsucc @ c_Empty)))))) => ((c_In @ X6) @ X4)) => ((((c_In @ X6) @ X4) => ((c_In @ X6) @ ((c_SNoCut @ ((famunion @ omega) @ (^ [X8:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X8)) @ c_Empty)))) @ ((famunion @ omega) @ (^ [X8:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X8)) @ (ordsucc @ c_Empty))))))) => X7)) => X7)))) => X5)) => X5))))))).
% megalodon_source_map (local_fact "c_H4" "H4" "")
thf(c_H4,axiom,(! [X4:$i] : (((c_In @ X4) @ ((famunion @ omega) @ (^ [X5:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X5)) @ (ordsucc @ c_Empty))))) => ((c_SNoLt @ ((c_SNoCut @ ((famunion @ omega) @ (^ [X5:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X5)) @ c_Empty)))) @ ((famunion @ omega) @ (^ [X5:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X5)) @ (ordsucc @ c_Empty)))))) @ X4)))).
% megalodon_source_map (local_fact "c_H3" "H3" "")
thf(c_H3,axiom,(! [X4:$i] : (((c_In @ X4) @ ((famunion @ omega) @ (^ [X5:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X5)) @ c_Empty)))) => ((c_SNoLt @ X4) @ ((c_SNoCut @ ((famunion @ omega) @ (^ [X5:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X5)) @ c_Empty)))) @ ((famunion @ omega) @ (^ [X5:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X5)) @ (ordsucc @ c_Empty))))))))).
% megalodon_source_map (local_fact "c_H2" "H2" "")
thf(c_H2,axiom,((c_In @ (c_SNoLev @ ((c_SNoCut @ ((famunion @ omega) @ (^ [X4:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X4)) @ c_Empty)))) @ ((famunion @ omega) @ (^ [X4:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X4)) @ (ordsucc @ c_Empty))))))) @ (ordsucc @ ((binunion @ ((famunion @ ((famunion @ omega) @ (^ [X4:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X4)) @ c_Empty)))) @ (^ [X4:$i] : (ordsucc @ (c_SNoLev @ X4))))) @ ((famunion @ ((famunion @ omega) @ (^ [X4:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X4)) @ (ordsucc @ c_Empty))))) @ (^ [X4:$i] : (ordsucc @ (c_SNoLev @ X4)))))))).
% megalodon_source_map (local_fact "c_H1" "H1" "")
thf(c_H1,axiom,(c_SNo @ ((c_SNoCut @ ((famunion @ omega) @ (^ [X4:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X4)) @ c_Empty)))) @ ((famunion @ omega) @ (^ [X4:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X4)) @ (ordsucc @ c_Empty))))))).
% megalodon_source_map (local_fact "c_HLR" "HLR" "")
thf(c_HLR,axiom,(! [X4:$i] : (((c_In @ X4) @ ((famunion @ omega) @ (^ [X5:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X5)) @ c_Empty)))) => (! [X5:$i] : (((c_In @ X5) @ ((famunion @ omega) @ (^ [X6:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X6)) @ (ordsucc @ c_Empty))))) => ((c_SNoLt @ X4) @ X5)))))).
% megalodon_source_map (local_fact "c_HR" "HR" "")
thf(c_HR,axiom,(! [X4:$i] : (((c_In @ X4) @ ((famunion @ omega) @ (^ [X5:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X5)) @ (ordsucc @ c_Empty))))) => (c_SNo @ X4)))).
% megalodon_source_map (local_fact "c_HL" "HL" "")
thf(c_HL,axiom,(! [X4:$i] : (((c_In @ X4) @ ((famunion @ omega) @ (^ [X5:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X5)) @ c_Empty)))) => (c_SNo @ X4)))).
% megalodon_source_map (local_fact "c_HLHR" "HLHR" "")
thf(c_HLHR,axiom,(! [X4:$o] : (((! [X5:$i] : (((c_In @ X5) @ ((famunion @ omega) @ (^ [X6:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X6)) @ c_Empty)))) => (c_SNo @ X5))) => ((! [X5:$i] : (((c_In @ X5) @ ((famunion @ omega) @ (^ [X6:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X6)) @ (ordsucc @ c_Empty))))) => (c_SNo @ X5))) => X4)) => X4))).
% megalodon_source_map (local_fact "c_L2" "L2" "")
thf(c_L2,axiom,(! [X4:$o] : (((! [X5:$o] : (((! [X6:$i] : (((c_In @ X6) @ ((famunion @ omega) @ (^ [X7:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X7)) @ c_Empty)))) => (c_SNo @ X6))) => ((! [X6:$i] : (((c_In @ X6) @ ((famunion @ omega) @ (^ [X7:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X7)) @ (ordsucc @ c_Empty))))) => (c_SNo @ X6))) => X5)) => X5)) => ((! [X5:$i] : (((c_In @ X5) @ ((famunion @ omega) @ (^ [X6:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X6)) @ c_Empty)))) => (! [X6:$i] : (((c_In @ X6) @ ((famunion @ omega) @ (^ [X7:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X7)) @ (ordsucc @ c_Empty))))) => ((c_SNoLt @ X5) @ X6))))) => X4)) => X4))).
% megalodon_source_map (local_fact "c_L1R" "L1R" "")
thf(c_L1R,axiom,(! [X4:$i] : (((c_In @ X4) @ ((famunion @ omega) @ (^ [X5:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X5)) @ (ordsucc @ c_Empty))))) => ((c_SNoLt @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ x) @ X4))))).
% megalodon_source_map (local_fact "c_L1L" "L1L" "")
thf(c_L1L,axiom,(! [X4:$i] : (((c_In @ X4) @ ((famunion @ omega) @ (^ [X5:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X5)) @ c_Empty)))) => ((c_SNoLt @ ((mul_5FSNo @ x) @ X4)) @ (ordsucc @ c_Empty))))).
% megalodon_source_map (local_fact "c_L1" "L1" "")
thf(c_L1,axiom,(! [X4:$i] : ((! [X5:($i > $o)] : ((X5 @ c_Empty) => ((! [X6:$i] : ((X5 @ X6) => (X5 @ (ordsucc @ X6)))) => (X5 @ X4)))) => (! [X5:$o] : (((! [X6:$i] : (((c_In @ X6) @ ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X4)) @ c_Empty)) => (! [X7:$o] : (((c_SNo @ X6) => (((c_SNoLt @ ((mul_5FSNo @ x) @ X6)) @ (ordsucc @ c_Empty)) => X7)) => X7)))) => ((! [X6:$i] : (((c_In @ X6) @ ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X4)) @ (ordsucc @ c_Empty))) => (! [X7:$o] : (((c_SNo @ X6) => (((c_SNoLt @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ x) @ X6)) => X7)) => X7)))) => X5)) => X5))))).
% megalodon_source_map (local_fact "c_Hxpos" "Hxpos" "")
thf(c_Hxpos,axiom,((c_SNoLt @ c_Empty) @ x)).
% megalodon_source_map (local_fact "c_IH" "IH" "")
thf(c_IH,axiom,(! [X4:$i] : (((c_In @ X4) @ (c_SNoS_5F @ (c_SNoLev @ x))) => (((c_SNoLt @ c_Empty) @ X4) => (! [X5:$o] : (((c_SNo @ (recip_5FSNo_5Fpos @ X4)) => ((((mul_5FSNo @ X4) @ (recip_5FSNo_5Fpos @ X4)) = (ordsucc @ c_Empty)) => X5)) => X5)))))).
% megalodon_source_map (local_fact "c_Hx" "Hx" "")
thf(c_Hx,axiom,(c_SNo @ x)).
% megalodon_source_map (conjecture "conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F12430_5F152" "/project/tmp/megalodon3_source_linked_corpus_250/hammer_12430_152" "")
thf(conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F12430_5F152,conjecture,(c_SNo @ w_27)).
