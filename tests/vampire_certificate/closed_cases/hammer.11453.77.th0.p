% megalodon_origin ((file "examples/hammer/100thms_12_h.mg") (line "11453") (char "77") (kind "aby"))
...
% megalodon_source_map (known "c_SNo_5F1" "SNo_1" "9c3b2441459e801ab1755c20be37f38d1596b7dadbe27d4e50bc4beafb5e3074")
thf(c_SNo_5F1,axiom,(c_SNo @ (ordsucc @ c_Empty))). % 9c3b2441459e801ab1755c20be37f38d1596b7dadbe27d4e50bc4beafb5e3074
...
% megalodon_source_map (known "c_SNo_5Feps_5F1" "SNo_eps_1" "acc1fde9b5c32690fd0f37b266431aa75dcfc4bc0c96ce019ab9cb8986d69d12")
thf(c_SNo_5Feps_5F1,axiom,(c_SNo @ (eps_5F @ (ordsucc @ c_Empty)))). % acc1fde9b5c32690fd0f37b266431aa75dcfc4bc0c96ce019ab9cb8986d69d12
...
% megalodon_source_map (known "add_5FSNo_5F1_5F1_5F2" "add_SNo_1_1_2" "d45e045365f4d8b41e28ee5af34f3ff9684523dc81a6ff285b6209d4ff5ec2e4")
thf(add_5FSNo_5F1_5F1_5F2,axiom,(((add_5FSNo @ (ordsucc @ c_Empty)) @ (ordsucc @ c_Empty)) = (ordsucc @ (ordsucc @ c_Empty)))). % d45e045365f4d8b41e28ee5af34f3ff9684523dc81a6ff285b6209d4ff5ec2e4
...
% megalodon_source_map (known "mul_5FSNo_5FdistrR" "mul_SNo_distrR" "08c5d8f719c3a9264700e7ca466ad688c4fa5a14fa259fbbeca65986de1d1831")
thf(mul_5FSNo_5FdistrR,axiom,(! [X0:$i] : (! [X1:$i] : (! [X2:$i] : ((c_SNo @ X0) => ((c_SNo @ X1) => ((c_SNo @ X2) => (((mul_5FSNo @ ((add_5FSNo @ X0) @ X1)) @ X2) = ((add_5FSNo @ ((mul_5FSNo @ X0) @ X2)) @ ((mul_5FSNo @ X1) @ X2)))))))))). % 08c5d8f719c3a9264700e7ca466ad688c4fa5a14fa259fbbeca65986de1d1831
% megalodon_source_map (known "mul_5FSNo_5FoneL" "mul_SNo_oneL" "ed70c7de23ba2c1bf90761c9dc07579f6bde720cf11f99ecd684f271d7a9f904")
thf(mul_5FSNo_5FoneL,axiom,(! [X0:$i] : ((c_SNo @ X0) => (((mul_5FSNo @ (ordsucc @ c_Empty)) @ X0) = X0)))). % ed70c7de23ba2c1bf90761c9dc07579f6bde720cf11f99ecd684f271d7a9f904
...
% megalodon_source_map (known "eps_5F1_5Fhalf_5Feq1" "eps_1_half_eq1" "c1c058d5e176b92c4082bec2d2a9a79ffd9ec43c623ba0c1d92596e1ad67e4d5")
thf(eps_5F1_5Fhalf_5Feq1,axiom,(((add_5FSNo @ (eps_5F @ (ordsucc @ c_Empty))) @ (eps_5F @ (ordsucc @ c_Empty))) = (ordsucc @ c_Empty))). % c1c058d5e176b92c4082bec2d2a9a79ffd9ec43c623ba0c1d92596e1ad67e4d5
% megalodon_source_map (conjecture "conj_c__2Fproject_2Ftmp_2Fsource_5Flinked_5Fstrict_5F100_5Fcorpus_5Ffresh_5F041947_2Fhammer_5F11453_5F77" "/project/tmp/source_linked_strict_100_corpus_fresh_041947/hammer_11453_77" "")
thf(conj_c__2Fproject_2Ftmp_2Fsource_5Flinked_5Fstrict_5F100_5Fcorpus_5Ffresh_5F041947_2Fhammer_5F11453_5F77,conjecture,(((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (eps_5F @ (ordsucc @ c_Empty))) = (ordsucc @ c_Empty))).
