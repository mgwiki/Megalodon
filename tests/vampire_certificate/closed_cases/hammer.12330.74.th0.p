% megalodon_origin ((file "/project/Megalodon/examples/hammer/100thms_12_h.mg") (line "12330") (char "74") (kind "aby"))
...
% megalodon_source_map (known "c_SNo_5Fmul_5FSNo" "SNo_mul_SNo" "0cc799c87dcca4c63fe0bf7a1c701f843bbb0054761c565b5b6b12d01e4c036b")
thf(c_SNo_5Fmul_5FSNo,axiom,(! [X0:$i] : (! [X1:$i] : ((c_SNo @ X0) => ((c_SNo @ X1) => (c_SNo @ ((mul_5FSNo @ X0) @ X1))))))). % 0cc799c87dcca4c63fe0bf7a1c701f843bbb0054761c565b5b6b12d01e4c036b
...
% megalodon_source_map (conjecture "conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F12330_5F74" "/project/tmp/megalodon3_source_linked_corpus_250/hammer_12330_74" "")
thf(conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F12330_5F74,conjecture,(c_SNo @ ((mul_5FSNo @ x) @ ((c_SNoCut @ ((famunion @ omega) @ (^ [X1:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X1)) @ c_Empty)))) @ ((famunion @ omega) @ (^ [X1:$i] : ((ap @ (((c_SNo_5Frecipaux @ x) @ recip_5FSNo_5Fpos) @ X1)) @ (ordsucc @ c_Empty)))))))).
