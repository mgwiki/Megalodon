% megalodon_origin ((file "/project/Megalodon/examples/hammer/100thms_12_h.mg") (line "10703") (char "23") (kind "aby"))
...
% megalodon_source_map (conjecture "conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F10703_5F23" "/project/tmp/megalodon3_source_linked_corpus_250/hammer_10703_23" "")
thf(conj_c__2Fproject_2Ftmp_2Fmegalodon3_5Fsource_5Flinked_5Fcorpus_5F250_2Fhammer_5F10703_5F23,conjecture,(! [X1:($i > $o)] : ((X1 @ c_Empty) => ((! [X2:$i] : ((X1 @ X2) => (X1 @ (ordsucc @ X2)))) => (X1 @ n))))).
