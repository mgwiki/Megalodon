(certificate vampire-megalodon 1
  (problem "native-cert-v1-formula-normalize-primitive-contract-missing-bad")
  ...
  (step_extra "f2" "kernel_v1"
    ("schema=prover9-small-kernel-v1"
     "rule=formula_normalize"
     "conclusion_unit=f2"))
    ...
    (target
      (formula
        (AP
          ...
          (TMH "f__true"))))
    (path "root.left"))
  (fool_atom_lift f1_fool_atom_1
    (source (formula (TMH "q")))
    (target
      (formula
        (AP
          (AP
