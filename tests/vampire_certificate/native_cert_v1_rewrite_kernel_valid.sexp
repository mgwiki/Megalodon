(certificate vampire-megalodon 1
  (problem "native-cert-v1-rewrite-kernel-valid")
  (step_extra step "kernel_v1"
    ("schema=prover9-small-kernel-v1"
     ...
     "rewritten_target=(pos (AP (AP (TMH \"=\") (AP (TMH \"h\") (TMH \"b\"))) (TMH \"c\")))"
     "parent_count=2"
      ...
      (clause
        (pos
          (AP
            ...
            (TMH "c"))))))
  (input neg_result (source axiom "neg_result")
    (clause
      (neg
        (AP
          (AP (TMH "=") (AP (TMH "h") (TMH "b")))
          (TMH "c")))))
  (resolve done
    (parents step neg_result)
    (pivot 0 0)
    (result
      (clause)))
  (contradiction refuted done))
